 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_apostas_bolao_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['apostas_bolao_id'])) ? $this->New_label['apostas_bolao_id'] : "Bolão"; ?></TD>
     ...
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_apostas_bolao_id" <?php echo $str_hide_apostas_bolao_id?> valign="top">

...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_cons_rodadas').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_cons_rodadas').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_cons_rodadas').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_cons_rodadas').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_cons_rodadas').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_cons_rodadas').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_cons_rodadas').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_cons_rodadas').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_cons_rodadas').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_cons_rodadas').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_cons_rodadas').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_cons_rodadas').style.width  = '0px';
        if (oResp["setValue"]) {

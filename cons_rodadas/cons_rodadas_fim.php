...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_rodadas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_rodadas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_rodadas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_rodadas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_rodadas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_rodadas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_rodadas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_rodadas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_rodadas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_rodadas']['embutida_filho'] as $ind => $sc_init)
          {

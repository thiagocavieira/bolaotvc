...
<?php
   ...
   $Ord_Cmp = new cons_rodadas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class cons_rodadas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["competicao_id"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["competicao_id"])) ? $_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["competicao_id"] : "Competição";
   $tab_ger_campos['num_rodada'] = "on";
   $tab_def_campos['num_rodada'] = "num_rodada";
   $tab_labels["num_rodada"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["num_rodada"])) ? $_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["num_rodada"] : "Rodada";
   $tab_ger_campos['temporada_id'] = "on";
   $tab_def_campos['temporada_id'] = "temporada_id";
   $tab_labels["temporada_id"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["temporada_id"])) ? $_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["temporada_id"] : "Temporada";
   $tab_ger_campos['dt_hr_inicio'] = "on";
   $tab_def_campos['dt_hr_inicio'] = "dt_hr_inicio";
   $tab_labels["dt_hr_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["dt_hr_inicio"])) ? $_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["dt_hr_inicio"] : "Data / Hora Início";
   $tab_ger_campos['dt_hr_fim'] = "on";
   $tab_def_campos['dt_hr_fim'] = "dt_hr_fim";
   $tab_labels["dt_hr_fim"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["dt_hr_fim"])) ? $_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["dt_hr_fim"] : "Data / Hora Fim";
   $tab_ger_campos['rodada_atual'] = "on";
   $tab_def_campos['rodada_atual'] = "rodada_atual";
   $tab_labels["rodada_atual"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["rodada_atual"])) ? $_SESSION['sc_session'][$sc_init]['cons_rodadas']['labels']["rodada_atual"] : "Rodada Atual";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['cons_rodadas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['cons_rodadas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "cons_rodadas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['cons_rodadas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

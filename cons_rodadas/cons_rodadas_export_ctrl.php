<?php
@session_start() ;
$_SESSION['scriptcase']['cons_rodadas']['sc_process_barr'] = true;
require_once('../cons_rodadas/index.php');
unset($_SESSION['scriptcase']['cons_rodadas']['sc_process_barr']);
$ExportCtrl = new cons_rodadas_export_control;
$ExportCtrl->Export_barr();

class cons_rodadas_export_control
{

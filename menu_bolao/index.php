<?php
include_once('menu_bolao_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_bolao']['glo_nm_perfil']         = "bolaotvc";
    $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_bolao']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_bolao']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_bolao_class
{
  var $Db;
 ...
 function menu_bolao_menu()
 {
    global $menu_bolao_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_bolao']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_bolao/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_bolao');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_bolao_erro.php");
}
include_once(dirname(__FILE__) . "/menu_bolao_erro.class.php"); 
$this->Erro = new menu_bolao_erro();
$str_path = substr($_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$menu_bolao_menuData         = array();
$menu_bolao_menuData['path'] = array();
$menu_bolao_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_bolao_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_bolao_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_bolao_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_bolao_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_bolao_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_bolao_menuData['url']['web']   = str_replace("\\", '/', $menu_bolao_menuData['url']['web']);
$menu_bolao_menuData['path']['root'] = substr($menu_bolao_menuData['path']['sys'],  0, -1 * strlen($menu_bolao_menuData['url']['web']));
$menu_bolao_menuData['path']['app']  = substr($menu_bolao_menuData['path']['sys'],  0, strrpos($menu_bolao_menuData['path']['sys'],  '/'));
$menu_bolao_menuData['path']['link'] = substr($menu_bolao_menuData['path']['app'],  0, strrpos($menu_bolao_menuData['path']['app'],  '/'));
$menu_bolao_menuData['path']['link'] = substr($menu_bolao_menuData['path']['link'], 0, strrpos($menu_bolao_menuData['path']['link'], '/')) . '/';
$menu_bolao_menuData['path']['app'] .= '/';
$menu_bolao_menuData['url']['app']   = substr($menu_bolao_menuData['url']['web'],  0, strrpos($menu_bolao_menuData['url']['web'],  '/'));
$menu_bolao_menuData['url']['link']  = substr($menu_bolao_menuData['url']['app'],  0, strrpos($menu_bolao_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] == "S")
{
    $menu_bolao_menuData['url']['link']  = substr($menu_bolao_menuData['url']['link'], 0, strrpos($menu_bolao_menuData['url']['link'], '/'));
}
$menu_bolao_menuData['url']['link']  .= '/';
$menu_bolao_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_bolao']['sc_apl_link'] = $menu_bolao_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_bolao']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_bolao']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_bolao']['actual_lang']) || $_SESSION['scriptcase']['menu_bolao']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_bolao']['actual_lang'] = $this->str_lang;
...
include_once("menu_bolao_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_bolao";
     $_SESSION['scriptcase']['menu_apls']['menu_bolao'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_bolao']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_bolao']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_bolao']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_bolao']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_bolao']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_bolao']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_bolao']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_bolao']['init']))
{
    $_SESSION['sc_session'][1]['menu_bolao']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_bolao']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_bolao'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_bolao'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_bolao'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_bolao'] = "on";
} 
if (!isset($_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_bolao']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_bolao'] != "on"))
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'], 'exercicios', 2); 
}
if (isset($_SESSION['scriptcase']['menu_bolao']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_bolao']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_bolao']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_bolao']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_bolao']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_bolao']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_bolao']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_bolao']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_bolao']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu_bolao']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'], 'exercicios'); 
} 
else 
{ 
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['menu_bolao']['decimal_db'] = ".";
} 
//
      $_SESSION['scriptcase']['menu_bolao']['contr_erro'] = 'on';
...
{
    if (!isset($_SESSION['scriptcase']['sc_menu_disable']['menu_bolao']))
    {
        $_SESSION['scriptcase']['sc_menu_disable']['menu_bolao'] = array();
    }
    if (!in_array($Cada_dis, $_SESSION['scriptcase']['sc_menu_disable']['menu_bolao']))
    {
        $_SESSION['scriptcase']['sc_menu_disable']['menu_bolao'][] = trim($Cada_dis);
    }
}
...
foreach ($NM_tmp_dis as $Cada_dis)
{
	...
	unset($_SESSION['scriptcase']['sc_menu_disable']['menu_bolao']);}
if (isset($this->sc_temp_usr_login)) {$_SESSION['usr_login'] = $this->sc_temp_usr_login;}
$_SESSION['scriptcase']['menu_bolao']['contr_erro'] = 'off';
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_bolao'))
{
    $_SESSION['sc_session'][1]['menu_bolao']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_bolao'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$menu_bolao_menuData['iframe'] = TRUE;
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_bolao'];
...
{
    $menu_bolao_menuData['data'] .= "item_20|.|" . $nm_var_lab[0] . "|menu_bolao_form_php.php?sc_item_menu=item_20&sc_apl_menu=bl_jogos_dia_mobile&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

$menu_bolao_menuData['data'] .= "item_25|.|" . $nm_var_lab[1] . "||" . $nm_var_hint[1] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['cons_boloes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_boloes']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_37|..|" . $nm_var_lab[2] . "|menu_bolao_form_php.php?sc_item_menu=item_37&sc_apl_menu=cons_boloes&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_competicoes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_competicoes']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_26|..|" . $nm_var_lab[3] . "|menu_bolao_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_competicoes&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['cons_temporadas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_temporadas']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_4|..|" . $nm_var_lab[4] . "|menu_bolao_form_php.php?sc_item_menu=item_4&sc_apl_menu=cons_temporadas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['cons_rodadas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_rodadas']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_5|..|" . $nm_var_lab[5] . "|menu_bolao_form_php.php?sc_item_menu=item_5&sc_apl_menu=cons_rodadas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['cons_clubes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_clubes']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_27|..|" . $nm_var_lab[6] . "|menu_bolao_form_php.php?sc_item_menu=item_27&sc_apl_menu=cons_clubes&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_jogos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_jogos']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_2|.|" . $nm_var_lab[7] . "|menu_bolao_form_php.php?sc_item_menu=item_2&sc_apl_menu=ctrl_jogos&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

$menu_bolao_menuData['data'] .= "item_6|.|" . $nm_var_lab[8] . "||" . $nm_var_hint[8] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['classific_apostas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['classific_apostas']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_36|..|" . $nm_var_lab[9] . "|menu_bolao_form_php.php?sc_item_menu=item_36&sc_apl_menu=classific_apostas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['cons_apostas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_apostas']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_24|..|" . $nm_var_lab[10] . "|menu_bolao_form_php.php?sc_item_menu=item_24&sc_apl_menu=cons_apostas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_23|..|" . $nm_var_lab[11] . "|menu_bolao_form_php.php?sc_item_menu=item_23&sc_apl_menu=cons_apostas_geral&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_35|.|" . $nm_var_lab[12] . "|menu_bolao_form_php.php?sc_item_menu=item_35&sc_apl_menu=ctrl_classif_campeonato&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

$menu_bolao_menuData['data'] .= "item_7|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_users']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_8|..|" . $this->Nm_lang['lang_list_users'] . "|menu_bolao_form_php.php?sc_item_menu=item_8&sc_apl_menu=ap_grid_sec_users&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_apps']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_9|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_bolao_form_php.php?sc_item_menu=item_9&sc_apl_menu=ap_grid_sec_apps&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_10|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_bolao_form_php.php?sc_item_menu=item_10&sc_apl_menu=ap_grid_sec_groups&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_17|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|menu_bolao_form_php.php?sc_item_menu=item_17&sc_apl_menu=ap_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_bolao_form_php.php?sc_item_menu=item_11&sc_apl_menu=ap_search_sec_groups&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ap_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_sync_apps']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_12|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_bolao_form_php.php?sc_item_menu=item_12&sc_apl_menu=ap_sync_apps&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ap_logged_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_logged_users']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_logged_users'] . "|menu_bolao_form_php.php?sc_item_menu=item_15&sc_apl_menu=ap_logged_users&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_logged_users'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ap_add_2fa']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_add_2fa']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_18|..|" . $this->Nm_lang['lang_2fa'] . "|menu_bolao_form_php.php?sc_item_menu=item_18&sc_apl_menu=ap_add_2fa&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_2fa'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_34|..|" . $nm_var_lab[13] . "|menu_bolao_form_php.php?sc_item_menu=item_34&sc_apl_menu=ctrl_gravar_classificacao&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

$menu_bolao_menuData['data'] .= "item_30|..|" . $nm_var_lab[14] . "||" . $nm_var_hint[14] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_gravar_jogos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_gravar_jogos']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_31|...|" . $nm_var_lab[15] . "|menu_bolao_form_php.php?sc_item_menu=item_31&sc_apl_menu=ctrl_gravar_jogos&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_33|...|" . $nm_var_lab[16] . "|menu_bolao_form_php.php?sc_item_menu=item_33&sc_apl_menu=bl_gravar_jogos_do_dia&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}
...
{
    $menu_bolao_menuData['data'] .= "item_38|..|" . $nm_var_lab[17] . "|menu_bolao_form_php.php?sc_item_menu=item_38&sc_apl_menu=bl_calcular_apostas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[17] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ap_settings']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_settings']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_19|..|" . $this->Nm_lang['lang_settings'] . "|menu_bolao_form_php.php?sc_item_menu=item_19&sc_apl_menu=ap_settings&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[18] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ap_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_change_pswd']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_bolao_form_php.php?sc_item_menu=item_13&sc_apl_menu=ap_change_pswd&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_bolao_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['login']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_exit'] . "|menu_bolao_form_php.php?sc_item_menu=item_14&sc_apl_menu=login&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_bolao_target('_parent') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_trocar_bolao']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_trocar_bolao']) == "on")
{
    $menu_bolao_menuData['data'] .= "item_29|.|" . $nm_var_lab[18] . "|menu_bolao_form_php.php?sc_item_menu=item_29&sc_apl_menu=ctrl_trocar_bolao&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[19] . "||" . $this->menu_bolao_target('_parent') . "|" . "\n";
}
...
$menu_bolao_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_20&sc_apl_menu=bl_jogos_dia_mobile&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['bl_jogos_dia_mobile']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['bl_jogos_dia_mobile']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_bolao_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_bolao_target('_self') . "\"",
        'sc_id'    => "item_20",
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_37&sc_apl_menu=cons_boloes&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cons_boloes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_boloes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_competicoes&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_competicoes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_competicoes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_4&sc_apl_menu=cons_temporadas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cons_temporadas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_temporadas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_5&sc_apl_menu=cons_rodadas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cons_rodadas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_rodadas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_27&sc_apl_menu=cons_clubes&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cons_clubes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_clubes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_2&sc_apl_menu=ctrl_jogos&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_jogos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_jogos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_36&sc_apl_menu=classific_apostas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['classific_apostas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['classific_apostas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_24&sc_apl_menu=cons_apostas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cons_apostas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_apostas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_23&sc_apl_menu=cons_apostas_geral&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cons_apostas_geral']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cons_apostas_geral']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_35&sc_apl_menu=ctrl_classif_campeonato&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_classif_campeonato']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_classif_campeonato']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_8&sc_apl_menu=ap_grid_sec_users&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_9&sc_apl_menu=ap_grid_sec_apps&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_10&sc_apl_menu=ap_grid_sec_groups&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_17&sc_apl_menu=ap_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_11&sc_apl_menu=ap_search_sec_groups&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_12&sc_apl_menu=ap_sync_apps&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_15&sc_apl_menu=ap_logged_users&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_logged_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_logged_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_18&sc_apl_menu=ap_add_2fa&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_add_2fa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_add_2fa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_34&sc_apl_menu=ctrl_gravar_classificacao&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_gravar_classificacao']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_gravar_classificacao']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_31&sc_apl_menu=ctrl_gravar_jogos&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_gravar_jogos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_gravar_jogos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_33&sc_apl_menu=bl_gravar_jogos_do_dia&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['bl_gravar_jogos_do_dia']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['bl_gravar_jogos_do_dia']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_38&sc_apl_menu=bl_calcular_apostas&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['bl_calcular_apostas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['bl_calcular_apostas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_19&sc_apl_menu=ap_settings&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_settings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_settings']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_13&sc_apl_menu=ap_change_pswd&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ap_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ap_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_14&sc_apl_menu=login&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_bolao_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_bolao_target('_parent') . "\"",
        'sc_id'    => "item_14",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "menu_bolao_form_php.php?sc_item_menu=item_29&sc_apl_menu=ctrl_trocar_bolao&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ctrl_trocar_bolao']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ctrl_trocar_bolao']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_bolao']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_bolao']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_bolao');
    $menu_bolao_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_bolao_help.txt"))
{
    $Arq_WebHelp = file("menu_bolao_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_bolao_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_bolao_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_bolao']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_bolao']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_bolao_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_bolao']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_bolao_menuData['data'][$i_menu]);
       }
    ...
    $menu_bolao_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_bolao']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_bolao']))
{
    $disable_menu = false;
    foreach ($menu_bolao_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_bolao']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_bolao_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_bolao_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_bolao_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_bolao_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_bolao_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_bolao_menuData['data'][$chave]['level'];
                        unset($menu_bolao_menuData['data'][$chave]);
                }
        }
}
$menu_bolao_menuData['data'] = array_values($menu_bolao_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_bolao_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($menu_bolao_menuData['data'][$chave + 1]) && !empty($menu_bolao_menuData['data'][$chave + 1]))
            {
                if ($menu_bolao_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_bolao_menuData['data'][$chave]['level'] >= $menu_bolao_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_bolao_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_bolao_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_bolao_menuData['data'][$chave]);
            }
        }
...
if($this->force_mobile || ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']))
{
    $_SESSION['scriptcase']['menu_mobile'] = "menu_bolao";
    include('menu_bolao_mobile.php');
    exit;
}
/* Cabeçalho HTML */
if ($menu_bolao_menuData['iframe'])
{
    $menu_bolao_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $menu_bolao_menuData['height'] = '30px';
}
...
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_bolao_message.js"></script>
...
Iframe_atual = "menu_bolao_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_bolao\";\r\n";
echo "Tab_labels['menu_bolao'] = \"\";\r\n";
echo "Tab_hints['menu_bolao'] = \"\";\r\n";
echo "Tab_abas['menu_bolao']   = \"none\";\r\n";
echo "Tab_refresh['menu_bolao']   = \"\";\r\n";
echo "Tab_icons['menu_bolao'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_bolao'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_bolao']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_bolao']   = \"\";\r\n";
echo "Tab_display['menu_bolao']   = \"\";\r\n";
echo "Tab_display_position['menu_bolao']   = \"\";\r\n";
echo "Tab_links['menu_bolao']   = \"\";\r\n";
         $seq++;
 if(isset($menu_bolao_menuData['data']) && !empty($menu_bolao_menuData['data']))
 {
   foreach ($menu_bolao_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_bolao_menuData['data_vertical']) && !empty($menu_bolao_menuData['data_vertical']))
 {
   foreach ($menu_bolao_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_bolao_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_bolao'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_bolao').hide();
    if (str_id == "")
    {
        $('#iframe_menu_bolao').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_bolao_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            if (Tab_iframes[i] != 'menu_bolao') 
            {
                Iframe_atual = "menu_bolao_" + Tab_iframes[i] + '_iframe';
            }
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_bolao")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_bolao_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_bolao', 'menu_bolao');
    if (str_target == "menu_bolao_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_bolao")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "menu_bolao" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_menu_bolao').length)
        $('#iframe_menu_bolao')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_bolao_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->menu_bolao_escreveMenu($menu_bolao_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_bolao_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_bolao');\" item-href=\"menu_bolao_form_php.php?sc_item_menu=menu_bolao&sc_apl_menu=bl_jogos_dia_mobile&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_bolao_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_bolao_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_bolao" name="menu_bolao_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_bolao').click()";
    echo "</script>";
}
...
/* Controle de Target */
function menu_bolao_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
?>
        <td class='sc-layer-2' style='width:12.00%;text-align:center;'>
  ...
  <div class='mainmenu menu--horizontal'>
      ...
      <div class='menu__container'>
        ...
        <td class='sc-layer-1' style='width:13.00%;text-align:center;'>
...
function menu_bolao_target($str_target)
{
    global $menu_bolao_menuData;
    ...
    elseif ($menu_bolao_menuData['iframe'])
    {
        return 'menu_bolao_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_bolao_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_bolao_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_bolao_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_bolao_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_bolao']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_bolao_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_bolao']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_bolao']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_bolao']['sc_init'][$apl_menu];
   }
...
;
 ...
 {
$this->nmgp_redireciona_form($_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('ap_logged') . "/", "menu_bolao_form_php.php", "user?#?" . NM_encode_input($user) . "?@?","_self", 440, 630);
 };
            return false;
        }
$_SESSION['scriptcase']['menu_bolao']['contr_erro'] = 'off';
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('ap_Login') . "/", "menu_bolao_form_php.php", "","_parent", 440, 630);
 };
        }
if (isset($this->sc_temp_logged_user)) {$_SESSION['logged_user'] = $this->sc_temp_logged_user;}
if (isset($this->sc_temp_logged_date_login)) {$_SESSION['logged_date_login'] = $this->sc_temp_logged_date_login;}
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0)
   {
      ...
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][1]['menu_bolao'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      {
          $nm_apl_dest = str_replace(".php", "", $nm_apl_dest);
          $nm_apl_dest = $menu_bolao_menuData['url']['link'] . $this->tab_grupo[0] .$nm_apl_dest . "/" . $nm_apl_dest . ".php";
      }
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_imag_temp'] . "/sc_apl_default_exercicios.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_bolao']['glo_nm_path_imag_temp'] . "/sc_apl_default_exercicios.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_bolao") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_bolao']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_exercicios'])) {
            $_SESSION['scriptcase']['menu_bolao']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_exercicios'];
        }
    }
}
...
$contr_menu_bolao = new menu_bolao_class;
$contr_menu_bolao->menu_bolao_menu();

<?php
@session_start() ;
$_SESSION['scriptcase']['cons_clubes']['sc_process_barr'] = true;
require_once('../cons_clubes/index.php');
unset($_SESSION['scriptcase']['cons_clubes']['sc_process_barr']);
$ExportCtrl = new cons_clubes_export_control;
$ExportCtrl->Export_barr();

class cons_clubes_export_control
{

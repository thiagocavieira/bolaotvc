...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "clube_id";$Nm_numeric[] = "competicao_id";$Nm_numeric[] = "clube_id";$Nm_numeric[] = "competicao_id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_competicao_id"  <?php echo $str_hide_competicao_id?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nome_clube"  <?php echo $str_hide_nome_clube?>><?php
      if ($nome_clube != "")
      {
      $nome_clube_look = substr($this->Db->qstr($nome_clube), 1, -1); 
      $nmgp_def_dados = array(); 

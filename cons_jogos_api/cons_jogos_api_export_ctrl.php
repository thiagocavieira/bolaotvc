<?php
@session_start() ;
$_SESSION['scriptcase']['cons_jogos_api']['sc_process_barr'] = true;
require_once('../cons_jogos_api/index.php');
unset($_SESSION['scriptcase']['cons_jogos_api']['sc_process_barr']);
$ExportCtrl = new cons_jogos_api_export_control;
$ExportCtrl->Export_barr();

class cons_jogos_api_export_control
{

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clubes" == sTestField)
        {
...
?>
  ...
  // ---------- Validate clube_id
  function do_ajax_form_clubes_validate_clube_id()
  {
    var nomeCampo_clube_id = "clube_id";
    var var_clube_id = scAjaxGetFieldHidden(nomeCampo_clube_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_validate_clube_id(var_clube_id, var_script_case_init, do_ajax_form_clubes_validate_clube_id_cb);
  } // do_ajax_form_clubes_validate_clube_id

  function do_ajax_form_clubes_validate_clube_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_validate_clube_id_cb

  // ---------- Validate competicao_id
  function do_ajax_form_clubes_validate_competicao_id()
  {
    var nomeCampo_competicao_id = "competicao_id";
    var var_competicao_id = scAjaxGetFieldSelect(nomeCampo_competicao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_validate_competicao_id(var_competicao_id, var_script_case_init, do_ajax_form_clubes_validate_competicao_id_cb);
  } // do_ajax_form_clubes_validate_competicao_id

  function do_ajax_form_clubes_validate_competicao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_validate_competicao_id_cb

  // ---------- Validate nome_clube
  function do_ajax_form_clubes_validate_nome_clube()
  {
    var nomeCampo_nome_clube = "nome_clube";
    var var_nome_clube = scAjaxGetFieldText(nomeCampo_nome_clube);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_validate_nome_clube(var_nome_clube, var_script_case_init, do_ajax_form_clubes_validate_nome_clube_cb);
  } // do_ajax_form_clubes_validate_nome_clube

  function do_ajax_form_clubes_validate_nome_clube_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_validate_nome_clube_cb

  // ---------- Validate brasao_url
  function do_ajax_form_clubes_validate_brasao_url()
  {
    var nomeCampo_brasao_url = "brasao_url";
    var var_brasao_url = scAjaxGetFieldText(nomeCampo_brasao_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_validate_brasao_url(var_brasao_url, var_script_case_init, do_ajax_form_clubes_validate_brasao_url_cb);
  } // do_ajax_form_clubes_validate_brasao_url

  function do_ajax_form_clubes_validate_brasao_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_validate_brasao_url_cb

  // ---------- Validate nome_api_clube
  function do_ajax_form_clubes_validate_nome_api_clube()
  {
    var nomeCampo_nome_api_clube = "nome_api_clube";
    var var_nome_api_clube = scAjaxGetFieldText(nomeCampo_nome_api_clube);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_validate_nome_api_clube(var_nome_api_clube, var_script_case_init, do_ajax_form_clubes_validate_nome_api_clube_cb);
  } // do_ajax_form_clubes_validate_nome_api_clube

  function do_ajax_form_clubes_validate_nome_api_clube_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_validate_nome_api_clube_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clubes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clubes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clubes_submit_form(var_clube_id, var_competicao_id, var_nome_clube, var_brasao_url, var_nome_api_clube, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clubes_submit_form_cb);
  } // do_ajax_form_clubes_submit_form

  function do_ajax_form_clubes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clubes_submit_form_cb_after_alert);
  } // do_ajax_form_clubes_submit_form_cb
  function do_ajax_form_clubes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clubes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clubes_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clubes_navigate_form, function() {});
    } else {
      perform_ajax_form_clubes_navigate_form();
    }
  }

  function perform_ajax_form_clubes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_clubes_navigate_form(var_clube_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clubes_navigate_form_cb);
  } // do_ajax_form_clubes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clubes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clubes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clubes_navigate_form_cb_after_alert);
  } // do_ajax_form_clubes_navigate_form_cb
  function do_ajax_form_clubes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clubes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clubes_navigate_form_cb_after_alert

  function sc_hide_form_clubes_form()
  {

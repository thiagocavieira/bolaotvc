  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clubes_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate clube_id
  function do_ajax_form_clubes_mob_validate_clube_id()
  {
    var nomeCampo_clube_id = "clube_id";
    var var_clube_id = scAjaxGetFieldHidden(nomeCampo_clube_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_mob_validate_clube_id(var_clube_id, var_script_case_init, do_ajax_form_clubes_mob_validate_clube_id_cb);
  } // do_ajax_form_clubes_mob_validate_clube_id

  function do_ajax_form_clubes_mob_validate_clube_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clube_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_mob_validate_clube_id_cb

  // ---------- Validate competicao_id
  function do_ajax_form_clubes_mob_validate_competicao_id()
  {
    var nomeCampo_competicao_id = "competicao_id";
    var var_competicao_id = scAjaxGetFieldSelect(nomeCampo_competicao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_mob_validate_competicao_id(var_competicao_id, var_script_case_init, do_ajax_form_clubes_mob_validate_competicao_id_cb);
  } // do_ajax_form_clubes_mob_validate_competicao_id

  function do_ajax_form_clubes_mob_validate_competicao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_mob_validate_competicao_id_cb

  // ---------- Validate nome_clube
  function do_ajax_form_clubes_mob_validate_nome_clube()
  {
    var nomeCampo_nome_clube = "nome_clube";
    var var_nome_clube = scAjaxGetFieldText(nomeCampo_nome_clube);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_mob_validate_nome_clube(var_nome_clube, var_script_case_init, do_ajax_form_clubes_mob_validate_nome_clube_cb);
  } // do_ajax_form_clubes_mob_validate_nome_clube

  function do_ajax_form_clubes_mob_validate_nome_clube_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_clube";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_mob_validate_nome_clube_cb

  // ---------- Validate brasao_url
  function do_ajax_form_clubes_mob_validate_brasao_url()
  {
    var nomeCampo_brasao_url = "brasao_url";
    var var_brasao_url = scAjaxGetFieldText(nomeCampo_brasao_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_mob_validate_brasao_url(var_brasao_url, var_script_case_init, do_ajax_form_clubes_mob_validate_brasao_url_cb);
  } // do_ajax_form_clubes_mob_validate_brasao_url

  function do_ajax_form_clubes_mob_validate_brasao_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "brasao_url";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_mob_validate_brasao_url_cb

  // ---------- Validate nome_api_clube
  function do_ajax_form_clubes_mob_validate_nome_api_clube()
  {
    var nomeCampo_nome_api_clube = "nome_api_clube";
    var var_nome_api_clube = scAjaxGetFieldText(nomeCampo_nome_api_clube);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clubes_mob_validate_nome_api_clube(var_nome_api_clube, var_script_case_init, do_ajax_form_clubes_mob_validate_nome_api_clube_cb);
  } // do_ajax_form_clubes_mob_validate_nome_api_clube

  function do_ajax_form_clubes_mob_validate_nome_api_clube_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_api_clube";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clubes_mob_validate_nome_api_clube_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clubes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clubes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_clube_id = scAjaxGetFieldHidden("clube_id");
    var var_competicao_id = scAjaxGetFieldSelect("competicao_id");
    var var_nome_clube = scAjaxGetFieldText("nome_clube");
    var var_brasao_url = scAjaxGetFieldText("brasao_url");
    var var_nome_api_clube = scAjaxGetFieldText("nome_api_clube");
    ...
    scAjaxProcOn();
    x_ajax_form_clubes_mob_submit_form(var_clube_id, var_competicao_id, var_nome_clube, var_brasao_url, var_nome_api_clube, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clubes_mob_submit_form_cb);
  } // do_ajax_form_clubes_mob_submit_form

  function do_ajax_form_clubes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("clube_id");
      scAjaxHideErrorDisplay("competicao_id");
      scAjaxHideErrorDisplay("nome_clube");
      scAjaxHideErrorDisplay("brasao_url");
      scAjaxHideErrorDisplay("nome_api_clube");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clubes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clubes_mob_submit_form_cb
  function do_ajax_form_clubes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clubes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clubes_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clubes_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_clubes_mob_navigate_form();
    }
  }

  function perform_ajax_form_clubes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("brasao_url");
    scAjaxHideErrorDisplay("nome_api_clube");
    var var_clube_id = document.F2.clube_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_clubes_mob_navigate_form(var_clube_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clubes_mob_navigate_form_cb);
  } // do_ajax_form_clubes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clubes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clubes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.clube_id.value = scAjaxGetKeyValue("clube_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clubes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clubes_mob_navigate_form_cb
  function do_ajax_form_clubes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clubes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clubes_mob_navigate_form_cb_after_alert

  function sc_hide_form_clubes_mob_form()
  {
  ...
  ajax_field_list[0] = "clube_id";
  ajax_field_list[1] = "competicao_id";
  ajax_field_list[2] = "nome_clube";
  ajax_field_list[3] = "brasao_url";
  ajax_field_list[4] = "nome_api_clube";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "clube_id": {"label": "Clube Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "nome_clube": {"label": "Nome Clube", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "brasao_url": {"label": "Brasao Url", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nome_api_clube": {"label": "Nome Api Clube", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "nome_clube": new Array(),
    "brasao_url": new Array(),
    "nome_api_clube": new Array()
  };
  ajax_field_mult["clube_id"][1] = "clube_id";
  ajax_field_mult["competicao_id"][1] = "competicao_id";
  ajax_field_mult["nome_clube"][1] = "nome_clube";
  ajax_field_mult["brasao_url"][1] = "brasao_url";
  ajax_field_mult["nome_api_clube"][1] = "nome_api_clube";

  var ajax_field_id = {
    "clube_id": new Array("hidden_field_label_clube_id", "hidden_field_data_clube_id"),
    "competicao_id": new Array("hidden_field_label_competicao_id", "hidden_field_data_competicao_id"),
    "nome_clube": new Array("hidden_field_label_nome_clube", "hidden_field_data_nome_clube"),
    "brasao_url": new Array("hidden_field_label_brasao_url", "hidden_field_data_brasao_url"),
    "nome_api_clube": new Array("hidden_field_label_nome_api_clube", "hidden_field_data_nome_api_clube")
  };

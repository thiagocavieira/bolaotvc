  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_apostas_1" == sTestField)
        {
...
?>
  ...
  // ---------- Validate aposta_id
  function do_ajax_form_apostas_1_validate_aposta_id()
  {
    var nomeCampo_aposta_id = "aposta_id";
    var var_aposta_id = scAjaxGetFieldHidden(nomeCampo_aposta_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_aposta_id(var_aposta_id, var_script_case_init, do_ajax_form_apostas_1_validate_aposta_id_cb);
  } // do_ajax_form_apostas_1_validate_aposta_id

  function do_ajax_form_apostas_1_validate_aposta_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_aposta_id_cb

  // ---------- Validate dt_hr_aposta
  function do_ajax_form_apostas_1_validate_dt_hr_aposta()
  {
    var nomeCampo_dt_hr_aposta = "dt_hr_aposta";
    var var_dt_hr_aposta = scAjaxGetFieldText(nomeCampo_dt_hr_aposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_dt_hr_aposta(var_dt_hr_aposta, var_script_case_init, do_ajax_form_apostas_1_validate_dt_hr_aposta_cb);
  } // do_ajax_form_apostas_1_validate_dt_hr_aposta

  function do_ajax_form_apostas_1_validate_dt_hr_aposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_dt_hr_aposta_cb

  // ---------- Validate login_id
  function do_ajax_form_apostas_1_validate_login_id()
  {
    var nomeCampo_login_id = "login_id";
    var var_login_id = scAjaxGetFieldText(nomeCampo_login_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_login_id(var_login_id, var_script_case_init, do_ajax_form_apostas_1_validate_login_id_cb);
  } // do_ajax_form_apostas_1_validate_login_id

  function do_ajax_form_apostas_1_validate_login_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_login_id_cb

  // ---------- Validate time_casa_placar
  function do_ajax_form_apostas_1_validate_time_casa_placar()
  {
    var nomeCampo_time_casa_placar = "time_casa_placar";
    var var_time_casa_placar = scAjaxGetFieldText(nomeCampo_time_casa_placar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_time_casa_placar(var_time_casa_placar, var_script_case_init, do_ajax_form_apostas_1_validate_time_casa_placar_cb);
  } // do_ajax_form_apostas_1_validate_time_casa_placar

  function do_ajax_form_apostas_1_validate_time_casa_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_time_casa_placar_cb

  // ---------- Validate time_visitante_placar
  function do_ajax_form_apostas_1_validate_time_visitante_placar()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_time_visitante_placar(var_time_visitante_placar, var_script_case_init, do_ajax_form_apostas_1_validate_time_visitante_placar_cb);
  } // do_ajax_form_apostas_1_validate_time_visitante_placar

  function do_ajax_form_apostas_1_validate_time_visitante_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_time_visitante_placar_cb

  // ---------- Validate pontos
  function do_ajax_form_apostas_1_validate_pontos()
  {
    var nomeCampo_pontos = "pontos";
    var var_pontos = scAjaxGetFieldText(nomeCampo_pontos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_pontos(var_pontos, var_script_case_init, do_ajax_form_apostas_1_validate_pontos_cb);
  } // do_ajax_form_apostas_1_validate_pontos

  function do_ajax_form_apostas_1_validate_pontos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pontos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_pontos_cb

  // ---------- Validate jogo_id
  function do_ajax_form_apostas_1_validate_jogo_id()
  {
    var nomeCampo_jogo_id = "jogo_id";
    var var_jogo_id = scAjaxGetFieldText(nomeCampo_jogo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_jogo_id(var_jogo_id, var_script_case_init, do_ajax_form_apostas_1_validate_jogo_id_cb);
  } // do_ajax_form_apostas_1_validate_jogo_id

  function do_ajax_form_apostas_1_validate_jogo_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jogo_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_jogo_id_cb

  // ---------- Validate competicao_id
  function do_ajax_form_apostas_1_validate_competicao_id()
  {
    var nomeCampo_competicao_id = "competicao_id";
    var var_competicao_id = scAjaxGetFieldText(nomeCampo_competicao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_competicao_id(var_competicao_id, var_script_case_init, do_ajax_form_apostas_1_validate_competicao_id_cb);
  } // do_ajax_form_apostas_1_validate_competicao_id

  function do_ajax_form_apostas_1_validate_competicao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_competicao_id_cb

  // ---------- Validate l_calc_aposta
  function do_ajax_form_apostas_1_validate_l_calc_aposta()
  {
    var nomeCampo_l_calc_aposta = "l_calc_aposta";
    var var_l_calc_aposta = scAjaxGetFieldText(nomeCampo_l_calc_aposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_validate_l_calc_aposta(var_l_calc_aposta, var_script_case_init, do_ajax_form_apostas_1_validate_l_calc_aposta_cb);
  } // do_ajax_form_apostas_1_validate_l_calc_aposta

  function do_ajax_form_apostas_1_validate_l_calc_aposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_validate_l_calc_aposta_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_apostas_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_apostas_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_apostas_1_submit_form(var_aposta_id, var_dt_hr_aposta, var_login_id, var_time_casa_placar, var_time_visitante_placar, var_pontos, var_jogo_id, var_competicao_id, var_l_calc_aposta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_apostas_1_submit_form_cb);
  } // do_ajax_form_apostas_1_submit_form

  function do_ajax_form_apostas_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_apostas_1_submit_form_cb_after_alert);
  } // do_ajax_form_apostas_1_submit_form_cb
  function do_ajax_form_apostas_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_apostas_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_apostas_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_apostas_1_navigate_form, function() {});
    } else {
      perform_ajax_form_apostas_1_navigate_form();
    }
  }

  function perform_ajax_form_apostas_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_apostas_1_navigate_form(var_aposta_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_apostas_1_navigate_form_cb);
  } // do_ajax_form_apostas_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_apostas_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_apostas_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_apostas_1_navigate_form_cb_after_alert);
  } // do_ajax_form_apostas_1_navigate_form_cb
  function do_ajax_form_apostas_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_apostas_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_apostas_1_navigate_form_cb_after_alert

  function sc_hide_form_apostas_1_form()
  {

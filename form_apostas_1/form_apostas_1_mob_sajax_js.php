  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_apostas_1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_apostas_1_mob_form();
	}
...
?>
  ...
  // ---------- Validate aposta_id
  function do_ajax_form_apostas_1_mob_validate_aposta_id()
  {
    var nomeCampo_aposta_id = "aposta_id";
    var var_aposta_id = scAjaxGetFieldHidden(nomeCampo_aposta_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_aposta_id(var_aposta_id, var_script_case_init, do_ajax_form_apostas_1_mob_validate_aposta_id_cb);
  } // do_ajax_form_apostas_1_mob_validate_aposta_id

  function do_ajax_form_apostas_1_mob_validate_aposta_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aposta_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_aposta_id_cb

  // ---------- Validate dt_hr_aposta
  function do_ajax_form_apostas_1_mob_validate_dt_hr_aposta()
  {
    var nomeCampo_dt_hr_aposta = "dt_hr_aposta";
    var var_dt_hr_aposta = scAjaxGetFieldText(nomeCampo_dt_hr_aposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_dt_hr_aposta(var_dt_hr_aposta, var_script_case_init, do_ajax_form_apostas_1_mob_validate_dt_hr_aposta_cb);
  } // do_ajax_form_apostas_1_mob_validate_dt_hr_aposta

  function do_ajax_form_apostas_1_mob_validate_dt_hr_aposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dt_hr_aposta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_dt_hr_aposta_cb

  // ---------- Validate login_id
  function do_ajax_form_apostas_1_mob_validate_login_id()
  {
    var nomeCampo_login_id = "login_id";
    var var_login_id = scAjaxGetFieldText(nomeCampo_login_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_login_id(var_login_id, var_script_case_init, do_ajax_form_apostas_1_mob_validate_login_id_cb);
  } // do_ajax_form_apostas_1_mob_validate_login_id

  function do_ajax_form_apostas_1_mob_validate_login_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_login_id_cb

  // ---------- Validate time_casa_placar
  function do_ajax_form_apostas_1_mob_validate_time_casa_placar()
  {
    var nomeCampo_time_casa_placar = "time_casa_placar";
    var var_time_casa_placar = scAjaxGetFieldText(nomeCampo_time_casa_placar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_time_casa_placar(var_time_casa_placar, var_script_case_init, do_ajax_form_apostas_1_mob_validate_time_casa_placar_cb);
  } // do_ajax_form_apostas_1_mob_validate_time_casa_placar

  function do_ajax_form_apostas_1_mob_validate_time_casa_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "time_casa_placar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_time_casa_placar_cb

  // ---------- Validate time_visitante_placar
  function do_ajax_form_apostas_1_mob_validate_time_visitante_placar()
  {
    var nomeCampo_time_visitante_placar = "time_visitante_placar";
    var var_time_visitante_placar = scAjaxGetFieldText(nomeCampo_time_visitante_placar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_time_visitante_placar(var_time_visitante_placar, var_script_case_init, do_ajax_form_apostas_1_mob_validate_time_visitante_placar_cb);
  } // do_ajax_form_apostas_1_mob_validate_time_visitante_placar

  function do_ajax_form_apostas_1_mob_validate_time_visitante_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "time_visitante_placar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_time_visitante_placar_cb

  // ---------- Validate pontos
  function do_ajax_form_apostas_1_mob_validate_pontos()
  {
    var nomeCampo_pontos = "pontos";
    var var_pontos = scAjaxGetFieldText(nomeCampo_pontos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_pontos(var_pontos, var_script_case_init, do_ajax_form_apostas_1_mob_validate_pontos_cb);
  } // do_ajax_form_apostas_1_mob_validate_pontos

  function do_ajax_form_apostas_1_mob_validate_pontos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pontos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_pontos_cb

  // ---------- Validate jogo_id
  function do_ajax_form_apostas_1_mob_validate_jogo_id()
  {
    var nomeCampo_jogo_id = "jogo_id";
    var var_jogo_id = scAjaxGetFieldText(nomeCampo_jogo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_jogo_id(var_jogo_id, var_script_case_init, do_ajax_form_apostas_1_mob_validate_jogo_id_cb);
  } // do_ajax_form_apostas_1_mob_validate_jogo_id

  function do_ajax_form_apostas_1_mob_validate_jogo_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jogo_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_jogo_id_cb

  // ---------- Validate competicao_id
  function do_ajax_form_apostas_1_mob_validate_competicao_id()
  {
    var nomeCampo_competicao_id = "competicao_id";
    var var_competicao_id = scAjaxGetFieldText(nomeCampo_competicao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_competicao_id(var_competicao_id, var_script_case_init, do_ajax_form_apostas_1_mob_validate_competicao_id_cb);
  } // do_ajax_form_apostas_1_mob_validate_competicao_id

  function do_ajax_form_apostas_1_mob_validate_competicao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "competicao_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_competicao_id_cb

  // ---------- Validate l_calc_aposta
  function do_ajax_form_apostas_1_mob_validate_l_calc_aposta()
  {
    var nomeCampo_l_calc_aposta = "l_calc_aposta";
    var var_l_calc_aposta = scAjaxGetFieldText(nomeCampo_l_calc_aposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_1_mob_validate_l_calc_aposta(var_l_calc_aposta, var_script_case_init, do_ajax_form_apostas_1_mob_validate_l_calc_aposta_cb);
  } // do_ajax_form_apostas_1_mob_validate_l_calc_aposta

  function do_ajax_form_apostas_1_mob_validate_l_calc_aposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "l_calc_aposta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_1_mob_validate_l_calc_aposta_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_apostas_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_apostas_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_aposta_id = scAjaxGetFieldHidden("aposta_id");
    var var_dt_hr_aposta = scAjaxGetFieldText("dt_hr_aposta");
    var var_login_id = scAjaxGetFieldText("login_id");
    var var_time_casa_placar = scAjaxGetFieldText("time_casa_placar");
    var var_time_visitante_placar = scAjaxGetFieldText("time_visitante_placar");
    var var_pontos = scAjaxGetFieldText("pontos");
    var var_jogo_id = scAjaxGetFieldText("jogo_id");
    var var_competicao_id = scAjaxGetFieldText("competicao_id");
    var var_l_calc_aposta = scAjaxGetFieldText("l_calc_aposta");
    ...
    scAjaxProcOn();
    x_ajax_form_apostas_1_mob_submit_form(var_aposta_id, var_dt_hr_aposta, var_login_id, var_time_casa_placar, var_time_visitante_placar, var_pontos, var_jogo_id, var_competicao_id, var_l_calc_aposta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_apostas_1_mob_submit_form_cb);
  } // do_ajax_form_apostas_1_mob_submit_form

  function do_ajax_form_apostas_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("aposta_id");
      scAjaxHideErrorDisplay("dt_hr_aposta");
      scAjaxHideErrorDisplay("login_id");
      scAjaxHideErrorDisplay("time_casa_placar");
      scAjaxHideErrorDisplay("time_visitante_placar");
      scAjaxHideErrorDisplay("pontos");
      scAjaxHideErrorDisplay("jogo_id");
      scAjaxHideErrorDisplay("competicao_id");
      scAjaxHideErrorDisplay("l_calc_aposta");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_apostas_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_apostas_1_mob_submit_form_cb
  function do_ajax_form_apostas_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_apostas_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_apostas_1_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_apostas_1_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_apostas_1_mob_navigate_form();
    }
  }

  function perform_ajax_form_apostas_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("competicao_id");
    scAjaxHideErrorDisplay("l_calc_aposta");
    var var_aposta_id = document.F2.aposta_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_apostas_1_mob_navigate_form(var_aposta_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_apostas_1_mob_navigate_form_cb);
  } // do_ajax_form_apostas_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_apostas_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_apostas_1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.aposta_id.value = scAjaxGetKeyValue("aposta_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_apostas_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_apostas_1_mob_navigate_form_cb
  function do_ajax_form_apostas_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_apostas_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_apostas_1_mob_navigate_form_cb_after_alert

  function sc_hide_form_apostas_1_mob_form()
  {
  ...
  ajax_field_list[0] = "aposta_id";
  ajax_field_list[1] = "dt_hr_aposta";
  ajax_field_list[2] = "login_id";
  ajax_field_list[3] = "time_casa_placar";
  ajax_field_list[4] = "time_visitante_placar";
  ajax_field_list[5] = "pontos";
  ajax_field_list[6] = "jogo_id";
  ajax_field_list[7] = "competicao_id";
  ajax_field_list[8] = "l_calc_aposta";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "aposta_id": {"label": "Aposta Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dt_hr_aposta": {"label": "Dt Hr Aposta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "login_id": {"label": "Login Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_casa_placar": {"label": "Time Casa Placar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_visitante_placar": {"label": "Time Visitante Placar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pontos": {"label": "Pontos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jogo_id": {"label": "Jogo Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "competicao_id": {"label": "Competicao Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "l_calc_aposta": {"label": "L Calc Aposta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "aposta_id": new Array(),
    "dt_hr_aposta": new Array(),
    "login_id": new Array(),
    "time_casa_placar": new Array(),
    "time_visitante_placar": new Array(),
    "pontos": new Array(),
    "jogo_id": new Array(),
    "competicao_id": new Array(),
    "l_calc_aposta": new Array()
  };
  ajax_field_mult["aposta_id"][1] = "aposta_id";
  ajax_field_mult["dt_hr_aposta"][1] = "dt_hr_aposta";
  ajax_field_mult["login_id"][1] = "login_id";
  ajax_field_mult["time_casa_placar"][1] = "time_casa_placar";
  ajax_field_mult["time_visitante_placar"][1] = "time_visitante_placar";
  ajax_field_mult["pontos"][1] = "pontos";
  ajax_field_mult["jogo_id"][1] = "jogo_id";
  ajax_field_mult["competicao_id"][1] = "competicao_id";
  ajax_field_mult["l_calc_aposta"][1] = "l_calc_aposta";

  var ajax_field_id = {
    "aposta_id": new Array("hidden_field_label_aposta_id", "hidden_field_data_aposta_id"),
    "dt_hr_aposta": new Array("hidden_field_label_dt_hr_aposta", "hidden_field_data_dt_hr_aposta"),
    "login_id": new Array("hidden_field_label_login_id", "hidden_field_data_login_id"),
    "time_casa_placar": new Array("hidden_field_label_time_casa_placar", "hidden_field_data_time_casa_placar"),
    "time_visitante_placar": new Array("hidden_field_label_time_visitante_placar", "hidden_field_data_time_visitante_placar"),
    "pontos": new Array("hidden_field_label_pontos", "hidden_field_data_pontos"),
    "jogo_id": new Array("hidden_field_label_jogo_id", "hidden_field_data_jogo_id"),
    "competicao_id": new Array("hidden_field_label_competicao_id", "hidden_field_data_competicao_id"),
    "l_calc_aposta": new Array("hidden_field_label_l_calc_aposta", "hidden_field_data_l_calc_aposta")
  };
  ...
  var ajax_read_only = {
    ...
    "dt_hr_aposta": "off",
    "login_id": "off",
    "time_casa_placar": "off",
    "time_visitante_placar": "off",
    "pontos": "off",
    "jogo_id": "off",
    "competicao_id": "off",
    "l_calc_aposta": "off"
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("time_visitante_placar" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);

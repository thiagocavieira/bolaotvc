...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_relacs_bolao_usuar']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_relacs_bolao_usuar']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['form_relacs_bolao_usuar']['upload_field_info'][ $_POST['param_field'] ];

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_altera_apostas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_altera_apostas_mob_form();
	}
...
?>
  ...
  // ---------- Validate bolao_id
  function do_ajax_form_altera_apostas_mob_validate_bolao_id()
  {
    var nomeCampo_bolao_id = "bolao_id";
    var var_bolao_id = scAjaxGetFieldSelect(nomeCampo_bolao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_altera_apostas_mob_validate_bolao_id(var_bolao_id, var_script_case_init, do_ajax_form_altera_apostas_mob_validate_bolao_id_cb);
  } // do_ajax_form_altera_apostas_mob_validate_bolao_id

  function do_ajax_form_altera_apostas_mob_validate_bolao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bolao_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_altera_apostas_mob_validate_bolao_id_cb

  // ---------- Validate time_casa
  function do_ajax_form_altera_apostas_mob_validate_time_casa()
  {
    var nomeCampo_time_casa = "time_casa";
    var var_time_casa = scAjaxGetFieldText(nomeCampo_time_casa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_altera_apostas_mob_validate_time_casa(var_time_casa, var_script_case_init, do_ajax_form_altera_apostas_mob_validate_time_casa_cb);
  } // do_ajax_form_altera_apostas_mob_validate_time_casa

  function do_ajax_form_altera_apostas_mob_validate_time_casa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_altera_apostas_mob_validate_time_casa_cb

  // ---------- Validate time_casa_placar
  function do_ajax_form_altera_apostas_mob_validate_time_casa_placar()
  {
    var nomeCampo_time_casa_placar = "time_casa_placar";
    var var_time_casa_placar = scAjaxGetFieldText(nomeCampo_time_casa_placar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_altera_apostas_mob_validate_time_casa_placar(var_time_casa_placar, var_script_case_init, do_ajax_form_altera_apostas_mob_validate_time_casa_placar_cb);
  } // do_ajax_form_altera_apostas_mob_validate_time_casa_placar

  function do_ajax_form_altera_apostas_mob_validate_time_casa_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_altera_apostas_mob_validate_time_casa_placar_cb

  // ---------- Validate time_visitante
  function do_ajax_form_altera_apostas_mob_validate_time_visitante()
  {
    var nomeCampo_time_visitante = "time_visitante";
    var var_time_visitante = scAjaxGetFieldText(nomeCampo_time_visitante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_altera_apostas_mob_validate_time_visitante(var_time_visitante, var_script_case_init, do_ajax_form_altera_apostas_mob_validate_time_visitante_cb);
  } // do_ajax_form_altera_apostas_mob_validate_time_visitante

  function do_ajax_form_altera_apostas_mob_validate_time_visitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_altera_apostas_mob_validate_time_visitante_cb

  // ---------- Validate time_visitante_placar
  function do_ajax_form_altera_apostas_mob_validate_time_visitante_placar()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_altera_apostas_mob_validate_time_visitante_placar(var_time_visitante_placar, var_script_case_init, do_ajax_form_altera_apostas_mob_validate_time_visitante_placar_cb);
  } // do_ajax_form_altera_apostas_mob_validate_time_visitante_placar

  function do_ajax_form_altera_apostas_mob_validate_time_visitante_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_altera_apostas_mob_validate_time_visitante_placar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_altera_apostas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_altera_apostas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_bolao_id = scAjaxGetFieldSelect("bolao_id");
    ...
    scAjaxProcOn();
    x_ajax_form_altera_apostas_mob_submit_form(var_bolao_id, var_time_casa, var_time_casa_placar, var_time_visitante, var_time_visitante_placar, var_aposta_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_altera_apostas_mob_submit_form_cb);
  } // do_ajax_form_altera_apostas_mob_submit_form

  function do_ajax_form_altera_apostas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("bolao_id");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_altera_apostas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_altera_apostas_mob_submit_form_cb
  function do_ajax_form_altera_apostas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_altera_apostas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_altera_apostas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_altera_apostas_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_altera_apostas_mob_navigate_form();
    }
  }

  function perform_ajax_form_altera_apostas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_altera_apostas_mob_navigate_form(var_aposta_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_altera_apostas_mob_navigate_form_cb);
  } // do_ajax_form_altera_apostas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_altera_apostas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_altera_apostas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_altera_apostas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_altera_apostas_mob_navigate_form_cb
  function do_ajax_form_altera_apostas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_altera_apostas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_altera_apostas_mob_navigate_form_cb_after_alert

  function sc_hide_form_altera_apostas_mob_form()
  {
  ...
  var ajax_error_list = {
    "bolao_id": {"label": "Bolão", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["bolao_id"][1] = "bolao_id";
  ...
  var ajax_field_id = {
    "bolao_id": new Array("hidden_field_label_bolao_id", "hidden_field_data_bolao_id"),

...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['grid_pesq'] = array();
   }
   $this->seq_iframe_emb = 0;
   if (!is_file($this->Ini->link_grid_apostas_copa_cons_emb))
   {
   ...
   else
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['exibe_titulos'] = "S";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['exibe_total'] = "S";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['exibe_seq'] = "S";
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['charts_html'] = '';
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['cons_jogos_brasil'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("pt_br");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_pdf']['all_label'] : "S";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "cons_jogos_brasil/cons_jogos_brasil_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['mostra_edit'] = "N";
   }
   $this->NM_cont_emb_linha = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['emb_linha'];
   $this->NM_cont_body   = 0; 
   $this->NM_emb_tree_no = false; 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("cons_jogos_brasil", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->nmgp_botoes['bt_apostar'] = "on";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   { 
       ...
       $data_jogo_2 = (isset($Busca_temp['data_jogo_input_2'])) ? $Busca_temp['data_jogo_input_2'] : ""; 
       $this->data_jogo_2 = $data_jogo_2; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "muda_qt_linhas";
   } 
       ob_start(); 
...
$_SESSION['scriptcase']['cons_jogos_brasil']['contr_erro'] = 'off'; 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cons_jogos_brasil'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cons_jogos_brasil'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "cons_jogos_brasil/cons_jogos_brasil_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "cons_jogos_brasil_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_select'] = array(); 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['prim_cons'] || !empty($nmgp_parms))  
   { 
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->data_jogo = $this->rs_grid->fields[0] ;  
       $this->horario = $this->rs_grid->fields[1] ;  
       ...
       $this->competicao_id = $this->rs_grid->fields[5] ;  
       $this->competicao_id = (string)$this->competicao_id;
       $this->jogo_id = $this->rs_grid->fields[6] ;  
       $this->jogo_id = (string)$this->jogo_id;
       $this->time_visitante_placar = $this->rs_grid->fields[7] ;  
       $this->time_visitante_placar = (string)$this->time_visitante_placar;
       $this->time_casa_placar = $this->rs_grid->fields[8] ;  
       $this->time_casa_placar = (string)$this->time_casa_placar;
       $this->jogo_api_id = $this->rs_grid->fields[9] ;  
       ...
       $GLOBALS["competicao_id"] = $this->rs_grid->fields[5] ;  
       $GLOBALS["competicao_id"] = (string)$GLOBALS["competicao_id"] ;
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Bolão Jogos do Brasil  Valor R$ 10 / PIX 988849252 :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               cons_jogos_brasil_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               cons_jogos_brasil_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               cons_jogos_brasil_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               cons_jogos_brasil_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               cons_jogos_brasil_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Bolão Jogos do Brasil  Valor R$ 10 / PIX 988849252</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"cons_jogos_brasil_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"cons_jogos_brasil_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"cons_jogos_brasil_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("    $(\"#\" + buttonId).html(stateHtml).data(\"actionbarState\", buttonState);\r\n");
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_linkSubmit5(link_selector, apl_lig, apl_saida, parms, target, opc, modal_h, modal_w, m_confirm, apl_name, ancor)\r\n");
           $nm_saida->saida("{\r\n");
           ...
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_linkSubmit6(link_obj, apl_lig, apl_saida, parms, target, pos, alt, larg, opc, modal_h, modal_w, m_confirm, apl_name, ancor)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    if ($(\"#\" + link_selector).hasClass(\"disabled\")) {\r\n");
           $nm_saida->saida("        return;\r\n");
           $nm_saida->saida("    }\r\n");
           ...
           $nm_saida->saida("<script>\r\n");
           $nm_saida->saida("function scAddTippy()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("$(function() {\r\n");
           $nm_saida->saida("    scAddTippy();\r\n");
           $nm_saida->saida("});\r\n");
           $nm_saida->saida("</script>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-cons_jogos_brasil-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-cons_jogos_brasil-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-cons_jogos_brasil-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-0a913c64\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
...
$nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("<style type=\"text/css\">\r\n");
           $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_cons_jogos_brasil_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_cons_jogos_brasil_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_cons_jogos_brasil_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "cons_jogos_brasil/cons_jogos_brasil_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".cons_jogos_brasil_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cab_embutida'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['SC_herda_css'] = "S"; 
   $compl_css = "";
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['cons_jogos_brasil']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['cons_jogos_brasil']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['cons_jogos_brasil']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['cons_jogos_brasil']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida']) ? "cons_jogos_brasil_" : "";
   $this->css_sep = " ";
   ...
   $this->css_apostas_label = $compl_css_emb . "css_apostas_label";
   $this->css_apostas_grid_line = $compl_css_emb . "css_apostas_grid_line";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cond_pesq'], 0, $trab_pos);
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . "Bolão Jogos do Brasil <br> Valor R$ 10 / PIX 988849252" . "</div>\r\n");
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: right;\">" . "Valor acumulado: R$ " . $_SESSION['vl_bolao'] . "" . "</div>\r\n");
   $nm_saida->saida("</div>\r\n");
   $nm_saida->saida("  </TD>\r\n");
   $nm_saida->saida(" </TR>\r\n");
 }
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_cons_jogos_brasil__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-cons_jogos_brasil-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_time_casa_placar_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_time_casa_placar_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".cons_jogos_brasil_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
 ...
 function NM_label_data_jogo()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != 'pdf') {
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['ini_cor_grid']);
       }
   }
   ...
   $this->sc_where_atual   = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_pesq'];
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['where_pesq_filtro'];
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_jogos_brasil']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_cons_jogos_brasil#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cab_embutida'] != "S")
               {
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['force_toolbar'] = true;
           } 
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_cons_jogos_brasil', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_cons_jogos_brasil', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_cons_jogos_brasil', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" &&
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_cons_jogos_brasil#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-0a913c64\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          $this->NM_cont_emb_linha++;
          $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['emb_linha']++;
          if ($this->Ini->qual_linha == "impar")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['ini_cor_grid'] = "impar";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['doc_word'] && !$this->Ini->sc_export_ajax)
          {
              $nm_prog_barr++;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  cons_jogos_brasil_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $GLOBALS["competicao_id"] = (string)$GLOBALS["competicao_id"];
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['rows_emb']++;
...
$_SESSION['scriptcase']['cons_jogos_brasil']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_time_casa_placar_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_time_casa_placar_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   $this->SC_grid_rightActionBar();
              $this->NM_calc_span();
              $nm_saida->saida("</TR>\r\n");
              $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_cons_jogos_brasil_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:''\">\r\n");
              ...
              $this->NM_grid_apostas();
              $nm_saida->saida("</TR></TABLE></TD>\r\n");
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   if (isset($this->grid_apostas_copa) && method_exists($this->grid_apostas_copa, "close_emb")) 
   {
       $this->grid_apostas_copa->close_emb();
   }
   if (!$this->rs_grid->EOF) 
   { 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_apostas()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['apostas']) || $this->NM_cmp_hidden['apostas'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->apostas)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->apostas)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          $this->SC_nowrap = "";
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_apostas_grid_line . "\"  style=\"" . $this->Css_Cmp['css_apostas_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          if (!$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf'] != "pdf")
          { 
              $link_div = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['ind_tree']++;
              $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['ind_tree'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_apostas_copa'][$this->NM_cont_body][1] = 'top';
              if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp)
              { 
                  $link_div  = "<img id=\"b_open_grid_apostas_copa_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_grid_apostas_copa_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_apostas_copa_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_apostas_copa, 'grid_apostas_copa'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
                  $link_div .= "<img id=\"b_close_grid_apostas_copa_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_grid_apostas_copa_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_apostas_copa_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_apostas_copa, 'grid_apostas_copa'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
              }
              $nm_saida->saida("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">");
              $nm_saida->saida("<TR> <TD align=\"left\">");
              $nm_saida->saida("<DIV id=\"tbody_grid_apostas_copa_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
              $nm_saida->saida($link_div . "</DIV></TD></TR>");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['ind_tree']++;
              $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['ind_tree'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_apostas_copa'][$this->NM_cont_body][1] = 'bot';
              $nm_saida->saida("<tr><td>");
              if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp)
              { 
                  $nm_saida->saida("<DIV id=\"tbody_grid_apostas_copa_" . $this->NM_cont_body . "_bot\" style=\"display:none\">");
              }
              else
              { 
                  $nm_saida->saida("<DIV id=\"tbody_grid_apostas_copa_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
              }
          }
          $GLOBALS["script_case_init"] = $this->Ini->sc_page;
          $GLOBALS["nmgp_parms"] = "nmgp_lig_edit_lapis?#?S?@?jogo?#?" . str_replace("'", "@aspass@", $this->jogo_api_id) . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida'] = true;
          if (method_exists($this->grid_apostas_copa, "controle"))
          {
              $this->grid_apostas_copa->controle();
          }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida'] = false;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['emb_lig_aba']))
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
              { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['emb_lig_aba'] = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['emb_lig_aba']);
              }
              else 
              { 
                 $this->Ini->Init_apl_lig = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['emb_lig_aba']);
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf'] != "pdf")
          { 
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_pdf'] == "pdf")
   {
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['bt_apostar'] == "on" && !$this->grid_emb_form) 
      { 
          $this->nm_btn_exist['bt_apostar'][] = "sc_bt_apostar_top";
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "bt_apostar", "sc_btn_bt_apostar();", "sc_btn_bt_apostar();", "sc_bt_apostar_top", "", "Apostar", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida("          $Cod_Btn \r\n");
          $NM_btn = true;
      } 
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"right\" width=\"33%\"> \r\n");
      if (!$this->Ini->SC_Link_View && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_modal'])
      {
          ...
          if (is_file("cons_jogos_brasil_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("cons_jogos_brasil_help.txt"); 
   ...
   function nmgp_barra_bot_mobile()
   {
      ...
      $nm_saida->saida("         <tr class=\"" . $this->css_scGridToolbarPadd . "_tr\"> \r\n");
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['nav']))
          {
...
?>
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_cons_jogos_brasil\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_cons_jogos_brasil\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('cons_jogos_brasil', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"cons_jogos_brasil\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"cons_jogos_brasil_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "cons_jogos_brasil/cons_jogos_brasil_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"cons_jogos_brasil_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   var Crtl_btn_bt_apostar = false;\r\n");
   $nm_saida->saida("   function sc_btn_bt_apostar()\r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       if (Crtl_btn_bt_apostar) {return;}\r\n");
   $nm_saida->saida("       document.F4.target = \"_self\";\r\n");
   $nm_saida->saida("       Crtl_btn_bt_apostar = true;\r\n");
   $nm_saida->saida("       document.F4.rec.value = \"\";\r\n");
   $nm_saida->saida("       document.F4.nm_call_php.value = \"bt_apostar\";\r\n");
   ...
   if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_modal']) || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['dashboard_info']['under_dashboard'])) {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=cons_jogos_brasil';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_cons_jogos_brasil');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_cons_jogos_brasil');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_cons_jogos_brasil');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_cons_jogos_brasil');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['cons_jogos_brasil_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@cons_jogos_brasil@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           document.Fexport.action = \"cons_jogos_brasil_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"cons_jogos_brasil_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('cons_jogos_brasil')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('cons_jogos_brasil', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }

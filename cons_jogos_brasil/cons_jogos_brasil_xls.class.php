...
class cons_jogos_brasil_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "cons_jogos_brasil/cons_jogos_brasil_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "cons_jogos_brasil_res_xls.class.php");
              $this->Res_xls = new cons_jogos_brasil_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_cons_jogos_brasil.zip";
          $this->Arquivo   .= "_cons_jogos_brasil" . $this->Xls_tp;
          $this->Tit_doc    = "cons_jogos_brasil" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $link_xls = substr($this->Ini->link_grid_apostas_copa_cons_emb, 0, $pos) . "/grid_apostas_copa_xls.class.php";
      if (!is_file($this->Ini->link_grid_apostas_copa_cons_emb) || !is_file($link_xls))
      {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['cons_jogos_brasil']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['cons_jogos_brasil']['contr_erro'] = 'off'; 
         ...
         { 
             $this->xls_set_style();
             $this->NM_export_apostas();
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
             { 
                 $this->Xls_row++;
                 $this->arr_export['lines'][$this->Xls_row] = $this->Rows_sub_apostas['label'];
                 foreach ($this->Rows_sub_apostas['lines'] as $line => $cols)
                 {
                     $this->Xls_row++;
             ...
             { 
                 ...
                 $_SESSION['scriptcase']['export_return']['label'] = $this->Rows_sub_apostas['label'];
                 foreach ($this->Rows_sub_apostas['lines'] as $line)
                 {
                     $this->Xls_col = 0;
                     $this->Xls_row++;
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['apostas'])) ? $this->New_label['apostas'] : "Apostas"; 
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
              $this->arr_span['apostas'] = $this->count_span;
              $this->Emb_label_cols_apostas = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_apostas += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_apostas += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_apostas++;
                         }
                     }
                  }
              }
      ...
      { 
          if (!isset($this->NM_cmp_hidden[$apostas]) || $this->NM_cmp_hidden[$apostas] != "off")
          {
              while ($this->count_span < $this->Emb_label_cols_apostas)
              {
   ...
   function NM_export_rodada()
   {
         ...
         if (is_numeric($this->rodada))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->rodada);
         $this->Xls_col++;
   }
   //----- competicao_id
   ...
   //----- apostas
   function NM_export_apostas()
   {
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?jogo?#?" . str_replace("'", "@aspass@", $this->Orig_jogo_api_id) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['nolabel'] = true;
         if (method_exists($this->grid_apostas_copa, "controle"))
         {
             $this->grid_apostas_copa->controle();
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 $this->Rows_sub_apostas = $_SESSION['scriptcase']['export_return'];
                 return;
             }
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida'] = false;
   ...
   {
         $this->rodada = NM_charset_to_utf8($this->rodada);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->rodada;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- apostas
   function NM_sub_cons_apostas()
   {
         $this->Rows_sub_apostas = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?jogo?#?" . str_replace("'", "@aspass@", $this->Orig_jogo_api_id) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['embutida'] = true;
         if (method_exists($this->grid_apostas_copa, "controle"))
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Bolão Jogos do Brasil  Valor R$ 10 / PIX 988849252 :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_brasil']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php

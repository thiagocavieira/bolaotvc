...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos_brasil"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos_brasil"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_jogos_brasil']['embutida_filho'] as $ind => $sc_init)
          {

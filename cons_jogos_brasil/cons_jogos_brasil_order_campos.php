...
<?php
   ...
   $Ord_Cmp = new cons_jogos_brasil_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class cons_jogos_brasil_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['data_jogo'] = "data_jogo";
   $tab_labels["data_jogo"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["data_jogo"])) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["data_jogo"] : "Data Jogo";
   $tab_ger_campos['horario'] = "on";
   $tab_def_campos['horario'] = "horario";
   $tab_labels["horario"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["horario"])) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["horario"] : "Horario";
   $tab_ger_campos['time_casa_id'] = "on";
   $tab_def_campos['time_casa_id'] = "time_casa_id";
   $tab_labels["time_casa_id"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["time_casa_id"])) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["time_casa_id"] : "Seleção";
   $tab_ger_campos['x'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['x'] = "x";
   ...
   $tab_labels["x"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["x"])) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["x"] : "";
   $tab_ger_campos['time_visitante_id'] = "on";
   $tab_def_campos['time_visitante_id'] = "time_visitante_id";
   $tab_labels["time_visitante_id"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["time_visitante_id"])) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["time_visitante_id"] : "Seleção";
   $tab_ger_campos['rodada'] = "on";
   $tab_def_campos['rodada'] = "rodada";
   $tab_labels["rodada"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["rodada"])) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["rodada"] : "Rodada";
   $tab_ger_campos['competicao_id'] = "on";
   $tab_def_campos['competicao_id'] = "competicao_id";
   $tab_labels["competicao_id"]   = (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["competicao_id"])) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['labels']["competicao_id"] : "Competição";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "cons_jogos_brasil_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['cons_jogos_brasil']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

...
$old_error_handler = set_error_handler("ap_form_add_users_mob_scriptcase_error_handler");

function ap_form_add_users_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['ap_form_add_users_mob']['contr_erro']) && $_SESSION['scriptcase']['ap_form_add_users_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ap_form_add_users_mob->contr_ap_form_add_users_mob->Apl_com_erro = true;
            if ($inicial_ap_form_add_users_mob->contr_ap_form_add_users_mob->NM_ajax_flag)
            {
                $inicial_ap_form_add_users_mob->contr_ap_form_add_users_mob->NM_ajax_info['errList']['geral_ap_form_add_users_mob'][] = $msg;
                return;
            }
            ap_form_add_users_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ap_form_add_users_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ap_form_add_users_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['ap_form_add_users_mob'])  ? $_SESSION['scriptcase']['error_icon']['ap_form_add_users_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ap_form_add_users_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['ap_form_add_users_mob']) ? $_SESSION['scriptcase']['error_span_title']['ap_form_add_users_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ap_form_add_users_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['ap_form_add_users_mob']) ? $_SESSION['scriptcase']['error_icon_title']['ap_form_add_users_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['ap_form_add_users']['error_buffer'] .= ob_get_flush();
}

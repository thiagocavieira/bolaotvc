  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aposta_jogo_corrente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aposta_jogo_corrente_mob_form();
	}
...
?>
  ...
  // ---------- Validate nome_bolao
  function do_ajax_form_aposta_jogo_corrente_mob_validate_nome_bolao()
  {
    var nomeCampo_nome_bolao = "nome_bolao";
    var var_nome_bolao = scAjaxGetFieldText(nomeCampo_nome_bolao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aposta_jogo_corrente_mob_validate_nome_bolao(var_nome_bolao, var_script_case_init, do_ajax_form_aposta_jogo_corrente_mob_validate_nome_bolao_cb);
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_nome_bolao

  function do_ajax_form_aposta_jogo_corrente_mob_validate_nome_bolao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_bolao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_nome_bolao_cb

  // ---------- Validate time_casa
  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa()
  {
    var nomeCampo_time_casa = "time_casa";
    var var_time_casa = scAjaxGetFieldText(nomeCampo_time_casa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aposta_jogo_corrente_mob_validate_time_casa(var_time_casa, var_script_case_init, do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_cb);
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa

  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "time_casa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_cb

  // ---------- Validate time_casa_placar
  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_placar()
  {
    var nomeCampo_time_casa_placar = "time_casa_placar";
    var var_time_casa_placar = scAjaxGetFieldText(nomeCampo_time_casa_placar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_placar(var_time_casa_placar, var_script_case_init, do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_placar_cb);
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_placar

  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_casa_placar_cb

  // ---------- Validate time_visitante
  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante()
  {
    var nomeCampo_time_visitante = "time_visitante";
    var var_time_visitante = scAjaxGetFieldText(nomeCampo_time_visitante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante(var_time_visitante, var_script_case_init, do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_cb);
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante

  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "time_visitante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_cb

  // ---------- Validate time_visitante_placar
  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_placar()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_placar(var_time_visitante_placar, var_script_case_init, do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_placar_cb);
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_placar

  function do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aposta_jogo_corrente_mob_validate_time_visitante_placar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_aposta_jogo_corrente_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aposta_jogo_corrente_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome_bolao = scAjaxGetFieldText("nome_bolao");
    var var_time_casa = scAjaxGetFieldText("time_casa");
    var var_time_casa_placar = scAjaxGetFieldText("time_casa_placar");
    var var_time_visitante = scAjaxGetFieldText("time_visitante");
    var var_time_visitante_placar = scAjaxGetFieldText("time_visitante_placar");
    var var_aposta_id = scAjaxGetFieldText("aposta_id");
    ...
    scAjaxProcOn();
    x_ajax_form_aposta_jogo_corrente_mob_submit_form(var_nome_bolao, var_time_casa, var_time_casa_placar, var_time_visitante, var_time_visitante_placar, var_aposta_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aposta_jogo_corrente_mob_submit_form_cb);
  } // do_ajax_form_aposta_jogo_corrente_mob_submit_form

  function do_ajax_form_aposta_jogo_corrente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nome_bolao");
      scAjaxHideErrorDisplay("time_casa");
      scAjaxHideErrorDisplay("time_casa_placar");
      scAjaxHideErrorDisplay("time_visitante");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aposta_jogo_corrente_mob_submit_form_cb_after_alert);
  } // do_ajax_form_aposta_jogo_corrente_mob_submit_form_cb
  function do_ajax_form_aposta_jogo_corrente_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aposta_jogo_corrente_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aposta_jogo_corrente_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_aposta_jogo_corrente_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_aposta_jogo_corrente_mob_navigate_form();
    }
  }

  function perform_ajax_form_aposta_jogo_corrente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_aposta_jogo_corrente_mob_navigate_form(var_aposta_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aposta_jogo_corrente_mob_navigate_form_cb);
  } // do_ajax_form_aposta_jogo_corrente_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aposta_jogo_corrente_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aposta_jogo_corrente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aposta_jogo_corrente_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_aposta_jogo_corrente_mob_navigate_form_cb
  function do_ajax_form_aposta_jogo_corrente_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_aposta_jogo_corrente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aposta_jogo_corrente_mob_navigate_form_cb_after_alert

  function sc_hide_form_aposta_jogo_corrente_mob_form()
  {
  ...
  ajax_field_list[0] = "nome_bolao";
  ajax_field_list[1] = "time_casa";
  ajax_field_list[2] = "time_casa_placar";
  ajax_field_list[3] = "time_visitante";
  ...
  var ajax_error_list = {
    "nome_bolao": {"label": "Bolão", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_casa": {"label": "Time Casa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_casa_placar": {"label": "Placar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_visitante": {"label": "Time Visitante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_visitante_placar": {"label": "Placar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "nome_bolao": new Array(),
    "time_casa": new Array(),
    "time_casa_placar": new Array(),
    "time_visitante": new Array(),
    "time_visitante_placar": new Array()
  };
  ajax_field_mult["nome_bolao"][1] = "nome_bolao";
  ajax_field_mult["time_casa"][1] = "time_casa";
  ajax_field_mult["time_casa_placar"][1] = "time_casa_placar";
  ajax_field_mult["time_visitante"][1] = "time_visitante";
  ajax_field_mult["time_visitante_placar"][1] = "time_visitante_placar";

  var ajax_field_id = {
    "nome_bolao": new Array("hidden_field_label_nome_bolao", "hidden_field_data_nome_bolao"),
    "time_casa": new Array("hidden_field_label_time_casa", "hidden_field_data_time_casa"),
    "time_casa_placar": new Array("hidden_field_label_time_casa_placar", "hidden_field_data_time_casa_placar"),
    "time_visitante": new Array("hidden_field_label_time_visitante", "hidden_field_data_time_visitante"),

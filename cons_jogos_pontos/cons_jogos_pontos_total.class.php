...
class cons_jogos_pontos_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['cons_jogos_pontos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['cons_jogos_pontos']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $jogos_competicao_id, $jogos_time_casa_id, $jogos_time_visitante_id;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(apostas.pontos) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['contr_total_geral'] = "OK";
   } 

   //-----  apostas_bolao_id
   function quebra_apostas_bolao_id_sc_free_group_by($apostas_bolao_id, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $jogos_competicao_id, $jogos_time_casa_id, $jogos_time_visitante_id;
      $tot_apostas_bolao_id = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(apostas.pontos) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['where_pesq']; 
      } 
      ...
      $tot_apostas_bolao_id[0] = NM_encode_input(sc_strip_script($apostas_bolao_id)) ; 
      $tot_apostas_bolao_id[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_apostas_bolao_id[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_apostas_bolao_id;
   } 

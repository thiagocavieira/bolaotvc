...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos_pontos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos_pontos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_pontos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos_pontos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_pontos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos_pontos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_jogos_pontos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_pontos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_jogos_pontos']['embutida_filho'] as $ind => $sc_init)
          {

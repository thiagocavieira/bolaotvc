...
class cons_jogos_pontos_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "cons_jogos_pontos/cons_jogos_pontos_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "cons_jogos_pontos_res_xls.class.php");
              $this->Res_xls = new cons_jogos_pontos_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_cons_jogos_pontos.zip";
          $this->Arquivo   .= "_cons_jogos_pontos" . $this->Xls_tp;
          $this->Tit_doc    = "cons_jogos_pontos" . $this->Xls_tp;
          $this->Tit_zip    = "cons_jogos_pontos.zip";
      ...
      require_once($this->Ini->path_aplicacao . "cons_jogos_pontos_total.class.php"); 
      ...
      {
          $this->sum_apostas_pontos = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'][2];
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['order_grid'];
     ...
     $prim_gb = false;
     $nm_houve_quebra = "N";
         //----- lookup - jogos_competicao_id
         $this->look_jogos_competicao_id = $this->jogos_competicao_id; 
         $this->Lookup->lookup_jogos_competicao_id($this->look_jogos_competicao_id, $this->jogos_competicao_id) ; 
         $this->look_jogos_competicao_id = ($this->look_jogos_competicao_id == "&nbsp;") ? "" : $this->look_jogos_competicao_id; 
...
$_SESSION['scriptcase']['cons_jogos_pontos']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "jogos_competicao_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
          ...
          if ($Cada_col == "x3" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "jogos_time_casa_placar" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "x2" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "jogos_time_visitante_placar" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "apostas_login_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "apostas_jogo_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "apostas_competicao_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   //----- jogos_competicao_id
   function NM_export_jogos_competicao_id()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         ...
         $this->look_jogos_competicao_id = NM_charset_to_utf8($this->look_jogos_competicao_id);
         if (is_numeric($this->look_jogos_competicao_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_jogos_competicao_id);
         $this->Xls_col++;
   }
   //----- jogos_rodada
   ...
   function NM_export_x3()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->x3 = html_entity_decode($this->x3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->x3 = strip_tags($this->x3);
         $this->x3 = NM_charset_to_utf8($this->x3);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->x3, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->x3, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   //----- jogos_time_casa_placar
   function NM_export_jogos_time_casa_placar()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->jogos_time_casa_placar = NM_charset_to_utf8($this->jogos_time_casa_placar);
         if (is_numeric($this->jogos_time_casa_placar))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->jogos_time_casa_placar);
         $this->Xls_col++;
   }
   //----- x2
   function NM_export_x2()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->x2 = html_entity_decode($this->x2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->x2 = strip_tags($this->x2);
         $this->x2 = NM_charset_to_utf8($this->x2);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->x2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->x2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- jogos_time_visitante_placar
   function NM_export_jogos_time_visitante_placar()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->jogos_time_visitante_placar = NM_charset_to_utf8($this->jogos_time_visitante_placar);
         if (is_numeric($this->jogos_time_visitante_placar))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->jogos_time_visitante_placar);
         $this->Xls_col++;
   }
   //----- jogos_data_jogo
   ...
   //----- apostas_login_id
   function NM_export_apostas_login_id()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->apostas_login_id = html_entity_decode($this->apostas_login_id, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->apostas_login_id = strip_tags($this->apostas_login_id);
         $this->apostas_login_id = NM_charset_to_utf8($this->apostas_login_id);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apostas_login_id, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apostas_login_id, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- apostas_jogo_id
   function NM_export_apostas_jogo_id()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->apostas_jogo_id = NM_charset_to_utf8($this->apostas_jogo_id);
         if (is_numeric($this->apostas_jogo_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->apostas_jogo_id);
         $this->Xls_col++;
   }
   //----- apostas_competicao_id
   function NM_export_apostas_competicao_id()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->apostas_competicao_id = NM_charset_to_utf8($this->apostas_competicao_id);
         if (is_numeric($this->apostas_competicao_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->apostas_competicao_id);
         $this->Xls_col++;
   }
   //----- jogos_competicao_id
   function NM_sub_cons_jogos_competicao_id()
   {
         $this->look_jogos_competicao_id = NM_charset_to_utf8($this->look_jogos_competicao_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_jogos_competicao_id;
   ...
   //----- x3
   function NM_sub_cons_x3()
   {
         $this->x3 = html_entity_decode($this->x3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->x3 = strip_tags($this->x3);
         $this->x3 = NM_charset_to_utf8($this->x3);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->x3;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- jogos_time_casa_placar
   function NM_sub_cons_jogos_time_casa_placar()
   {
         $this->jogos_time_casa_placar = NM_charset_to_utf8($this->jogos_time_casa_placar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->jogos_time_casa_placar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- x2
   function NM_sub_cons_x2()
   {
         $this->x2 = html_entity_decode($this->x2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->x2 = strip_tags($this->x2);
         $this->x2 = NM_charset_to_utf8($this->x2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->x2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- jogos_time_visitante_placar
   function NM_sub_cons_jogos_time_visitante_placar()
   {
         $this->jogos_time_visitante_placar = NM_charset_to_utf8($this->jogos_time_visitante_placar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->jogos_time_visitante_placar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- apostas_login_id
   function NM_sub_cons_apostas_login_id()
   {
         $this->apostas_login_id = html_entity_decode($this->apostas_login_id, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->apostas_login_id = strip_tags($this->apostas_login_id);
         $this->apostas_login_id = NM_charset_to_utf8($this->apostas_login_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->apostas_login_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- apostas_jogo_id
   function NM_sub_cons_apostas_jogo_id()
   {
         $this->apostas_jogo_id = NM_charset_to_utf8($this->apostas_jogo_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->apostas_jogo_id;
   ...
   //----- apostas_competicao_id
   function NM_sub_cons_apostas_competicao_id()
   {
         $this->apostas_competicao_id = NM_charset_to_utf8($this->apostas_competicao_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->apostas_competicao_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['nolabel'])
       {
 ...
 function quebra_apostas_bolao_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_apostas_bolao_id_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_apostas_bolao_id as $cada_campo) {
           if ($cont_col == $lim_col) {
   ...
   function quebra_apostas_bolao_id_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_apostas_bolao_id_apostas_pontos;
               $prim_cmp = false;
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "apostas_pontos" && (!isset($this->NM_cmp_hidden['apostas_pontos']) || $this->NM_cmp_hidden['apostas_pontos'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['tot_geral'][2];
               $prim_cmp = false;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>Pontos conquistados por <?php echo $_SESSION['usr_login'] ?> :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_pontos']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php

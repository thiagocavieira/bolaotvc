<?php
@session_start() ;
$_SESSION['scriptcase']['cons_relacs_bolao_usuar_ini']['sc_process_barr'] = true;
require_once('../cons_relacs_bolao_usuar_ini/index.php');
unset($_SESSION['scriptcase']['cons_relacs_bolao_usuar_ini']['sc_process_barr']);
$ExportCtrl = new cons_relacs_bolao_usuar_ini_export_control;
$ExportCtrl->Export_barr();

class cons_relacs_bolao_usuar_ini_export_control
{

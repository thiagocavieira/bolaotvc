  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_rodadas_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate rodada_id
  function do_ajax_form_rodadas_mob_validate_rodada_id()
  {
    var nomeCampo_rodada_id = "rodada_id";
    var var_rodada_id = scAjaxGetFieldHidden(nomeCampo_rodada_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rodadas_mob_validate_rodada_id(var_rodada_id, var_script_case_init, do_ajax_form_rodadas_mob_validate_rodada_id_cb);
  } // do_ajax_form_rodadas_mob_validate_rodada_id

  function do_ajax_form_rodadas_mob_validate_rodada_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rodada_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rodadas_mob_validate_rodada_id_cb

  // ---------- Validate num_rodada
  function do_ajax_form_rodadas_mob_validate_num_rodada()
  {
    var nomeCampo_num_rodada = "num_rodada";
    var var_num_rodada = scAjaxGetFieldText(nomeCampo_num_rodada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rodadas_mob_validate_num_rodada(var_num_rodada, var_script_case_init, do_ajax_form_rodadas_mob_validate_num_rodada_cb);
  } // do_ajax_form_rodadas_mob_validate_num_rodada

  function do_ajax_form_rodadas_mob_validate_num_rodada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "num_rodada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rodadas_mob_validate_num_rodada_cb

  // ---------- Validate dt_hr_inicio
  function do_ajax_form_rodadas_mob_validate_dt_hr_inicio()
  {
    var nomeCampo_dt_hr_inicio = "dt_hr_inicio";
    var var_dt_hr_inicio = scAjaxGetFieldText(nomeCampo_dt_hr_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rodadas_mob_validate_dt_hr_inicio(var_dt_hr_inicio, var_script_case_init, do_ajax_form_rodadas_mob_validate_dt_hr_inicio_cb);
  } // do_ajax_form_rodadas_mob_validate_dt_hr_inicio

  function do_ajax_form_rodadas_mob_validate_dt_hr_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dt_hr_inicio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rodadas_mob_validate_dt_hr_inicio_cb

  // ---------- Validate dt_hr_fim
  function do_ajax_form_rodadas_mob_validate_dt_hr_fim()
  {
    var nomeCampo_dt_hr_fim = "dt_hr_fim";
    var var_dt_hr_fim = scAjaxGetFieldText(nomeCampo_dt_hr_fim);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rodadas_mob_validate_dt_hr_fim(var_dt_hr_fim, var_script_case_init, do_ajax_form_rodadas_mob_validate_dt_hr_fim_cb);
  } // do_ajax_form_rodadas_mob_validate_dt_hr_fim

  function do_ajax_form_rodadas_mob_validate_dt_hr_fim_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dt_hr_fim";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rodadas_mob_validate_dt_hr_fim_cb

  // ---------- Validate temporada_id
  function do_ajax_form_rodadas_mob_validate_temporada_id()
  {
    var nomeCampo_temporada_id = "temporada_id";
    var var_temporada_id = scAjaxGetFieldSelect(nomeCampo_temporada_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rodadas_mob_validate_temporada_id(var_temporada_id, var_script_case_init, do_ajax_form_rodadas_mob_validate_temporada_id_cb);
  } // do_ajax_form_rodadas_mob_validate_temporada_id

  function do_ajax_form_rodadas_mob_validate_temporada_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "temporada_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rodadas_mob_validate_temporada_id_cb

  // ---------- Validate competicao_id
  function do_ajax_form_rodadas_mob_validate_competicao_id()
  {
    var nomeCampo_competicao_id = "competicao_id";
    var var_competicao_id = scAjaxGetFieldSelect(nomeCampo_competicao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rodadas_mob_validate_competicao_id(var_competicao_id, var_script_case_init, do_ajax_form_rodadas_mob_validate_competicao_id_cb);
  } // do_ajax_form_rodadas_mob_validate_competicao_id

  function do_ajax_form_rodadas_mob_validate_competicao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rodadas_mob_validate_competicao_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_rodadas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_rodadas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_rodada_id = scAjaxGetFieldHidden("rodada_id");
    var var_num_rodada = scAjaxGetFieldText("num_rodada");
    var var_dt_hr_inicio = scAjaxGetFieldText("dt_hr_inicio");
    var var_dt_hr_fim = scAjaxGetFieldText("dt_hr_fim");
    var var_temporada_id = scAjaxGetFieldSelect("temporada_id");
    ...
    scAjaxProcOn();
    x_ajax_form_rodadas_mob_submit_form(var_rodada_id, var_num_rodada, var_dt_hr_inicio, var_dt_hr_fim, var_temporada_id, var_competicao_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_rodadas_mob_submit_form_cb);
  } // do_ajax_form_rodadas_mob_submit_form

  function do_ajax_form_rodadas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rodada_id");
      scAjaxHideErrorDisplay("num_rodada");
      scAjaxHideErrorDisplay("dt_hr_inicio");
      scAjaxHideErrorDisplay("dt_hr_fim");
      scAjaxHideErrorDisplay("temporada_id");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_rodadas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_rodadas_mob_submit_form_cb
  function do_ajax_form_rodadas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_rodadas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_rodadas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_rodadas_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_rodadas_mob_navigate_form();
    }
  }

  function perform_ajax_form_rodadas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("temporada_id");
    scAjaxHideErrorDisplay("competicao_id");
    var var_rodada_id = document.F2.rodada_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_rodadas_mob_navigate_form(var_rodada_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_rodadas_mob_navigate_form_cb);
  } // do_ajax_form_rodadas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_rodadas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_rodadas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rodada_id.value = scAjaxGetKeyValue("rodada_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_rodadas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_rodadas_mob_navigate_form_cb
  function do_ajax_form_rodadas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_rodadas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_rodadas_mob_navigate_form_cb_after_alert

  function sc_hide_form_rodadas_mob_form()
  {
  ...
  ajax_field_list[0] = "rodada_id";
  ajax_field_list[1] = "num_rodada";
  ajax_field_list[2] = "dt_hr_inicio";
  ajax_field_list[3] = "dt_hr_fim";
  ajax_field_list[4] = "temporada_id";
  ajax_field_list[5] = "competicao_id";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "rodada_id": {"label": "Rodada Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "num_rodada": {"label": "Num Rodada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dt_hr_inicio": {"label": "Dt Hr Inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dt_hr_fim": {"label": "Dt Hr Fim", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "temporada_id": {"label": "Temporada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "competicao_id": {"label": "Competicao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "rodada_id": new Array(),
    "num_rodada": new Array(),
    "dt_hr_inicio": new Array(),
    "dt_hr_fim": new Array(),
    "temporada_id": new Array(),
    "competicao_id": new Array()
  };
  ajax_field_mult["rodada_id"][1] = "rodada_id";
  ajax_field_mult["num_rodada"][1] = "num_rodada";
  ajax_field_mult["dt_hr_inicio"][1] = "dt_hr_inicio";
  ajax_field_mult["dt_hr_fim"][1] = "dt_hr_fim";
  ajax_field_mult["temporada_id"][1] = "temporada_id";
  ajax_field_mult["competicao_id"][1] = "competicao_id";

  var ajax_field_id = {
    "rodada_id": new Array("hidden_field_label_rodada_id", "hidden_field_data_rodada_id"),
    "num_rodada": new Array("hidden_field_label_num_rodada", "hidden_field_data_num_rodada"),
    "dt_hr_inicio": new Array("hidden_field_label_dt_hr_inicio", "hidden_field_data_dt_hr_inicio"),
    "dt_hr_fim": new Array("hidden_field_label_dt_hr_fim", "hidden_field_data_dt_hr_fim"),
    "temporada_id": new Array("hidden_field_label_temporada_id", "hidden_field_data_temporada_id"),

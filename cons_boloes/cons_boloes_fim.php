...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_boloes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_boloes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_boloes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_boloes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_boloes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_boloes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_boloes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_boloes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_boloes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_boloes']['embutida_filho'] as $ind => $sc_init)
          {

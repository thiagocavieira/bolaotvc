...
?>
  ...
  function do_ajax_login_validate_remember_me()
  {
    var nomeCampo_remember_me = "remember_me";
    var var_remember_me = scAjaxGetFieldCheckbox(nomeCampo_remember_me, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_remember_me(var_remember_me, var_script_case_init, do_ajax_login_validate_remember_me_cb);
  } // do_ajax_login_validate_remember_me

  function do_ajax_login_validate_remember_me_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_remember_me_cb

  // ---------- Validate retrieve_pswd
  function do_ajax_login_validate_retrieve_pswd()
  {
    var nomeCampo_retrieve_pswd = "retrieve_pswd";
    var var_retrieve_pswd = scAjaxGetFieldText(nomeCampo_retrieve_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_retrieve_pswd(var_retrieve_pswd, var_script_case_init, do_ajax_login_validate_retrieve_pswd_cb);
  } // do_ajax_login_validate_retrieve_pswd

  function do_ajax_login_validate_retrieve_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_retrieve_pswd_cb

  // ---------- Validate new_user
  function do_ajax_login_validate_new_user()
  {
    var nomeCampo_new_user = "new_user";
    var var_new_user = scAjaxGetFieldText(nomeCampo_new_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_new_user(var_new_user, var_script_case_init, do_ajax_login_validate_new_user_cb);
  } // do_ajax_login_validate_new_user

  function do_ajax_login_validate_new_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_new_user_cb

  // ---------- Validate dados
  function do_ajax_login_validate_dados()
  {
    var nomeCampo_dados = "dados";
    var var_dados = scAjaxGetFieldText(nomeCampo_dados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_dados(var_dados, var_script_case_init, do_ajax_login_validate_dados_cb);
  } // do_ajax_login_validate_dados

  function do_ajax_login_validate_dados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dados";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_dados_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_login_submit_form()
  {
    ...
    var var_dados = scAjaxGetFieldText("dados");
    ...
    x_ajax_login_submit_form(var_login, var_pswd, var_remember_me, var_retrieve_pswd, var_new_user, var_dados, var_retrieve_pswd_sc_target_name, var_new_user_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_login_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_login_navigate_form, function() {});
    } else {
      perform_ajax_login_navigate_form();
    }
  }

  function perform_ajax_login_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
...
?>
  ...
  ajax_field_list[3] = "retrieve_pswd";
  ajax_field_list[4] = "new_user";
  ajax_field_list[5] = "dados";
  ...
  var ajax_error_list = {
    ...
    "remember_me": {"label": "Lembrar Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "retrieve_pswd": {"label": "Redefinir Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "new_user": {"label": "Novo Usuário", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dados": {"label": "dados", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "dados": new Array("hidden_field_label_dados", "hidden_field_data_dados")
  };

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_times_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate time_id
  function do_ajax_form_times_mob_validate_time_id()
  {
    var nomeCampo_time_id = "time_id";
    var var_time_id = scAjaxGetFieldHidden(nomeCampo_time_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_times_mob_validate_time_id(var_time_id, var_script_case_init, do_ajax_form_times_mob_validate_time_id_cb);
  } // do_ajax_form_times_mob_validate_time_id

  function do_ajax_form_times_mob_validate_time_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_times_mob_validate_time_id_cb

  // ---------- Validate nome_time
  function do_ajax_form_times_mob_validate_nome_time()
  {
    var nomeCampo_nome_time = "nome_time";
    var var_nome_time = scAjaxGetFieldText(nomeCampo_nome_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_times_mob_validate_nome_time(var_nome_time, var_script_case_init, do_ajax_form_times_mob_validate_nome_time_cb);
  } // do_ajax_form_times_mob_validate_nome_time

  function do_ajax_form_times_mob_validate_nome_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_time";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_times_mob_validate_nome_time_cb

  // ---------- Validate num_comp
  function do_ajax_form_times_mob_validate_num_comp()
  {
    var nomeCampo_num_comp = "num_comp";
    var var_num_comp = scAjaxGetFieldSelect(nomeCampo_num_comp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_times_mob_validate_num_comp(var_num_comp, var_script_case_init, do_ajax_form_times_mob_validate_num_comp_cb);
  } // do_ajax_form_times_mob_validate_num_comp

  function do_ajax_form_times_mob_validate_num_comp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "num_comp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_times_mob_validate_num_comp_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_times_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_times_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_time_id = scAjaxGetFieldHidden("time_id");
    var var_nome_time = scAjaxGetFieldText("nome_time");
    var var_num_comp = scAjaxGetFieldSelect("num_comp");
    ...
    scAjaxProcOn();
    x_ajax_form_times_mob_submit_form(var_time_id, var_nome_time, var_num_comp, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_times_mob_submit_form_cb);
  } // do_ajax_form_times_mob_submit_form

  function do_ajax_form_times_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("time_id");
      scAjaxHideErrorDisplay("nome_time");
      scAjaxHideErrorDisplay("num_comp");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_times_mob_submit_form_cb_after_alert);
  } // do_ajax_form_times_mob_submit_form_cb
  function do_ajax_form_times_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_times_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_times_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_times_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_times_mob_navigate_form();
    }
  }

  function perform_ajax_form_times_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nome_time");
    scAjaxHideErrorDisplay("num_comp");
    var var_time_id = document.F2.time_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_times_mob_navigate_form(var_time_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_times_mob_navigate_form_cb);
  } // do_ajax_form_times_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_times_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_times_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.time_id.value = scAjaxGetKeyValue("time_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_times_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_times_mob_navigate_form_cb
  function do_ajax_form_times_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_times_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_times_mob_navigate_form_cb_after_alert

  function sc_hide_form_times_mob_form()
  {
  ...
  ajax_field_list[0] = "time_id";
  ajax_field_list[1] = "nome_time";
  ajax_field_list[2] = "num_comp";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "time_id": {"label": "Time Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nome_time": {"label": "Nome Time", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "num_comp": {"label": "Competição", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["time_id"][1] = "time_id";
  ajax_field_mult["nome_time"][1] = "nome_time";
  ajax_field_mult["num_comp"][1] = "num_comp";

  var ajax_field_id = {
    "time_id": new Array("hidden_field_label_time_id", "hidden_field_data_time_id"),
    "nome_time": new Array("hidden_field_label_nome_time", "hidden_field_data_nome_time"),
    "num_comp": new Array("hidden_field_label_num_comp", "hidden_field_data_num_comp")
  };

<?php
@session_start() ;
$_SESSION['scriptcase']['cons_boloes_1']['sc_process_barr'] = true;
require_once('../cons_boloes_1/index.php');
unset($_SESSION['scriptcase']['cons_boloes_1']['sc_process_barr']);
$ExportCtrl = new cons_boloes_1_export_control;
$ExportCtrl->Export_barr();

class cons_boloes_1_export_control
{

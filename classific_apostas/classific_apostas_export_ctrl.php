<?php
@session_start() ;
$_SESSION['scriptcase']['classific_apostas']['sc_process_barr'] = true;
require_once('../classific_apostas/index.php');
unset($_SESSION['scriptcase']['classific_apostas']['sc_process_barr']);
$ExportCtrl = new classific_apostas_export_control;
$ExportCtrl->Export_barr();

class classific_apostas_export_control
{

...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "jogos_competicao_id";$Nm_numeric[] = "apostas_bolao_id";$Nm_numeric[] = "sum(apostas_pontos)";$Nm_numeric[] = "jogos_competicao_id";$Nm_numeric[] = "apostas_bolao_id";$Nm_numeric[] = "sum(apostas_pontos)";

<?php
@session_start() ;
$_SESSION['scriptcase']['grid_competicoes']['sc_process_barr'] = true;
require_once('../grid_competicoes/index.php');
unset($_SESSION['scriptcase']['grid_competicoes']['sc_process_barr']);
$ExportCtrl = new grid_competicoes_export_control;
$ExportCtrl->Export_barr();

class grid_competicoes_export_control
{

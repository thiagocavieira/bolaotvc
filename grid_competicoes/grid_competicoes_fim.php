...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____grid_competicoes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____grid_competicoes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_competicoes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_competicoes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_competicoes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_competicoes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_competicoes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_competicoes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_competicoes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_competicoes']['embutida_filho'] as $ind => $sc_init)
          {

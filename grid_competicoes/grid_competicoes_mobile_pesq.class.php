...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "competicao_id";$Nm_numeric[] = "competicao_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_competicao_id_cond" name="competicao_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_competicao_id'), this, 'competicao_id')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nome_competicao_cond" name="nome_competicao_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_competicao'), this, 'nome_competicao')">
      ...
      <br><span id="id_hide_nome_competicao"  <?php echo $str_hide_nome_competicao?>><?php
      if ($nome_competicao != "")
      {
      $nome_competicao_look = substr($this->Db->qstr($nome_competicao), 1, -1); 
      $nmgp_def_dados = array(); 

<?php
@session_start() ;
$_SESSION['scriptcase']['cons_boloes_ini']['sc_process_barr'] = true;
require_once('../cons_boloes_ini/index.php');
unset($_SESSION['scriptcase']['cons_boloes_ini']['sc_process_barr']);
$ExportCtrl = new cons_boloes_ini_export_control;
$ExportCtrl->Export_barr();

class cons_boloes_ini_export_control
{

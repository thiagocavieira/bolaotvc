  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_apostas_copa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_apostas_copa_mob_form();
	}
...
?>
  ...
  // ---------- Validate nome_apostador
  function do_ajax_form_apostas_copa_mob_validate_nome_apostador()
  {
    var nomeCampo_nome_apostador = "nome_apostador";
    var var_nome_apostador = scAjaxGetFieldText(nomeCampo_nome_apostador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_copa_mob_validate_nome_apostador(var_nome_apostador, var_script_case_init, do_ajax_form_apostas_copa_mob_validate_nome_apostador_cb);
  } // do_ajax_form_apostas_copa_mob_validate_nome_apostador

  function do_ajax_form_apostas_copa_mob_validate_nome_apostador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_apostador";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_copa_mob_validate_nome_apostador_cb

  // ---------- Validate time_casa
  function do_ajax_form_apostas_copa_mob_validate_time_casa()
  {
    var nomeCampo_time_casa = "time_casa";
    var var_time_casa = scAjaxGetFieldText(nomeCampo_time_casa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_copa_mob_validate_time_casa(var_time_casa, var_script_case_init, do_ajax_form_apostas_copa_mob_validate_time_casa_cb);
  } // do_ajax_form_apostas_copa_mob_validate_time_casa

  function do_ajax_form_apostas_copa_mob_validate_time_casa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_copa_mob_validate_time_casa_cb

  // ---------- Validate placar_casa
  function do_ajax_form_apostas_copa_mob_validate_placar_casa()
  {
    var nomeCampo_placar_casa = "placar_casa";
    var var_placar_casa = scAjaxGetFieldText(nomeCampo_placar_casa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_copa_mob_validate_placar_casa(var_placar_casa, var_script_case_init, do_ajax_form_apostas_copa_mob_validate_placar_casa_cb);
  } // do_ajax_form_apostas_copa_mob_validate_placar_casa

  function do_ajax_form_apostas_copa_mob_validate_placar_casa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placar_casa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_copa_mob_validate_placar_casa_cb

  // ---------- Validate time_visitante
  function do_ajax_form_apostas_copa_mob_validate_time_visitante()
  {
    var nomeCampo_time_visitante = "time_visitante";
    var var_time_visitante = scAjaxGetFieldText(nomeCampo_time_visitante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_copa_mob_validate_time_visitante(var_time_visitante, var_script_case_init, do_ajax_form_apostas_copa_mob_validate_time_visitante_cb);
  } // do_ajax_form_apostas_copa_mob_validate_time_visitante

  function do_ajax_form_apostas_copa_mob_validate_time_visitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_copa_mob_validate_time_visitante_cb

  // ---------- Validate placar_fora
  function do_ajax_form_apostas_copa_mob_validate_placar_fora()
  {
    var nomeCampo_placar_fora = "placar_fora";
    var var_placar_fora = scAjaxGetFieldText(nomeCampo_placar_fora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_copa_mob_validate_placar_fora(var_placar_fora, var_script_case_init, do_ajax_form_apostas_copa_mob_validate_placar_fora_cb);
  } // do_ajax_form_apostas_copa_mob_validate_placar_fora

  function do_ajax_form_apostas_copa_mob_validate_placar_fora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placar_fora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_copa_mob_validate_placar_fora_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_apostas_copa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_apostas_copa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome_apostador = scAjaxGetFieldText("nome_apostador");
    var var_time_casa = scAjaxGetFieldText("time_casa");
    var var_placar_casa = scAjaxGetFieldText("placar_casa");
    var var_time_visitante = scAjaxGetFieldText("time_visitante");
    var var_placar_fora = scAjaxGetFieldText("placar_fora");
    var var_aposta_copa_id = scAjaxGetFieldText("aposta_copa_id");
    ...
    scAjaxProcOn();
    x_ajax_form_apostas_copa_mob_submit_form(var_nome_apostador, var_time_casa, var_placar_casa, var_time_visitante, var_placar_fora, var_aposta_copa_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_apostas_copa_mob_submit_form_cb);
  } // do_ajax_form_apostas_copa_mob_submit_form

  function do_ajax_form_apostas_copa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nome_apostador");
      scAjaxHideErrorDisplay("time_casa");
      scAjaxHideErrorDisplay("placar_casa");
      scAjaxHideErrorDisplay("time_visitante");
      scAjaxHideErrorDisplay("placar_fora");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_apostas_copa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_apostas_copa_mob_submit_form_cb
  function do_ajax_form_apostas_copa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_apostas_copa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_apostas_copa_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_apostas_copa_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_apostas_copa_mob_navigate_form();
    }
  }

  function perform_ajax_form_apostas_copa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("time_visitante");
    scAjaxHideErrorDisplay("placar_fora");
    var var_aposta_copa_id = document.F2.aposta_copa_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_apostas_copa_mob_navigate_form(var_aposta_copa_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_apostas_copa_mob_navigate_form_cb);
  } // do_ajax_form_apostas_copa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_apostas_copa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_apostas_copa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.aposta_copa_id.value = scAjaxGetKeyValue("aposta_copa_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_apostas_copa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_apostas_copa_mob_navigate_form_cb
  function do_ajax_form_apostas_copa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_apostas_copa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_apostas_copa_mob_navigate_form_cb_after_alert

  function sc_hide_form_apostas_copa_mob_form()
  {
  ...
  ajax_field_list[0] = "nome_apostador";
  ajax_field_list[1] = "time_casa";
  ajax_field_list[2] = "placar_casa";
  ajax_field_list[3] = "time_visitante";
  ajax_field_list[4] = "placar_fora";
  ...
  var ajax_error_list = {
    "nome_apostador": {"label": "Nome Apostador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_casa": {"label": "Seleção", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "placar_casa": {"label": "Placar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_visitante": {"label": "Seleção", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "placar_fora": {"label": "Placar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "nome_apostador": new Array(),
    "time_casa": new Array(),
    "placar_casa": new Array(),
    "time_visitante": new Array(),
    "placar_fora": new Array()
  };
  ajax_field_mult["nome_apostador"][1] = "nome_apostador";
  ajax_field_mult["time_casa"][1] = "time_casa";
  ajax_field_mult["placar_casa"][1] = "placar_casa";
  ajax_field_mult["time_visitante"][1] = "time_visitante";
  ajax_field_mult["placar_fora"][1] = "placar_fora";

  var ajax_field_id = {
    "nome_apostador": new Array("hidden_field_label_nome_apostador", "hidden_field_data_nome_apostador"),
    "time_casa": new Array("hidden_field_label_time_casa", "hidden_field_data_time_casa"),
    "placar_casa": new Array("hidden_field_label_placar_casa", "hidden_field_data_placar_casa"),
    "time_visitante": new Array("hidden_field_label_time_visitante", "hidden_field_data_time_visitante"),
    "placar_fora": new Array("hidden_field_label_placar_fora", "hidden_field_data_placar_fora")
  };

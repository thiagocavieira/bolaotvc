...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_cons_jogos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_cons_jogos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_cons_jogos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_cons_jogos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_cons_jogos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_cons_jogos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_cons_jogos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_cons_jogos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_cons_jogos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_cons_jogos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_cons_jogos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_cons_jogos').style.width  = '0px';
        if (oResp["setValue"]) {

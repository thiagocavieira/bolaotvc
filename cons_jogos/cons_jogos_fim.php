...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['cons_jogos']))
   {
       unset($_SESSION['scriptcase']['refresh']['cons_jogos']);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_jogos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_jogos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_jogos']['embutida_filho'] as $ind => $sc_init)
          {

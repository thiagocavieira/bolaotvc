<?php
   include_once('bl_api_jogos_dia_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_perfil']          = "bolaodb";
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_con_bolaotvc']         = "bolaotvc";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class bl_api_jogos_dia_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "bl_api_jogos_dia"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_hr_criacao   = "153248"; 
      $this->nm_autor_alt    = "thiago"; 
      $this->nm_dt_ult_alt   = "20220915"; 
      $this->nm_hr_ult_alt   = "141455"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['bl_api_jogos_dia']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['bl_api_jogos_dia']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['bl_api_jogos_dia']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/bl_api_jogos_dia';
      ...
      $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['bl_api_jogos_dia']['actual_lang']) || $_SESSION['scriptcase']['bl_api_jogos_dia']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['bl_api_jogos_dia']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("bl_api_jogos_dia_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["bl_api_jogos_dia"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["bl_api_jogos_dia"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "bl_api_jogos_dia_erro.class.php"); 
      $this->Erro = new bl_api_jogos_dia_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('bl_api_jogos_dia'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao']) && $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_perfil']) && $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao']))
      {
          ...
          $this->nm_con_bolaotvc['glo_database_encoding'] = isset($_SESSION['scriptcase']['glo_database_encoding'])?$_SESSION['scriptcase']['glo_database_encoding']:'';
      ...
      if (isset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_perfil'];
      }
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_con_bolaotvc'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_bolaotvc['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_bolaotvc['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_bolaotvc['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_bolaotvc['senha']                  = $_SESSION['scriptcase']['glo_senha'];
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_conexao'], $this->root . $this->path_prod, 'exercicios', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function conectExtra()
   {
      ...
      $databaseEncoding = $this->force_db_utf8 ? 'utf8' : $this->nm_con_bolaotvc['glo_database_encoding'];
      $this->nm_db_bolaotvc = db_conect($this->nm_con_bolaotvc['tpbanco'], $this->nm_con_bolaotvc['servidor'], $this->nm_con_bolaotvc['usuario'], $this->nm_con_bolaotvc['senha'], $this->nm_con_bolaotvc['banco'], $this->nm_con_bolaotvc['protect'], 'S', 'N', '', $databaseEncoding); 
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['bl_api_jogos_dia']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new bl_api_jogos_dia_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bl_api_jogos_dia']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['bl_api_jogos_dia']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['bl_api_jogos_dia']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['bl_api_jogos_dia'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['bl_api_jogos_dia']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['bl_api_jogos_dia']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('bl_api_jogos_dia') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['bl_api_jogos_dia']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['bl_api_jogos_dia']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['bl_api_jogos_dia']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['bl_api_jogos_dia']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "bl_api_jogos_dia_erro.class.php"); 
      $this->Erro      = new bl_api_jogos_dia_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
if (!isset($_SESSION['nome_bolao'])) {$_SESSION['nome_bolao'] = "";}
...
if (!isset($this->sc_temp_id_bolao)) {$this->sc_temp_id_bolao = (isset($_SESSION['id_bolao'])) ? $_SESSION['id_bolao'] : "";}
  $nomeCompeticao = '';
$aIdJogos = $this->getIdJogosDia($this->sc_temp_id_bolao);
$userLogin = $this->sc_temp_usr_login;
$horaAtual = date('H:i:s');
$aComps = $this->verificaCompBolao($this->sc_temp_id_bolao);

if(empty($aComps)){		
	echo "<center><h4>Nenhuma competição cadastrada para o bolão:
				      $this->sc_temp_nome_bolao.<br> vá em cadastros, bolões e incluia
					  alguma competição para este bolão.</h4></center>";
}else{
    if(empty($aIdJogos)){				
	}else{
		foreach($aIdJogos as $jg){
						$apostaId = '';
						$idJg   = $jg[0];	
					    $comp   = $jg[1];
					    $rodada = $jg[2];
					    if($comp == 3){
							...
							$competicao = 'Brasileirão Serie B';
						}else if($comp == 6){
							$competicao = 'Premier League';
						}else if($comp == 8){
							$competicao = 'Campeonato Espanhol';
						}else if($comp == 9){
							$competicao = 'Campeonato Italiano';
						}else{
							$competicao = '';
						}
					    $data        = $this->getDataHoraJogo(1,$idJg);
					    $data        = date("d-m-Y",strtotime($data));
						$horario     = $this->getDataHoraJogo(2,$idJg);
						$time1       = $this->getTimeCasaJogo($idJg);
						$nomTimeCasa = $this->getNomeClube($time1);
						$brasaoTimeC = $this->getBrasaoClube($time1);
						$time2       = $this->getTimeVisiJogo($idJg);
						$nomTimeFora = $this->getNomeClube($time2);		
						$brasaoTimeF = $this->getBrasaoClube($time2);
						$placar1     = $this->getPlacarJogo(1,$idJg);
						$placar2     = $this->getPlacarJogo(2,$idJg);
					    $plAoVivo    = $this->getPlacarSite($nomTimeCasa,$nomTimeFora);
					    $aPalpite    = $this->getPalpitesUsuario("'$this->sc_temp_usr_login'",$idJg,$this->sc_temp_id_bolao);
					    $posCasa     = $this->getPosicaoCamp($comp,$time1);
					    $posFora     = $this->getPosicaoCamp($comp,$time2);
					    
					    if(empty($posCasa)){
							$clubeCasaPos  = '';
						}else{
							$clubeCasaPos  = $posCasa[0][0];								
						}
						if(empty($posFora)){
							$clubeForaPos  = '';
						}else{
							$clubeForaPos  = $posFora[0][0];								
						}
					    if(empty($plAoVivo)){
							$plCasaVivo  = '';
							$plForaVivo  = '';
							...
							$plCasaVivo  = $plAoVivo[0][0];
							$plForaVivo  = $plAoVivo[0][1];
							$labelPlVivo = 'Placar';						
						}
					    if(empty($aPalpite)){
							$casaPalpite = '';
							...
							$casaPalpite = $aPalpite[0][0];
							$foraPalpite = $aPalpite[0][1];
							$apostaId    = $aPalpite[0][2];
							$label       = 'Palpite';						
						}
						$aAposta = $this->verificaApostas($idJg,"'$this->sc_temp_usr_login'",$this->sc_temp_id_bolao);
			
			$a[] = array(
				 'competicao'        => $competicao,
				 'rodada'            => $rodada,
				 'horario'           => $horario,
				 'time_casa'         => $nomTimeCasa,
				 'pl_casa_vivo'      => $plCasaVivo,
				 'placar_casa'       => $placar1,
				 'palpite_t_casa'    => $casaPalpite,
				 'posicao_t_casa'    => $clubeCasaPos,
				 'brasao_time_casa'  => $brasaoTimeC,
				 'time_fora'         => $nomTimeFora,
				 'pl_fora_vivo'      => $plForaVivo,
				 'placar_casa'       => $placar2,
				 'palpite_t_fora'    => $foraPalpite,
				 'posicao_t_fora'    => $clubeForaPos,
				 'brasao_time_fora'  => $brasaoTimeF,
...
if(empty($a)){
	$retorno = 'Não Temos Jogos Hoje!';
}else{
	$retorno = json_encode($a);
}
...
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
...
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
    ...
    $sql = "select competicoes 
      ...
      { 
          $rs = false;
          $rs_erro = $this->Ini->nm_db_bolaotvc->ErrorMsg();
      } 
;
    ...
    if(is_array($competicoes)){
        foreach ($competicoes as $comps){
            $comp = $comps[0][0];
            $listaCompeticoes = $this->util_incr_valor($listaCompeticoes,$comp,",");
        }
    }
...
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
    ...
    $cmd = "insert into jogos(data_jogo,time_casa_id,time_visitante_id,horario,rodada,competicao_id,jogo_api_id,time_visitante_placar,time_casa_placar)
                    values($dt,$idTimeCasa,$idTimeFora,$horario,$rodada,$compId,$idJg,0,0)";
...
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
	...
	$sql = "select rodada from jogos where rodada = $rodada and competicao_id = $competicao";
...
function getPosicaoCamp($campeonato,$clubeId){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
    $sql = "select posicao				   
	        FROM classificacao 
			WHERE competicao_id = $campeonato and clube_id = $clubeId";
...
function getClassificacaoBanco($campeonato){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
	$sql = "select classificacao_id,
				   clube_id,
				   posicao,
				   pg_total,
				   pg_casa,
				   ...
				   competicao_id 
	        FROM classificacao 
			WHERE competicao_id = $campeonato
			order by posicao";	
...
function atualizarDadosClassificacao($campeonato,$clube,$pgTot,$pgMand,$pgVisit,$qtJogos,$v,$e,$d,$gp,$gc,$sg){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
	$cmd = " update classificacao set pg_total=$pgTot, pg_casa=$pgMand, pg_fora=$pgVisit, tot_jogos=$qtJogos,
			 qt_vitoria=$v, qt_empate=$e, qt_derrota=$d, gols_pro=$gp, gols_contra=$gc, saldo_gols=$sg
			 where competicao_id = $campeonato and clube_id = $clube";
...
function inserirDadosClassificacao($campeonato,$clube,$posicao,$pgTot,$pgMand,$pgVisit,$qtJogos,$v,$e,$d,$gp,$gc,$sg){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
	$cmd = "insert into classificacao(competicao_id,clube_id,posicao,pg_total,pg_casa,pg_fora,tot_jogos,qt_vitoria,qt_empate,qt_derrota,
	gols_pro,gols_contra,saldo_gols)
                    values($campeonato,$clube,$posicao,$pgTot,$pgMand,$pgVisit,$qtJogos,$v,$e,$d,$gp,$gc,$sg)";
...
function atualizarPosicaoClassificacao($campeonato,$clube,$posicao){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
	$cmd = " update classificacao set posicao = $posicao 
                     where competicao_id = $campeonato and clube_id = $clube";
...
function gravarClassificacoesPtCorridos($idCompBanco,$idCompApi,$filtroCompl=''){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  


    $aDadosCompe = $this->dadosCompeticoes($idCompApi);
    if(empty($aDadosCompe)){
    }else{
        $idCompBanco = $aDadosCompe['banco_id'];
        $filtroCompl = $aDadosCompe['filtro_compl'];
    }
    $aDados = getClassificacao($idCompApi,1,$filtroCompl);
    foreach($aDados as $dadosClubes){
        $idClube     = $dadosClubes->id;
        $posicao     = $dadosClubes->pos;
        $pg          = $dadosClubes->pg;
        $pgGanho     = $pg->total;
        $pgGanhoMand = $pg->mandante;
        $pgGanhoVisi = $pg->visitante;
        $jg          = $dadosClubes->j;
        $qtJogos     = $jg->total;
        $vit         = $dadosClubes->v;
        $numVitorias = $vit->total;
        $emp         = $dadosClubes->e;
        $numEmpates  = $emp->total;
        $der         = $dadosClubes->d;
        $numDerrotas = $der->total;
        $golsP       = $dadosClubes->gp;
        $golsPro     = $golsP->total;
        $golsC       = $dadosClubes->gc;
        $golsContra  = $golsC->total;
        $golsS       = $dadosClubes->sg;
        $golsSaldo   = $golsS->total;
        ...
        $this->atualizarDadosClassificacao($idCompBanco,$idClube,$pgGanho,$pgGanhoMand,$pgGanhoVisi,$qtJogos,$numVitorias,$numEmpates,$numDerrotas,$golsPro,$golsContra,$golsSaldo);

    }
    $aDadosPosClube = getClassificacao($idCompApi,2,$filtroCompl);
    $posi = 0;
    foreach($aDadosPosClube as $aPos){
        $posi += 1 ;
        $clubeId = $aPos;
        $this->atualizarPosicaoClassificacao($idCompBanco,$clubeId,$posi);
    }


$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'off';
}
function getDadosCoresClassif($nomeCompeticao,$pos){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
    switch($nomeCompeticao){
        case "Brasileirão Serie A":
            $label1 = 'Libertadores';
            $label2 = 'Pré-Libertadores';
            $label3 = 'Sulamericana';
            $label4 = 'Rebaixados';
            if($pos <= 4){
                $color = 'blue';
            }else if($pos > 4 and $pos <= 6 ){
                $color = 'green';
            }else if($pos > 6 and $pos < 13){
                $color = 'gray';
            }else if($pos > 12 and $pos < 17){
                $color = 'black';
            }else{
                $color = 'red';
            }
            break;
        case "Brasileirão Serie B":
            $label1 = 'Acesso Serie A';
            $label2 = '';
            $label3 = '';
            $label4 = 'Rebaixados';
            if($pos <= 4){
                $color = 'blue';
            }else if($pos > 4 and $pos < 17){
                $color = 'black';
            }else{
                $color = 'red';
            }
        ...
        case "Premier League":
            $label1 = 'Champions';
            $label2 = 'Liga Europa';
            $label3 = 'Conference League';
            $label4 = 'Rebaixados';
            if($pos <= 4){
                $color = 'blue';
            }else if($pos > 4 and $pos <= 6){
                $color = 'green';
            }else if($pos > 6 and $pos <= 7){
                $color = 'gray';
            }else if($pos > 7 and $pos < 18){
                $color = 'black';
            }else{
                $color = 'red';
            }
...
function getNomeCompeticaoIdBanco($idCompeticao){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
    switch($idCompeticao){
        case 30:
            $nomeCompeticao = "Brasileirão Serie A";
            $idCompBanco    = 3;
            break;
        case 112:
            $nomeCompeticao = "Brasileirão Serie B";
            $idCompBanco    = 4;
            break;
        case 79:
            $nomeCompeticao = "Premier League";
            $idCompBanco    = 6;
            break;
        case 72:
    ...
    return array(
        'nome_comp' => $nomeCompeticao,
        'id_banco_comp' => $idCompBanco
    );
...
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
    ...
    switch($id){
        ...
        case 79:
            $idCompBanco    = 6;
            $mes <= 6 ? $filtroCompl = '' : $filtroCompl = 'inter';
            break;
        case 51:
            $idCompBanco    = 7;
            $filtroCompl    = '';
    ...
    return array(
        'banco_id' => $idCompBanco,
        'filtro_compl' => $filtroCompl
    );


$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'off';
}
function buscarLogin($usuario,$senha){
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  

    $sql = "select name 
	        FROM s_users s
			WHERE s.login = '$usuario' and s.pswd = '$senha'";
...
function getPlacarSite($nomeTimeCasa,$nomeTimeFora)
{
$_SESSION['scriptcase']['bl_api_jogos_dia']['contr_erro'] = 'on';
  
    $sql = "select placar_time_casa, placar_time_fora 
	        FROM dados_placar_ao_vivo 
			WHERE time_casa = '$nomeTimeCasa' and time_fora = '$nomeTimeFora'";
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_bl_api_jogos_dia($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp'] . "/sc_apl_default_exercicios.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['bl_api_jogos_dia']['glo_nm_path_imag_temp'] . "/sc_apl_default_exercicios.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "bl_api_jogos_dia") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_exercicios'])) {
               $_SESSION['scriptcase']['bl_api_jogos_dia']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_exercicios'];
           }
       }
   }
   ...
   if (isset($_POST["id_bolao"])) 
   {
       ...
       nm_limpa_str_bl_api_jogos_dia($_SESSION["id_bolao"]);
   }
   ...
   if (isset($_POST["usr_login"])) 
   {
       ...
       nm_limpa_str_bl_api_jogos_dia($_SESSION["usr_login"]);
   }
   ...
   if (isset($_POST["nome_bolao"])) 
   {
       ...
       nm_limpa_str_bl_api_jogos_dia($_SESSION["nome_bolao"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "bl_api_jogos_dia";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'bl_api_jogos_dia' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('bl_api_jogos_dia' == $sReferer || 'bl_api_jogos_dia_' == substr($sReferer, 0, 17))
       {
           $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'bl_api_jogos_dia')
   {
       $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['bl_api_jogos_dia']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/bl_api_jogos_dia_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_bl_api_jogos_dia($cadapar[1]);
   ...
   $contr_bl_api_jogos_dia = new bl_api_jogos_dia_apl();
   $contr_bl_api_jogos_dia->controle();
//
   function nm_limpa_str_bl_api_jogos_dia(&$str)
   {

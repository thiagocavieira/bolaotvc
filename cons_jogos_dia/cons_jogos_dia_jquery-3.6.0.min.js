...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_cons_jogos_dia').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_cons_jogos_dia').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_cons_jogos_dia').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_cons_jogos_dia').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_cons_jogos_dia').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_cons_jogos_dia').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_cons_jogos_dia').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_cons_jogos_dia').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_cons_jogos_dia').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_cons_jogos_dia').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_cons_jogos_dia').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_cons_jogos_dia').style.width  = '0px';
        if (oResp["setValue"]) {
        ...
        if (opc == "igual" && parm_save == "reload") {
            setTimeout(function(){clear_reload = nm_gp_submit_ajax ('igual', 'reload');},50000);
        }
        if (!SC_Link_View)
        {

...
class cons_jogos_dia_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "cons_jogos_dia/cons_jogos_dia_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "cons_jogos_dia_res_xls.class.php");
              $this->Res_xls = new cons_jogos_dia_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_cons_jogos_dia.zip";
          $this->Arquivo   .= "_cons_jogos_dia" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['cons_jogos_dia']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['cons_jogos_dia']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_apostar()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apostar, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apostar, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- jogos_geral
   function NM_export_jogos_geral()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->jogos_geral = html_entity_decode($this->jogos_geral, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->jogos_geral = strip_tags($this->jogos_geral);
         $this->jogos_geral = NM_charset_to_utf8($this->jogos_geral);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->jogos_geral, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->jogos_geral, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- x
   ...
   function NM_export_time2()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->time2 = html_entity_decode($this->time2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->time2 = strip_tags($this->time2);
         $this->time2 = NM_charset_to_utf8($this->time2);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->time2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->time2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- jogo_id
   ...
   //----- apostar
   function NM_sub_cons_apostar()
   {
         $this->apostar = NM_charset_to_utf8($this->apostar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->apostar;
   ...
   //----- jogos_geral
   function NM_sub_cons_jogos_geral()
   {
         $this->jogos_geral = html_entity_decode($this->jogos_geral, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->jogos_geral = strip_tags($this->jogos_geral);
         $this->jogos_geral = NM_charset_to_utf8($this->jogos_geral);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->jogos_geral;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- time2
   function NM_sub_cons_time2()
   {
         $this->time2 = html_entity_decode($this->time2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->time2 = strip_tags($this->time2);
         $this->time2 = NM_charset_to_utf8($this->time2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->time2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_jogos_dia']['nolabel'])
       {

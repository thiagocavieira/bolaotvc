...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos_dia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_jogos_dia"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['cons_jogos_dia']))
   {
       unset($_SESSION['scriptcase']['refresh']['cons_jogos_dia']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_dia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos_dia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_dia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_jogos_dia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_jogos_dia']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_jogos_dia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_jogos_dia']['embutida_filho'] as $ind => $sc_init)
          {

<?php
@session_start() ;
$_SESSION['scriptcase']['cons_jogos_dia']['sc_process_barr'] = true;
require_once('../cons_jogos_dia/index.php');
unset($_SESSION['scriptcase']['cons_jogos_dia']['sc_process_barr']);
$ExportCtrl = new cons_jogos_dia_export_control;
$ExportCtrl->Export_barr();

class cons_jogos_dia_export_control
{

...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "time_id";$Nm_numeric[] = "time_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_time_id_cond" name="time_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_time_id'), this, 'time_id')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nome_time_cond" name="nome_time_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_time'), this, 'nome_time')">
      ...
      <br><span id="id_hide_nome_time"  <?php echo $str_hide_nome_time?>><?php
      if ($nome_time != "")
      {
      $nome_time_look = substr($this->Db->qstr($nome_time), 1, -1); 
      $nmgp_def_dados = array(); 

...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_times"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_times"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_times'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_times']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_times']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_times']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_times']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_times']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_times']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_times']['embutida_filho'] as $ind => $sc_init)
          {

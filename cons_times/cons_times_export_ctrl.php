<?php
@session_start() ;
$_SESSION['scriptcase']['cons_times']['sc_process_barr'] = true;
require_once('../cons_times/index.php');
unset($_SESSION['scriptcase']['cons_times']['sc_process_barr']);
$ExportCtrl = new cons_times_export_control;
$ExportCtrl->Export_barr();

class cons_times_export_control
{

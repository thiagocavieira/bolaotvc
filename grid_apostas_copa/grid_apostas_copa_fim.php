...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____grid_apostas_copa"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____grid_apostas_copa"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_apostas_copa'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_apostas_copa']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_apostas_copa']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_apostas_copa']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_apostas_copa']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_apostas_copa']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_apostas_copa']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_apostas_copa']['embutida_filho'] as $ind => $sc_init)
          {

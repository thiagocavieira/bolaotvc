...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "aposta_copa_id";$Nm_numeric[] = "jogo_id";$Nm_numeric[] = "placar_casa";$Nm_numeric[] = "placar_fora";$Nm_numeric[] = "aposta_copa_id";$Nm_numeric[] = "jogo_id";$Nm_numeric[] = "placar_casa";$Nm_numeric[] = "placar_fora";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_placar_fora_cond" name="placar_fora_cond" onChange="nm_campos_between(document.getElementById('id_vis_placar_fora'), this, 'placar_fora')">
      ...
      <br><span id="id_hide_placar_fora"  <?php echo $str_hide_placar_fora?>><INPUT  type="text" id="SC_placar_fora" name="placar_fora" value="<?php echo NM_encode_input($placar_fora) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_aposta_copa_id_cond" name="aposta_copa_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_aposta_copa_id'), this, 'aposta_copa_id')">
      ...
      <br><span id="id_hide_aposta_copa_id"  <?php echo $str_hide_aposta_copa_id?>><INPUT  type="text" id="SC_aposta_copa_id" name="aposta_copa_id" value="<?php echo NM_encode_input($aposta_copa_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nome_apostador_cond" name="nome_apostador_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_apostador'), this, 'nome_apostador')">
      ...
      <br><span id="id_hide_nome_apostador"  <?php echo $str_hide_nome_apostador?>><?php
      if ($nome_apostador != "")
      {
      $nome_apostador_look = substr($this->Db->qstr($nome_apostador), 1, -1); 
      $nmgp_def_dados = array(); 

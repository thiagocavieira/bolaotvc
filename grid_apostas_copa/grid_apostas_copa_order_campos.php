...
<?php
   ...
   $Ord_Cmp = new grid_apostas_copa_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_apostas_copa_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['nome_apostador'] = "nome_apostador";
   $tab_labels["nome_apostador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["nome_apostador"])) ? $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["nome_apostador"] : "Nome Apostador";
   $tab_ger_campos['time_casa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['time_casa'] = "time_casa";
   }
   else
   {
       $tab_def_campos['time_casa'] = "";
   }
   $tab_labels["time_casa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["time_casa"])) ? $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["time_casa"] : "Seleção";
   $tab_ger_campos['placar_casa'] = "on";
   $tab_def_campos['placar_casa'] = "placar_casa";
   $tab_labels["placar_casa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["placar_casa"])) ? $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["placar_casa"] : "Placar";
   $tab_ger_campos['x'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['x'] = "x";
   ...
   $tab_labels["x"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["x"])) ? $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["x"] : "";
   $tab_ger_campos['placar_fora'] = "on";
   $tab_def_campos['placar_fora'] = "placar_fora";
   $tab_labels["placar_fora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["placar_fora"])) ? $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["placar_fora"] : "Placar";
   $tab_ger_campos['time_visitante'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['time_visitante'] = "time_visitante";
   }
   else
   {
       $tab_def_campos['time_visitante'] = "";
   }
   $tab_labels["time_visitante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["time_visitante"])) ? $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['labels']["time_visitante"] : "Seleção";
   $tab_ger_campos['time_casa'] = "none";
   $tab_ger_campos['x'] = "none";
   $tab_ger_campos['time_visitante'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_apostas_copa_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_apostas_copa']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

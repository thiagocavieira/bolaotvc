...
class grid_apostas_copa_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_apostas_copa_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_apostas_copa_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_apostas_copa_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nome_apostador')
      {
          $nome_apostador = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nome_apostador($nome_apostador);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> apostas_copa</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_apostas_copa/grid_apostas_copa_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_apostas_copa_ajax_search.js"></script>
 <script type="text/javascript" src="grid_apostas_copa_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_apostas_copa_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_apostas_copa']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_apostas_copa']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_placar_fora_cond#NMF#' + search_get_sel_txt('SC_placar_fora_cond') + '@NMF@';
  str_out += 'SC_placar_fora#NMF#' + search_get_text('SC_placar_fora') + '@NMF@';
  str_out += 'SC_aposta_copa_id_cond#NMF#' + search_get_sel_txt('SC_aposta_copa_id_cond') + '@NMF@';
  str_out += 'SC_aposta_copa_id#NMF#' + search_get_text('SC_aposta_copa_id') + '@NMF@';
  str_out += 'SC_jogo_id_cond#NMF#' + search_get_sel_txt('SC_jogo_id_cond') + '@NMF@';
  str_out += 'SC_jogo_id#NMF#' + search_get_text('SC_jogo_id') + '@NMF@';
  str_out += 'SC_nome_apostador_cond#NMF#' + search_get_sel_txt('SC_nome_apostador_cond') + '@NMF@';
  str_out += 'SC_nome_apostador#NMF#' + search_get_text('SC_nome_apostador') + '@NMF@';
  str_out += 'id_ac_nome_apostador#NMF#' + search_get_text('id_ac_nome_apostador') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nome_apostador").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nome_apostador").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nome_apostador",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nome_apostador").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nome_apostador").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> apostas_copa</div>
...
<?php
   ...
   {
      global 
             $placar_fora_cond, $placar_fora,
             $aposta_copa_id_cond, $aposta_copa_id,
             $jogo_id_cond, $jogo_id,
             $nome_apostador_cond, $nome_apostador, $nome_apostador_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $placar_fora = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['placar_fora']; 
          $placar_fora_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['placar_fora_cond']; 
          $aposta_copa_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['aposta_copa_id']; 
          $aposta_copa_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['aposta_copa_id_cond']; 
          $jogo_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['jogo_id']; 
          $jogo_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['jogo_id_cond']; 
          $nome_apostador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['nome_apostador']; 
          $nome_apostador_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['nome_apostador_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['NM_operador']; 
          if (strtoupper($placar_fora_cond) != "II" && strtoupper($placar_fora_cond) != "QP" && strtoupper($placar_fora_cond) != "NP" && strtoupper($placar_fora_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($placar_fora, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($aposta_copa_id_cond) != "II" && strtoupper($aposta_copa_id_cond) != "QP" && strtoupper($aposta_copa_id_cond) != "NP" && strtoupper($aposta_copa_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($aposta_copa_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      ...
      if (!isset($placar_fora_cond) || empty($placar_fora_cond))
      {
         $placar_fora_cond = "gt";
      }
      if (!isset($aposta_copa_id_cond) || empty($aposta_copa_id_cond))
      {
         $aposta_copa_id_cond = "gt";
      }
      if (!isset($jogo_id_cond) || empty($jogo_id_cond))
      {
         $jogo_id_cond = "gt";
      }
      if (!isset($nome_apostador_cond) || empty($nome_apostador_cond))
      {
         $nome_apostador_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_placar_fora = (in_array($placar_fora_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_aposta_copa_id = (in_array($aposta_copa_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_jogo_id = (in_array($jogo_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nome_apostador = (in_array($nome_apostador_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($placar_fora) || $placar_fora == "")
      {
          $placar_fora = "";
      }
      if (isset($placar_fora) && !empty($placar_fora))
      {
         $tmp_pos = strpos($placar_fora, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $placar_fora = substr($placar_fora, 0, $tmp_pos);
         }
      }
      if (!isset($aposta_copa_id) || $aposta_copa_id == "")
      {
          $aposta_copa_id = "";
      }
      if (isset($aposta_copa_id) && !empty($aposta_copa_id))
      {
         $tmp_pos = strpos($aposta_copa_id, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $aposta_copa_id = substr($aposta_copa_id, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($nome_apostador) || $nome_apostador == "")
      {
          $nome_apostador = "";
      }
      if (isset($nome_apostador) && !empty($nome_apostador))
      {
         $tmp_pos = strpos($nome_apostador, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nome_apostador = substr($nome_apostador, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_placar_fora_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['placar_fora'])) ? $this->New_label['placar_fora'] : "Placar"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_placar_fora_cond" name="placar_fora_cond" onChange="nm_campos_between(document.getElementById('id_vis_placar_fora'), this, 'placar_fora')">
       <OPTION value="gt" <?php if ("gt" == $placar_fora_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $placar_fora_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $placar_fora_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_placar_fora" <?php echo $str_hide_placar_fora?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['placar_fora'])) ? $this->New_label['placar_fora'] : "Placar";
 $nmgp_tab_label .= "placar_fora?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_placar_fora" name="placar_fora" value="<?php echo NM_encode_input($placar_fora) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_aposta_copa_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['aposta_copa_id'])) ? $this->New_label['aposta_copa_id'] : "Aposta Copa Id"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_aposta_copa_id_cond" name="aposta_copa_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_aposta_copa_id'), this, 'aposta_copa_id')">
       <OPTION value="gt" <?php if ("gt" == $aposta_copa_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $aposta_copa_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $aposta_copa_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_aposta_copa_id" <?php echo $str_hide_aposta_copa_id?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['aposta_copa_id'])) ? $this->New_label['aposta_copa_id'] : "Aposta Copa Id";
 $nmgp_tab_label .= "aposta_copa_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_aposta_copa_id" name="aposta_copa_id" value="<?php echo NM_encode_input($aposta_copa_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<INPUT  type="text" id="SC_jogo_id" name="jogo_id" value="<?php echo NM_encode_input($jogo_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_nome_apostador_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nome_apostador'])) ? $this->New_label['nome_apostador'] : "Nome Apostador"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nome_apostador_cond" name="nome_apostador_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_apostador'), this, 'nome_apostador')">
       <OPTION value="qp" <?php if ("qp" == $nome_apostador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nome_apostador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nome_apostador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nome_apostador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nome_apostador" <?php echo $str_hide_nome_apostador?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nome_apostador'])) ? $this->New_label['nome_apostador'] : "Nome Apostador";
 $nmgp_tab_label .= "nome_apostador?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nome_apostador;
      }
?>
<INPUT  type="text" id="SC_nome_apostador" name="nome_apostador" value="<?php echo NM_encode_input($nome_apostador) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nome_apostador" name="nome_apostador_autocomp" size="40"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_apostas_copa_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_apostas_copa']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_apostas_copa']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.placar_fora_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_placar_fora'), document.F1.placar_fora_cond, 'placar_fora');
   document.F1.placar_fora.value = "";
   document.F1.aposta_copa_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_aposta_copa_id'), document.F1.aposta_copa_id_cond, 'aposta_copa_id');
   document.F1.aposta_copa_id.value = "";
   ...
   document.F1.nome_apostador_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nome_apostador'), document.F1.nome_apostador_cond, 'nome_apostador');
   document.F1.nome_apostador.value = "";
   document.F1.nome_apostador_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_placar_fora_cond'] = 'cond';
      $tp_fields['SC_placar_fora'] = 'text';
      $tp_fields['SC_aposta_copa_id_cond'] = 'cond';
      $tp_fields['SC_aposta_copa_id'] = 'text';
      $tp_fields['SC_jogo_id_cond'] = 'cond';
      $tp_fields['SC_jogo_id'] = 'text';
      $tp_fields['SC_nome_apostador_cond'] = 'cond';
      $tp_fields['SC_nome_apostador'] = 'text_aut';
      $tp_fields['id_ac_nome_apostador'] = 'text_aut';
   ...
   {
      global $placar_fora_cond, $placar_fora,
             $aposta_copa_id_cond, $aposta_copa_id,
             $jogo_id_cond, $jogo_id,
             $nome_apostador_cond, $nome_apostador, $nome_apostador_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($nome_apostador_autocomp) && empty($nome_apostador))
      {
          $nome_apostador = $nome_apostador_autocomp;
      }
      $placar_fora_cond_salva = $placar_fora_cond; 
      if (!isset($placar_fora_input_2) || $placar_fora_input_2 == "")
      {
          $placar_fora_input_2 = $placar_fora;
      }
      $aposta_copa_id_cond_salva = $aposta_copa_id_cond; 
      if (!isset($aposta_copa_id_input_2) || $aposta_copa_id_input_2 == "")
      {
          $aposta_copa_id_input_2 = $aposta_copa_id;
      }
      ...
      $nome_apostador_cond_salva = $nome_apostador_cond; 
      if (!isset($nome_apostador_input_2) || $nome_apostador_input_2 == "")
      {
          $nome_apostador_input_2 = $nome_apostador;
      }
      if ($placar_fora_cond != "in")
      {
          nm_limpa_numero($placar_fora, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($aposta_copa_id_cond != "in")
      {
          nm_limpa_numero($aposta_copa_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($jogo_id_cond != "in")
      {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['placar_fora'] = $placar_fora; 
      if (is_array($placar_fora) && !empty($placar_fora))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0] = $placar_fora;
      }
      elseif ($placar_fora_cond_salva == "nu" || $placar_fora_cond_salva == "nn" || $placar_fora_cond_salva == "ep" || $placar_fora_cond_salva == "ne" || !empty($placar_fora))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0][0] = $placar_fora;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['placar_fora_cond'] = $placar_fora_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['cmp'] = "placar_fora"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['opc'] = $placar_fora_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq']['placar_fora'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['aposta_copa_id'] = $aposta_copa_id; 
      if (is_array($aposta_copa_id) && !empty($aposta_copa_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0] = $aposta_copa_id;
      }
      elseif ($aposta_copa_id_cond_salva == "nu" || $aposta_copa_id_cond_salva == "nn" || $aposta_copa_id_cond_salva == "ep" || $aposta_copa_id_cond_salva == "ne" || !empty($aposta_copa_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0][0] = $aposta_copa_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['aposta_copa_id_cond'] = $aposta_copa_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['cmp'] = "aposta_copa_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['opc'] = $aposta_copa_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq']['aposta_copa_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['jogo_id'] = $jogo_id; 
      if (is_array($jogo_id) && !empty($jogo_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0] = $jogo_id;
      }
      elseif ($jogo_id_cond_salva == "nu" || $jogo_id_cond_salva == "nn" || $jogo_id_cond_salva == "ep" || $jogo_id_cond_salva == "ne" || !empty($jogo_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0][0] = $jogo_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['jogo_id_cond'] = $jogo_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['cmp'] = "jogo_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['opc'] = $jogo_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq']['jogo_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['nome_apostador'] = $nome_apostador; 
      if (is_array($nome_apostador) && !empty($nome_apostador))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0] = $nome_apostador;
      }
      elseif ($nome_apostador_cond_salva == "nu" || $nome_apostador_cond_salva == "nn" || $nome_apostador_cond_salva == "ep" || $nome_apostador_cond_salva == "ne" || !empty($nome_apostador))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['val'][0][0] = $nome_apostador;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['nome_apostador_cond'] = $nome_apostador_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['cmp'] = "nome_apostador"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid]['opc'] = $nome_apostador_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['grid_pesq']['nome_apostador'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $placar_fora;
      if (strtoupper($placar_fora_cond) != "II" && strtoupper($placar_fora_cond) != "QP" && strtoupper($placar_fora_cond) != "NP" && strtoupper($placar_fora_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['placar_fora'] = $Conteudo;
      $Conteudo = $aposta_copa_id;
      if (strtoupper($aposta_copa_id_cond) != "II" && strtoupper($aposta_copa_id_cond) != "QP" && strtoupper($aposta_copa_id_cond) != "NP" && strtoupper($aposta_copa_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['aposta_copa_id'] = $Conteudo;
      $Conteudo = $jogo_id;
      if (strtoupper($jogo_id_cond) != "II" && strtoupper($jogo_id_cond) != "QP" && strtoupper($jogo_id_cond) != "NP" && strtoupper($jogo_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
    ...
    if ($nome_apostador != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nome_apostador'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nome_apostador'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nome_apostador'] = $nome_apostador;
      }

      //----- $placar_fora
      $this->Date_part = false;
      if (isset($placar_fora) || $placar_fora_cond == "nu" || $placar_fora_cond == "nn" || $placar_fora_cond == "ep" || $placar_fora_cond == "ne")
      {
         $this->monta_condicao("placar_fora", $placar_fora_cond, $placar_fora, "", "placar_fora");
      }

      //----- $aposta_copa_id
      $this->Date_part = false;
      if (isset($aposta_copa_id) || $aposta_copa_id_cond == "nu" || $aposta_copa_id_cond == "nn" || $aposta_copa_id_cond == "ep" || $aposta_copa_id_cond == "ne")
      {
         $this->monta_condicao("aposta_copa_id", $aposta_copa_id_cond, $aposta_copa_id, "", "aposta_copa_id");
      }
      ...
      //----- $nome_apostador
      $this->Date_part = false;
      if (isset($nome_apostador) || $nome_apostador_cond == "nu" || $nome_apostador_cond == "nn" || $nome_apostador_cond == "ep" || $nome_apostador_cond == "ne")
      {
         $this->monta_condicao("nome_apostador", $nome_apostador_cond, $nome_apostador, "", "nome_apostador");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_apostas_copa']['cond_pesq'] .= $this->NM_operador;

<?php
@session_start() ;
$_SESSION['scriptcase']['grid_apostas_copa']['sc_process_barr'] = true;
require_once('../grid_apostas_copa/index.php');
unset($_SESSION['scriptcase']['grid_apostas_copa']['sc_process_barr']);
$ExportCtrl = new grid_apostas_copa_export_control;
$ExportCtrl->Export_barr();

class grid_apostas_copa_export_control
{

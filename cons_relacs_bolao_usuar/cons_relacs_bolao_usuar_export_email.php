<?php
   ...
   session_start();
    ...
    $exportEmail = new exportEmail_cons_relacs_bolao_usuar(); 
   
class exportEmail_cons_relacs_bolao_usuar
{
...
<HEAD>
 <TITLE><?php echo "Participantes"; ?></TITLE>
...
?>
            ...
            function html_export_email_send()
            {
                $.ajax({
                    type: 'POST',
                    url: 'cons_relacs_bolao_usuar_export_email.php',

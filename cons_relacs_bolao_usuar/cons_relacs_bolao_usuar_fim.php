...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_relacs_bolao_usuar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_relacs_bolao_usuar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_relacs_bolao_usuar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_relacs_bolao_usuar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_relacs_bolao_usuar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_relacs_bolao_usuar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_relacs_bolao_usuar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>cons_relacs_bolao_usuar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_relacs_bolao_usuar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_relacs_bolao_usuar']['embutida_filho'] as $ind => $sc_init)
          {

<?php
@session_start() ;
$_SESSION['scriptcase']['ap_logged_users']['sc_process_barr'] = true;
require_once('../ap_logged_users/index.php');
unset($_SESSION['scriptcase']['ap_logged_users']['sc_process_barr']);
$ExportCtrl = new ap_logged_users_export_control;
$ExportCtrl->Export_barr();

class ap_logged_users_export_control
{

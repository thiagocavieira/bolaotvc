  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_apostas_2" == sTestField)
        {
...
?>
  ...
  // ---------- Validate login_id_
  function do_ajax_form_apostas_2_validate_login_id_(iNumLinha)
  {
    var nomeCampo_login_id_ = "login_id_" + iNumLinha;
    var var_login_id_ = scAjaxGetFieldText(nomeCampo_login_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_2_validate_login_id_(var_login_id_, iNumLinha, var_script_case_init, do_ajax_form_apostas_2_validate_login_id__cb);
  } // do_ajax_form_apostas_2_validate_login_id_

  function do_ajax_form_apostas_2_validate_login_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "login_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "login_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "login_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "login_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_2_validate_login_id__cb

  // ---------- Validate time_casa_
  function do_ajax_form_apostas_2_validate_time_casa_(iNumLinha)
  {
    var nomeCampo_time_casa_ = "time_casa_" + iNumLinha;
    var var_time_casa_ = scAjaxGetFieldText(nomeCampo_time_casa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_2_validate_time_casa_(var_time_casa_, iNumLinha, var_script_case_init, do_ajax_form_apostas_2_validate_time_casa__cb);
  } // do_ajax_form_apostas_2_validate_time_casa_

  function do_ajax_form_apostas_2_validate_time_casa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "time_casa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "time_casa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "time_casa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "time_casa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_2_validate_time_casa__cb

  // ---------- Validate time_casa_placar_
  function do_ajax_form_apostas_2_validate_time_casa_placar_(iNumLinha)
  {
    var nomeCampo_time_casa_placar_ = "time_casa_placar_" + iNumLinha;
    var var_time_casa_placar_ = scAjaxGetFieldText(nomeCampo_time_casa_placar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_2_validate_time_casa_placar_(var_time_casa_placar_, iNumLinha, var_script_case_init, do_ajax_form_apostas_2_validate_time_casa_placar__cb);
  } // do_ajax_form_apostas_2_validate_time_casa_placar_

  function do_ajax_form_apostas_2_validate_time_casa_placar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "time_casa_placar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "time_casa_placar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "time_casa_placar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "time_casa_placar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_2_validate_time_casa_placar__cb

  // ---------- Validate x_
  function do_ajax_form_apostas_2_validate_x_(iNumLinha)
  {
    var nomeCampo_x_ = "x_" + iNumLinha;
    var var_x_ = scAjaxGetFieldText(nomeCampo_x_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_2_validate_x_(var_x_, iNumLinha, var_script_case_init, do_ajax_form_apostas_2_validate_x__cb);
  } // do_ajax_form_apostas_2_validate_x_

  function do_ajax_form_apostas_2_validate_x__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "x_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "x_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_2_validate_x__cb

  // ---------- Validate time_visitante_placar_
  function do_ajax_form_apostas_2_validate_time_visitante_placar_(iNumLinha)
  {
    var nomeCampo_time_visitante_placar_ = "time_visitante_placar_" + iNumLinha;
    var var_time_visitante_placar_ = scAjaxGetFieldText(nomeCampo_time_visitante_placar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_2_validate_time_visitante_placar_(var_time_visitante_placar_, iNumLinha, var_script_case_init, do_ajax_form_apostas_2_validate_time_visitante_placar__cb);
  } // do_ajax_form_apostas_2_validate_time_visitante_placar_

  function do_ajax_form_apostas_2_validate_time_visitante_placar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "time_visitante_placar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "time_visitante_placar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "time_visitante_placar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "time_visitante_placar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_2_validate_time_visitante_placar__cb

  // ---------- Validate time_visitante_
  function do_ajax_form_apostas_2_validate_time_visitante_(iNumLinha)
  {
    var nomeCampo_time_visitante_ = "time_visitante_" + iNumLinha;
    var var_time_visitante_ = scAjaxGetFieldText(nomeCampo_time_visitante_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_2_validate_time_visitante_(var_time_visitante_, iNumLinha, var_script_case_init, do_ajax_form_apostas_2_validate_time_visitante__cb);
  } // do_ajax_form_apostas_2_validate_time_visitante_

  function do_ajax_form_apostas_2_validate_time_visitante__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "time_visitante_" + iLineNumber;
    }
    else
    {
      sFieldValid = "time_visitante_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "time_visitante_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "time_visitante_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_apostas_2_validate_time_visitante__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_apostas_2_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_apostas_2_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_apostas_2_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_apostas_2_add_new_line_cb);
  } // do_ajax_form_apostas_2_add_new_line

  function do_ajax_form_apostas_2_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_apostas_2_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_apostas_2_backup_line(iNumLinha)
  {
    var var_aposta_id_ = scAjaxGetFieldText("aposta_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_apostas_2_backup_line(var_aposta_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_apostas_2_backup_line_cb);
  } // do_ajax_form_apostas_2_backup_line

  function do_ajax_form_apostas_2_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_apostas_2_backup_line_cb

  function do_ajax_form_apostas_2_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_apostas_2_cancel_insert

  function do_ajax_form_apostas_2_cancel_update(iSeqVert)
  {
    do_ajax_form_apostas_2_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_apostas_2_cancel_update

  function do_ajax_form_apostas_2_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_apostas_2_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_apostas_2_table_refresh()
  {
    var var_aposta_id_ = document.F2.aposta_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_apostas_2_table_refresh(var_aposta_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_apostas_2_table_refresh_cb);
  } //  do_ajax_form_apostas_2_table_refresh

  function do_ajax_form_apostas_2_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.aposta_id_.value = scAjaxGetKeyValue("aposta_id_");
    ...
    scAjaxAlert(do_ajax_form_apostas_2_table_refresh_cb_after_alert);
  } // do_ajax_form_apostas_2_table_refresh_cb
  function do_ajax_form_apostas_2_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_apostas_2_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_apostas_2_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_apostas_2_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_login_id_ = scAjaxGetFieldText("login_id_" + iNumLinha);
    var var_time_casa_ = scAjaxGetFieldText("time_casa_" + iNumLinha);
    var var_time_casa_placar_ = scAjaxGetFieldText("time_casa_placar_" + iNumLinha);
    var var_x_ = scAjaxGetFieldText("x_" + iNumLinha);
    var var_time_visitante_placar_ = scAjaxGetFieldText("time_visitante_placar_" + iNumLinha);
    var var_time_visitante_ = scAjaxGetFieldText("time_visitante_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_apostas_2_submit_form(var_login_id_, var_time_casa_, var_time_casa_placar_, var_x_, var_time_visitante_placar_, var_time_visitante_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_apostas_2_submit_form_cb);
  } // do_ajax_form_apostas_2_submit_form

  function do_ajax_form_apostas_2_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("login_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("time_casa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("time_casa_placar_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("x_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("time_visitante_placar_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("time_visitante_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_apostas_2_submit_form_cb_after_alert);
  } // do_ajax_form_apostas_2_submit_form_cb
  function do_ajax_form_apostas_2_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_apostas_2_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_apostas_2_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_apostas_2_navigate_form, function() {});
    } else {
      perform_ajax_form_apostas_2_navigate_form();
    }
  }

  function perform_ajax_form_apostas_2_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_apostas_2_cancel_insert(sc_form_apostas_2_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("login_id_" + iNavForm);
      scAjaxHideErrorDisplay("time_casa_" + iNavForm);
      scAjaxHideErrorDisplay("time_casa_placar_" + iNavForm);
      scAjaxHideErrorDisplay("x_" + iNavForm);
      scAjaxHideErrorDisplay("time_visitante_placar_" + iNavForm);
      scAjaxHideErrorDisplay("time_visitante_" + iNavForm);
    }
    var var_aposta_id_ = document.F2.aposta_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_apostas_2_navigate_form(var_aposta_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_apostas_2_navigate_form_cb);
  } // do_ajax_form_apostas_2_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_apostas_2']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_apostas_2_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.aposta_id_.value = scAjaxGetKeyValue("aposta_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_apostas_2_navigate_form_cb_after_alert);
  } // do_ajax_form_apostas_2_navigate_form_cb
  function do_ajax_form_apostas_2_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_apostas_2_navigate_form_cb_after_alert

    function sc_form_apostas_2_get_last_line_number()
    {
    ...
    } //sc_form_apostas_2_get_last_line_number 

  function sc_hide_form_apostas_2_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "login_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "time_casa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "time_casa_placar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "x_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "time_visitante_placar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "time_visitante_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["login_id_" + iNumLinha] = {"label": "Login Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["time_casa_" + iNumLinha] = {"label": "Time Casa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["time_casa_placar_" + iNumLinha] = {"label": "Time Casa Placar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["x_" + iNumLinha] = {"label": "<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["time_visitante_placar_" + iNumLinha] = {"label": "Time Visitante Placar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["time_visitante_" + iNumLinha] = {"label": "Time Visitante<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["login_id_"][iNumLinha] = "login_id_" + iNumLinha;
    ajax_field_mult["time_casa_"][iNumLinha] = "time_casa_" + iNumLinha;
    ajax_field_mult["time_casa_placar_"][iNumLinha] = "time_casa_placar_" + iNumLinha;
    ajax_field_mult["x_"][iNumLinha] = "x_" + iNumLinha;
    ajax_field_mult["time_visitante_placar_"][iNumLinha] = "time_visitante_placar_" + iNumLinha;
    ajax_field_mult["time_visitante_"][iNumLinha] = "time_visitante_" + iNumLinha;
    ajax_field_id["login_id_" + iNumLinha] = new Array("hidden_field_label_login_id_", "hidden_field_data_login_id_" + iNumLinha);
    ajax_field_id["time_casa_" + iNumLinha] = new Array("hidden_field_label_time_casa_", "hidden_field_data_time_casa_" + iNumLinha);
    ajax_field_id["time_casa_placar_" + iNumLinha] = new Array("hidden_field_label_time_casa_placar_", "hidden_field_data_time_casa_placar_" + iNumLinha);
    ajax_field_id["x_" + iNumLinha] = new Array("hidden_field_label_x_", "hidden_field_data_x_" + iNumLinha);
    ajax_field_id["time_visitante_placar_" + iNumLinha] = new Array("hidden_field_label_time_visitante_placar_", "hidden_field_data_time_visitante_placar_" + iNumLinha);
    ajax_field_id["time_visitante_" + iNumLinha] = new Array("hidden_field_label_time_visitante_", "hidden_field_data_time_visitante_" + iNumLinha);
    ajax_error_count["login_id_" + iNumLinha] = "off";
    ajax_error_count["time_casa_" + iNumLinha] = "off";
    ajax_error_count["time_casa_placar_" + iNumLinha] = "off";
    ajax_error_count["x_" + iNumLinha] = "off";
    ajax_error_count["time_visitante_placar_" + iNumLinha] = "off";
    ajax_error_count["time_visitante_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["login_id_" + iNumLinha] = "off";
    ajax_read_only["time_casa_" + iNumLinha] = "off";
    ajax_read_only["time_casa_placar_" + iNumLinha] = "off";
    ajax_read_only["x_" + iNumLinha] = "off";
    ajax_read_only["time_visitante_placar_" + iNumLinha] = "off";
    ajax_read_only["time_visitante_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["login_id_" + iNumLinha] = "on";
    ajax_read_only["time_casa_" + iNumLinha] = "on";
    ajax_read_only["time_casa_placar_" + iNumLinha] = "on";
    ajax_read_only["x_" + iNumLinha] = "on";
    ajax_read_only["time_visitante_placar_" + iNumLinha] = "on";
    ajax_read_only["time_visitante_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["login_id_" + iNumLinha] = null;
    ajax_error_list["time_casa_" + iNumLinha] = null;
    ajax_error_list["time_casa_placar_" + iNumLinha] = null;
    ajax_error_list["x_" + iNumLinha] = null;
    ajax_error_list["time_visitante_placar_" + iNumLinha] = null;
    ajax_error_list["time_visitante_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "login_id_": new Array(),
    "time_casa_": new Array(),
    "time_casa_placar_": new Array(),
    "x_": new Array(),
    "time_visitante_placar_": new Array(),
    "time_visitante_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["login_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["login_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["login_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["login_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["login_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["time_casa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["time_casa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["time_casa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["time_casa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["time_casa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["time_casa_placar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["time_casa_placar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["time_casa_placar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["time_casa_placar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["time_casa_placar_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["x_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["x_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["x_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["x_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["x_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["time_visitante_placar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["time_visitante_placar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["time_visitante_placar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["time_visitante_placar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["time_visitante_placar_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["time_visitante_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["time_visitante_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["time_visitante_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["time_visitante_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["time_visitante_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['login_id_'])) ? $this->nmgp_cmp_readonly['login_id_'] : 'off';
?>
    scAjaxFieldRead("login_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['time_casa_'])) ? $this->nmgp_cmp_readonly['time_casa_'] : 'off';
?>
    scAjaxFieldRead("time_casa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['time_casa_placar_'])) ? $this->nmgp_cmp_readonly['time_casa_placar_'] : 'off';
?>
    scAjaxFieldRead("time_casa_placar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['x_'])) ? $this->nmgp_cmp_readonly['x_'] : 'off';
?>
    scAjaxFieldRead("x_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['time_visitante_placar_'])) ? $this->nmgp_cmp_readonly['time_visitante_placar_'] : 'off';
?>
    scAjaxFieldRead("time_visitante_placar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['time_visitante_'])) ? $this->nmgp_cmp_readonly['time_visitante_'] : 'off';
?>
    scAjaxFieldRead("time_visitante_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("login_id_" + iSeq, "on");
    scAjaxFieldRead("time_casa_" + iSeq, "on");
    scAjaxFieldRead("time_casa_placar_" + iSeq, "on");
    scAjaxFieldRead("x_" + iSeq, "on");
    scAjaxFieldRead("time_visitante_placar_" + iSeq, "on");
    scAjaxFieldRead("time_visitante_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["login_id_" + iRow] || "on" == ajax_error_count["time_casa_" + iRow] || "on" == ajax_error_count["time_casa_placar_" + iRow] || "on" == ajax_error_count["x_" + iRow] || "on" == ajax_error_count["time_visitante_placar_" + iRow] || "on" == ajax_error_count["time_visitante_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_login_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_time_casa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_time_casa_placar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_x_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_time_visitante_placar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_time_visitante_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["login_id_" + iRow] && "off" == ajax_error_count["time_casa_" + iRow] && "off" == ajax_error_count["time_casa_placar_" + iRow] && "off" == ajax_error_count["x_" + iRow] && "off" == ajax_error_count["time_visitante_placar_" + iRow] && "off" == ajax_error_count["time_visitante_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["login_id_" + iRow] = "off";
        ajax_error_count["time_casa_" + iRow] = "off";
        ajax_error_count["time_casa_placar_" + iRow] = "off";
        ajax_error_count["x_" + iRow] = "off";
        ajax_error_count["time_visitante_placar_" + iRow] = "off";
        ajax_error_count["time_visitante_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_login_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_time_casa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_time_casa_placar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_x_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_time_visitante_placar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_time_visitante_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("time_visitante_placar_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);

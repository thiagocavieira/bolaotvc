  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jogos_1" == sTestField)
        {
...
?>
  ...
  // ---------- Validate jogo_id
  function do_ajax_form_jogos_1_validate_jogo_id()
  {
    var nomeCampo_jogo_id = "jogo_id";
    var var_jogo_id = scAjaxGetFieldHidden(nomeCampo_jogo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_jogo_id(var_jogo_id, var_script_case_init, do_ajax_form_jogos_1_validate_jogo_id_cb);
  } // do_ajax_form_jogos_1_validate_jogo_id

  function do_ajax_form_jogos_1_validate_jogo_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_jogo_id_cb

  // ---------- Validate data_jogo
  function do_ajax_form_jogos_1_validate_data_jogo()
  {
    ...
    setTimeout(function() {
      var var_data_jogo = scAjaxGetFieldText(nomeCampo_data_jogo);
      x_ajax_form_jogos_1_validate_data_jogo(var_data_jogo, var_script_case_init, do_ajax_form_jogos_1_validate_data_jogo_cb);
    }, 200);
  } // do_ajax_form_jogos_1_validate_data_jogo

  function do_ajax_form_jogos_1_validate_data_jogo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_data_jogo_cb

  // ---------- Validate time_casa_id
  function do_ajax_form_jogos_1_validate_time_casa_id()
  {
    var nomeCampo_time_casa_id = "time_casa_id";
    var var_time_casa_id = scAjaxGetFieldText(nomeCampo_time_casa_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_time_casa_id(var_time_casa_id, var_script_case_init, do_ajax_form_jogos_1_validate_time_casa_id_cb);
  } // do_ajax_form_jogos_1_validate_time_casa_id

  function do_ajax_form_jogos_1_validate_time_casa_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_time_casa_id_cb

  // ---------- Validate time_visitante_id
  function do_ajax_form_jogos_1_validate_time_visitante_id()
  {
    var nomeCampo_time_visitante_id = "time_visitante_id";
    var var_time_visitante_id = scAjaxGetFieldText(nomeCampo_time_visitante_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_time_visitante_id(var_time_visitante_id, var_script_case_init, do_ajax_form_jogos_1_validate_time_visitante_id_cb);
  } // do_ajax_form_jogos_1_validate_time_visitante_id

  function do_ajax_form_jogos_1_validate_time_visitante_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_time_visitante_id_cb

  // ---------- Validate time_visitante_placar
  function do_ajax_form_jogos_1_validate_time_visitante_placar()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_time_visitante_placar(var_time_visitante_placar, var_script_case_init, do_ajax_form_jogos_1_validate_time_visitante_placar_cb);
  } // do_ajax_form_jogos_1_validate_time_visitante_placar

  function do_ajax_form_jogos_1_validate_time_visitante_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_time_visitante_placar_cb

  // ---------- Validate time_casa_placar
  function do_ajax_form_jogos_1_validate_time_casa_placar()
  {
    var nomeCampo_time_casa_placar = "time_casa_placar";
    var var_time_casa_placar = scAjaxGetFieldText(nomeCampo_time_casa_placar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_time_casa_placar(var_time_casa_placar, var_script_case_init, do_ajax_form_jogos_1_validate_time_casa_placar_cb);
  } // do_ajax_form_jogos_1_validate_time_casa_placar

  function do_ajax_form_jogos_1_validate_time_casa_placar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_time_casa_placar_cb

  // ---------- Validate horario
  function do_ajax_form_jogos_1_validate_horario()
  {
    var nomeCampo_horario = "horario";
    var var_horario = scAjaxGetFieldText(nomeCampo_horario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_horario(var_horario, var_script_case_init, do_ajax_form_jogos_1_validate_horario_cb);
  } // do_ajax_form_jogos_1_validate_horario

  function do_ajax_form_jogos_1_validate_horario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_horario_cb

  // ---------- Validate rodada
  function do_ajax_form_jogos_1_validate_rodada()
  {
    var nomeCampo_rodada = "rodada";
    var var_rodada = scAjaxGetFieldText(nomeCampo_rodada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_rodada(var_rodada, var_script_case_init, do_ajax_form_jogos_1_validate_rodada_cb);
  } // do_ajax_form_jogos_1_validate_rodada

  function do_ajax_form_jogos_1_validate_rodada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rodada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_rodada_cb

  // ---------- Validate competicao_id
  function do_ajax_form_jogos_1_validate_competicao_id()
  {
    var nomeCampo_competicao_id = "competicao_id";
    var var_competicao_id = scAjaxGetFieldSelect(nomeCampo_competicao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jogos_1_validate_competicao_id(var_competicao_id, var_script_case_init, do_ajax_form_jogos_1_validate_competicao_id_cb);
  } // do_ajax_form_jogos_1_validate_competicao_id

  function do_ajax_form_jogos_1_validate_competicao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jogos_1_validate_competicao_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jogos_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jogos_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_jogo_id = scAjaxGetFieldHidden("jogo_id");
    var var_data_jogo = scAjaxGetFieldText("data_jogo");
    var var_time_casa_id = scAjaxGetFieldText("time_casa_id");
    var var_time_visitante_id = scAjaxGetFieldText("time_visitante_id");
    ...
    var var_rodada = scAjaxGetFieldText("rodada");
    ...
    scAjaxProcOn();
    x_ajax_form_jogos_1_submit_form(var_jogo_id, var_data_jogo, var_time_casa_id, var_time_visitante_id, var_time_visitante_placar, var_time_casa_placar, var_horario, var_rodada, var_competicao_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jogos_1_submit_form_cb);
  } // do_ajax_form_jogos_1_submit_form

  function do_ajax_form_jogos_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jogos_1_submit_form_cb_after_alert);
  } // do_ajax_form_jogos_1_submit_form_cb
  function do_ajax_form_jogos_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jogos_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jogos_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_jogos_1_navigate_form, function() {});
    } else {
      perform_ajax_form_jogos_1_navigate_form();
    }
  }

  function perform_ajax_form_jogos_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_jogos_1_navigate_form(var_jogo_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jogos_1_navigate_form_cb);
  } // do_ajax_form_jogos_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jogos_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jogos_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jogos_1_navigate_form_cb_after_alert);
  } // do_ajax_form_jogos_1_navigate_form_cb
  function do_ajax_form_jogos_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jogos_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jogos_1_navigate_form_cb_after_alert

  function sc_hide_form_jogos_1_form()
  {
  ...
  ajax_field_list[1] = "data_jogo";
  ajax_field_list[2] = "time_casa_id";
  ajax_field_list[3] = "time_visitante_id";
  ajax_field_list[4] = "time_visitante_placar";
  ajax_field_list[5] = "time_casa_placar";
  ajax_field_list[6] = "horario";
  ajax_field_list[7] = "rodada";
  ajax_field_list[8] = "competicao_id";
  ...
  var ajax_error_list = {
    ...
    "time_casa_id": {"label": "Time Casa Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "time_visitante_id": {"label": "Time Visitante Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},

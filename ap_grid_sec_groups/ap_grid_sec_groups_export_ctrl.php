<?php
@session_start() ;
$_SESSION['scriptcase']['ap_grid_sec_groups']['sc_process_barr'] = true;
require_once('../ap_grid_sec_groups/index.php');
unset($_SESSION['scriptcase']['ap_grid_sec_groups']['sc_process_barr']);
$ExportCtrl = new ap_grid_sec_groups_export_control;
$ExportCtrl->Export_barr();

class ap_grid_sec_groups_export_control
{

<?php
@session_start() ;
$_SESSION['scriptcase']['cons_temporadas']['sc_process_barr'] = true;
require_once('../cons_temporadas/index.php');
unset($_SESSION['scriptcase']['cons_temporadas']['sc_process_barr']);
$ExportCtrl = new cons_temporadas_export_control;
$ExportCtrl->Export_barr();

class cons_temporadas_export_control
{

...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_temporadas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_temporadas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_temporadas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_temporadas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_temporadas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_temporadas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_temporadas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_temporadas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_temporadas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_temporadas']['embutida_filho'] as $ind => $sc_init)
          {

...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "temporada_id";$Nm_numeric[] = "ano_temp";$Nm_numeric[] = "temporada_id";$Nm_numeric[] = "ano_temp";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_temporada_id_cond" name="temporada_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_temporada_id'), this, 'temporada_id')">
      ...
      <br><span id="id_hide_temporada_id"  <?php echo $str_hide_temporada_id?>><INPUT  type="text" id="SC_temporada_id" name="temporada_id" value="<?php echo NM_encode_input($temporada_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ano_temp_cond" name="ano_temp_cond" onChange="nm_campos_between(document.getElementById('id_vis_ano_temp'), this, 'ano_temp')">
      ...
      <br><span id="id_hide_ano_temp"  <?php echo $str_hide_ano_temp?>><INPUT  type="text" id="SC_ano_temp" name="ano_temp" value="<?php echo NM_encode_input($ano_temp) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>

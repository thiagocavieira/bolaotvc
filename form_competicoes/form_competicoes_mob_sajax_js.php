  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_competicoes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_competicoes_mob_form();
	}
...
?>
  ...
  function do_ajax_form_competicoes_mob_validate_competicao_id()
  {
    var nomeCampo_competicao_id = "competicao_id";
    var var_competicao_id = scAjaxGetFieldHidden(nomeCampo_competicao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_competicoes_mob_validate_competicao_id(var_competicao_id, var_script_case_init, do_ajax_form_competicoes_mob_validate_competicao_id_cb);
  } // do_ajax_form_competicoes_mob_validate_competicao_id

  function do_ajax_form_competicoes_mob_validate_competicao_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_competicoes_mob_validate_competicao_id_cb

  // ---------- Validate nome_competicao
  function do_ajax_form_competicoes_mob_validate_nome_competicao()
  {
    var nomeCampo_nome_competicao = "nome_competicao";
    var var_nome_competicao = scAjaxGetFieldText(nomeCampo_nome_competicao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_competicoes_mob_validate_nome_competicao(var_nome_competicao, var_script_case_init, do_ajax_form_competicoes_mob_validate_nome_competicao_cb);
  } // do_ajax_form_competicoes_mob_validate_nome_competicao

  function do_ajax_form_competicoes_mob_validate_nome_competicao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_competicao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_competicoes_mob_validate_nome_competicao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_competicoes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_competicoes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_competicao_id = scAjaxGetFieldHidden("competicao_id");
    var var_nome_competicao = scAjaxGetFieldText("nome_competicao");
    ...
    scAjaxProcOn();
    x_ajax_form_competicoes_mob_submit_form(var_competicao_id, var_nome_competicao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_competicoes_mob_submit_form_cb);
  } // do_ajax_form_competicoes_mob_submit_form

  function do_ajax_form_competicoes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nome_competicao");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_competicoes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_competicoes_mob_submit_form_cb
  function do_ajax_form_competicoes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_competicoes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_competicoes_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_competicoes_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_competicoes_mob_navigate_form();
    }
  }

  function perform_ajax_form_competicoes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("competicao_id");
    scAjaxHideErrorDisplay("nome_competicao");
    var var_competicao_id = document.F2.competicao_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_competicoes_mob_navigate_form(var_competicao_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_competicoes_mob_navigate_form_cb);
  } // do_ajax_form_competicoes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_competicoes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_competicoes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.competicao_id.value = scAjaxGetKeyValue("competicao_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_competicoes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_competicoes_mob_navigate_form_cb
  function do_ajax_form_competicoes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_competicoes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_competicoes_mob_navigate_form_cb_after_alert

  function sc_hide_form_competicoes_mob_form()
  {
  ...
  ajax_field_list[0] = "competicao_id";
  ajax_field_list[1] = "nome_competicao";
  ...
  var ajax_error_list = {
    ...
    "nome_competicao": {"label": "Nome Competicao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "nome_competicao": new Array()
  };
  ajax_field_mult["competicao_id"][1] = "competicao_id";
  ajax_field_mult["nome_competicao"][1] = "nome_competicao";

  var ajax_field_id = {
    "competicao_id": new Array("hidden_field_label_competicao_id", "hidden_field_data_competicao_id"),
    "nome_competicao": new Array("hidden_field_label_nome_competicao", "hidden_field_data_nome_competicao")
  };

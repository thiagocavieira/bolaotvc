...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_apostas_geral"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_apostas_geral"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>cons_apostas_geral</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['embutida_filho'] as $ind => $sc_init)
          {

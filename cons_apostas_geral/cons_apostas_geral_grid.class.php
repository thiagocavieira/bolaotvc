...
class cons_apostas_geral_grid
{
   ...
   var $apostas_login_id_Old;
   var $arg_sum_apostas_login_id;
   var $Label_apostas_login_id;
   var $sc_proc_quebra_apostas_login_id;
   var $count_apostas_login_id;
   var $x;
   var $sit_aposta;
   var $time_casa;
   var $apostas_aposta_id;
   var $apostas_dt_hr_aposta;
   var $jogos_rodada;
   var $jogos_data_jogo;
   var $jogos_horario;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['charts_html'] = '';
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['cons_apostas_geral'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("pt_br");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_pdf']['all_label'] : "S";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "cons_apostas_geral/cons_apostas_geral_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pesq_tab_label'] .= "apostas_login_id?#?" . "Apostador" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_search_add']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if (count($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp']) > 1)
   {
       $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp']) - 1) * 8) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['mostra_edit'] = "N";
   }
   $this->sc_proc_quebra_jogos_competicao_id = false;
   $this->sc_proc_quebra_apostas_login_id = false;
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree'] = array();
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['print_all'];
   if ($this->Print_All)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['apostas_aposta_id'] = " desc";
   $this->Cmps_ord_def["apostas.aposta_id"] = "";
   $this->Cmps_ord_def['apostas_dt_hr_aposta'] = " desc";
   $this->Cmps_ord_def["apostas.dt_hr_aposta"] = "";
   ...
   $this->Cmps_ord_def['jogos_horario'] = " desc";
   $this->Cmps_ord_def["jogos.horario"] = "";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cons_apostas_geral'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cons_apostas_geral'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "cons_apostas_geral/cons_apostas_geral_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "cons_apostas_geral_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] = 100;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_select'] = array(); 
           $Free_sql_atual = array();
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_sql'] as $cmp => $resto)
           {
           ...
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_select']['jogos.data_jogo'] = 'desc'; 
           } 
           $Free_sql_atual = array();
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_sql'] as $cmp => $resto)
           {
           ...
           if (!isset($Free_sql_atual['apostas.login_id']))
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_select']['apostas.login_id'] = 'asc'; 
           } 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   $this->arg_sum_jogos_competicao_id = "";
   $this->count_jogos_competicao_id = 0;
   $this->arg_sum_apostas_login_id = "";
   $this->count_apostas_login_id = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_desc'] . "," .  $campos_order; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->apostas_aposta_id = $this->rs_grid->fields[0] ;  
       $this->apostas_aposta_id = (string)$this->apostas_aposta_id;
       $this->apostas_dt_hr_aposta = $this->rs_grid->fields[1] ;  
       $this->jogos_rodada = $this->rs_grid->fields[2] ;  
       $this->jogos_rodada = (string)$this->jogos_rodada;
       $this->jogos_data_jogo = $this->rs_grid->fields[3] ;  
       $this->jogos_horario = $this->rs_grid->fields[4] ;  
       $this->jogos_time_casa_id = $this->rs_grid->fields[5] ;  
       $this->jogos_time_casa_id = (string)$this->jogos_time_casa_id;
       $this->apostas_time_casa_placar = $this->rs_grid->fields[6] ;  
       $this->apostas_time_casa_placar = (string)$this->apostas_time_casa_placar;
       $this->apostas_time_visitante_placar = $this->rs_grid->fields[7] ;  
       $this->apostas_time_visitante_placar = (string)$this->apostas_time_visitante_placar;
       $this->jogos_time_visitante_id = $this->rs_grid->fields[8] ;  
       $this->jogos_time_visitante_id = (string)$this->jogos_time_visitante_id;
       $this->apostas_pontos = $this->rs_grid->fields[9] ;  
       $this->apostas_pontos = (string)$this->apostas_pontos;
       $this->apostas_login_id = $this->rs_grid->fields[10] ;  
       $this->jogos_competicao_id = $this->rs_grid->fields[11] ;  
       $this->jogos_competicao_id = (string)$this->jogos_competicao_id;
       if (!isset($this->jogos_competicao_id)) { $this->jogos_competicao_id = ""; }
       if (!isset($this->apostas_login_id)) { $this->apostas_login_id = ""; }
       $GLOBALS["jogos_time_casa_id"] = $this->rs_grid->fields[5] ;  
       $GLOBALS["jogos_time_casa_id"] = (string)$GLOBALS["jogos_time_casa_id"] ;
       $GLOBALS["jogos_time_visitante_id"] = $this->rs_grid->fields[8] ;  
       $GLOBALS["jogos_time_visitante_id"] = (string)$GLOBALS["jogos_time_visitante_id"] ;
       $GLOBALS["jogos_competicao_id"] = $this->rs_grid->fields[11] ;  
       $GLOBALS["jogos_competicao_id"] = (string)$GLOBALS["jogos_competicao_id"] ;
       $this->arg_sum_apostas_login_id = " = " . $this->Db->qstr($this->apostas_login_id);
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               cons_apostas_geral_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               cons_apostas_geral_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               cons_apostas_geral_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               cons_apostas_geral_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               cons_apostas_geral_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>APOSTAS</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"cons_apostas_geral_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"cons_apostas_geral_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"cons_apostas_geral_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-cons_apostas_geral-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-cons_apostas_geral-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-cons_apostas_geral-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-8b04042a\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_cons_apostas_geral_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_cons_apostas_geral_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_cons_apostas_geral_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "cons_apostas_geral/cons_apostas_geral_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".cons_apostas_geral_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
                   $groupByLabel = sprintf("Competição", "jogos.competicao_id");
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['cons_apostas_geral']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['cons_apostas_geral']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['cons_apostas_geral']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['cons_apostas_geral']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida']) ? "cons_apostas_geral_" : "";
   $this->css_sep = " ";
   $this->css_apostas_aposta_id_label = $compl_css_emb . "css_apostas_aposta_id_label";
   $this->css_apostas_aposta_id_grid_line = $compl_css_emb . "css_apostas_aposta_id_grid_line";
   $this->css_apostas_dt_hr_aposta_label = $compl_css_emb . "css_apostas_dt_hr_aposta_label";
   $this->css_apostas_dt_hr_aposta_grid_line = $compl_css_emb . "css_apostas_dt_hr_aposta_grid_line";
   ...
   $this->css_jogos_horario_label = $compl_css_emb . "css_jogos_horario_label";
   $this->css_jogos_horario_grid_line = $compl_css_emb . "css_jogos_horario_grid_line";
   ...
   $this->css_sit_aposta_label = $compl_css_emb . "css_sit_aposta_label";
   $this->css_sit_aposta_grid_line = $compl_css_emb . "css_sit_aposta_grid_line";
 }  
 function cabecalho()
 {
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">APOSTAS</div>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_cons_apostas_geral__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-cons_apostas_geral-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_sit_aposta_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_sit_aposta_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".cons_apostas_geral_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
 ...
 function NM_label_apostas_aposta_id()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['apostas_aposta_id'])) ? $this->New_label['apostas_aposta_id'] : "Aposta Id";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
     $classColTitle = " sc-col-title";
   }
   if (!isset($this->NM_cmp_hidden['apostas_aposta_id']) || $this->NM_cmp_hidden['apostas_aposta_id'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_apostas_aposta_id_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_apostas_aposta_id_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
        $NM_cmp_class = "apostas_aposta_id";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "apostas.aposta_id";
        }
 ...
 function NM_label_apostas_dt_hr_aposta()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['apostas_dt_hr_aposta']) || $this->NM_cmp_hidden['apostas_dt_hr_aposta'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_apostas_dt_hr_aposta_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_apostas_dt_hr_aposta_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $NM_cmp_class = "apostas_dt_hr_aposta";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "apostas.dt_hr_aposta";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "apostas.dt_hr_aposta";
        }
 ...
 function NM_label_jogos_horario()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['jogos_horario']) || $this->NM_cmp_hidden['jogos_horario'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_jogos_horario_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_jogos_horario_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $NM_cmp_class = "jogos_horario";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "jogos.horario";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "jogos.horario";
        }
 ...
 function NM_label_sit_aposta()
 {
   ...
   if (!isset($this->NM_cmp_hidden['sit_aposta']) || $this->NM_cmp_hidden['sit_aposta'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_sit_aposta_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_sit_aposta_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = 'left';
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['apostas_aposta_id'])) ? $this->New_label['apostas_aposta_id'] : "Aposta Id";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['apostas_aposta_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['apostas_dt_hr_aposta'])) ? $this->New_label['apostas_dt_hr_aposta'] : "Data / Hora Aposta";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['apostas_dt_hr_aposta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['jogos_rodada'])) ? $this->New_label['jogos_rodada'] : "Rodada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['jogos_rodada'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['jogos_data_jogo'])) ? $this->New_label['jogos_data_jogo'] : "Data Jogo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['jogos_data_jogo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['jogos_horario'])) ? $this->New_label['jogos_horario'] : "Horário";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['jogos_horario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['jogos_time_casa_id'])) ? $this->New_label['jogos_time_casa_id'] : "Time Casa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['jogos_time_casa_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['apostas_time_casa_placar'])) ? $this->New_label['apostas_time_casa_placar'] : "Placar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['apostas_time_casa_placar'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['x'])) ? $this->New_label['x'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['x'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['apostas_time_visitante_placar'])) ? $this->New_label['apostas_time_visitante_placar'] : "Placar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['apostas_time_visitante_placar'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['jogos_time_visitante_id'])) ? $this->New_label['jogos_time_visitante_id'] : "Time Visitante";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['jogos_time_visitante_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['apostas_pontos'])) ? $this->New_label['apostas_pontos'] : "Pontos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['apostas_pontos'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['sit_aposta'])) ? $this->New_label['sit_aposta'] : "Situação";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['labels']['sit_aposta'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['cons_apostas_geral']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_cons_apostas_geral#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['force_toolbar'] = true;
           } 
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_cons_apostas_geral#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-8b04042a\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['sc_free_group_by']['jogos_competicao_id'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['jogos_competicao_id'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['apostas_login_id'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['apostas_login_id'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   $this->SC_top[]     = "jogos_competicao_id"; 
   $this->SC_top[]     = "apostas_login_id"; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final'] == 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       $Nivel_gb = 1;
       $this->Tab_Nv_tree = array();
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp']);
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  cons_apostas_geral_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_jogos_competicao_id = ($this->jogos_competicao_id == "") ? " is null " : " = " . $this->jogos_competicao_id;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final'] + 1; 
          if (!$ini_grid) {
          ...
          {  
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby']][$cmp] == "S" && $Qb_page)
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Page_break_PDF'][$cmp] == "S" && $Qb_page)
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  $Qb_page = false;
...
$_SESSION['scriptcase']['cons_apostas_geral']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_sit_aposta_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"  >&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_sit_aposta_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\" >\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
 ...
 function NM_grid_apostas_aposta_id()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['apostas_aposta_id']) || $this->NM_cmp_hidden['apostas_aposta_id'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->apostas_aposta_id)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->apostas_aposta_id)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'apostas_aposta_id', $str_tem_display, $conteudo_original); 
          } 
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_apostas_aposta_id_grid_line . "\"  style=\"" . $this->Css_Cmp['css_apostas_aposta_id_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_apostas_aposta_id_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_apostas_dt_hr_aposta()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['apostas_dt_hr_aposta']) || $this->NM_cmp_hidden['apostas_dt_hr_aposta'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->apostas_dt_hr_aposta)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->apostas_dt_hr_aposta)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'apostas_dt_hr_aposta', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_apostas_dt_hr_aposta_grid_line . "\"  style=\"" . $this->Css_Cmp['css_apostas_dt_hr_aposta_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_apostas_dt_hr_aposta_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_jogos_rodada()
 {
      ...
      if (!isset($this->NM_cmp_hidden['jogos_rodada']) || $this->NM_cmp_hidden['jogos_rodada'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'jogos_rodada', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
 ...
 function NM_grid_jogos_data_jogo()
 {
      ...
      if (!isset($this->NM_cmp_hidden['jogos_data_jogo']) || $this->NM_cmp_hidden['jogos_data_jogo'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'jogos_data_jogo', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
 ...
 function NM_grid_jogos_horario()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['jogos_horario']) || $this->NM_cmp_hidden['jogos_horario'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->jogos_horario)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->jogos_horario)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'jogos_horario', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_jogos_horario_grid_line . "\"  style=\"" . $this->Css_Cmp['css_jogos_horario_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_jogos_horario_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_jogos_time_casa_id()
 {
      ...
      if (!isset($this->NM_cmp_hidden['jogos_time_casa_id']) || $this->NM_cmp_hidden['jogos_time_casa_id'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'jogos_time_casa_id', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
 ...
 function NM_grid_apostas_time_casa_placar()
 {
      ...
      if (!isset($this->NM_cmp_hidden['apostas_time_casa_placar']) || $this->NM_cmp_hidden['apostas_time_casa_placar'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'apostas_time_casa_placar', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
 ...
 function NM_grid_apostas_time_visitante_placar()
 {
      ...
      if (!isset($this->NM_cmp_hidden['apostas_time_visitante_placar']) || $this->NM_cmp_hidden['apostas_time_visitante_placar'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'apostas_time_visitante_placar', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
 ...
 function NM_grid_jogos_time_visitante_id()
 {
      ...
      if (!isset($this->NM_cmp_hidden['jogos_time_visitante_id']) || $this->NM_cmp_hidden['jogos_time_visitante_id'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'jogos_time_visitante_id', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
 ...
 function NM_grid_apostas_pontos()
 {
      ...
      if (!isset($this->NM_cmp_hidden['apostas_pontos']) || $this->NM_cmp_hidden['apostas_pontos'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'apostas_pontos', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
 ...
 function NM_grid_sit_aposta()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['sit_aposta']) || $this->NM_cmp_hidden['sit_aposta'] != "off") { 
          $conteudo = sc_strip_script($this->sit_aposta); 
          $conteudo_original = sc_strip_script($this->sit_aposta); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'sit_aposta', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != 'pdf') {
              ...
              $Style_txt_sit_aposta = "";
          if (isset($this->NM_field_color["sit_aposta"]) && !empty($this->NM_field_color["sit_aposta"]))
          {
              $Style_txt_sit_aposta .= "color: " . $this->NM_field_color["sit_aposta"] . ";";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'])
          {
              $this->SC_nowrap = "NOWRAP";
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_sit_aposta_grid_line . "\"  style=\"" . $this->Css_Cmp['css_sit_aposta_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  ><span style=\"" . $Style_txt_sit_aposta . "\" id=\"id_sc_field_sit_aposta_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_apostas_login_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global $$Var_name_gb, $Desc_Gb_Ant;
   $this->sc_proc_quebra_jogos_competicao_id = false;
   $this->sc_proc_quebra_apostas_login_id = true; 
   $this->Tot->quebra_apostas_login_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_apostas_login_id = $$Var_name_gb;
   $conteudo = $tot_apostas_login_id[0] ;  
   $this->count_apostas_login_id = $tot_apostas_login_id[1];
   $Temp_cmp_quebra = array(); 
   $conteudo = sc_strip_script($this->apostas_login_id); 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['apostas_login_id']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['apostas_login_id']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "Apostador"; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_apostas_login_id = false; 
 } 
 function quebra_jogos_competicao_id_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $tot_jogos_competicao_id = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp']) > 1) ? 5 * $this->Tab_Nv_tree['jogos_competicao_id'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_jogos_competicao_id = 0; 
   $cont_quebra_jogos_competicao_id++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['rows_emb']++;
   ...
   if ($this->SC_sep_quebra)
   {
       $this->SC_sep_quebra = false;
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['proc_pdf_vert']) { 
             ...
             $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['rows_emb']++;
   $nm_saida->saida("<tr>\r\n");
   $nm_saida->saida("<td class=\"" . $this->css_scGridBlockSpaceBg . "\" style=\"height: 1px;\" colspan=\"" . $this->NM_colspan . "\">&nbsp;</td>\r\n");
   $nm_saida->saida("</tr>\r\n");
         }
   }
   $colspan = $this->NM_colspan;
   $this->Label_jogos_competicao_id = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_jogos_competicao_id .= "<tr>"; 
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
       {
           $this->Label_jogos_competicao_id .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_jogos_competicao_id .= "<td>" . $cada_campo['lab'] . "</td><td> -</td>";
       $this->Label_jogos_competicao_id .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_jogos_competicao_id .= "</tr>"; 
   } 
   $this->Label_jogos_competicao_id .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\" NOWRAP " . "colspan=\"" . $colspan . "\"" . ">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_jogos_competicao_id . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_apostas_login_id_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_apostas_login_id = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['SC_Gb_Free_cmp']) > 1) ? 5 * $this->Tab_Nv_tree['apostas_login_id'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_apostas_login_id = 0; 
   $cont_quebra_apostas_login_id++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['rows_emb']++;
   ...
   $colspan = $this->NM_colspan;
   $this->Label_apostas_login_id = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_apostas_login_id .= "<tr>"; 
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'])
       {
           $this->Label_apostas_login_id .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_apostas_login_id .= "<td>" . $cada_campo['lab'] . "</td><td> -</td>";
       $this->Label_apostas_login_id .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_apostas_login_id .= "</tr>"; 
   } 
   $this->Label_apostas_login_id .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . ">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_apostas_login_id . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] == 50) ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] == 100) ? " selected" : "";
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['nav']))
          {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
          ...
          if (is_file("cons_apostas_geral_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("cons_apostas_geral_help.txt"); 
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_modal'])
        {
      ...
      $nm_saida->saida("        </tr> \r\n");
      $nm_saida->saida("       </table> \r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ajax_nav'] && $this->force_toolbar)
      { 
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "apostas_login_id")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "apostas_login_id";
                           $lin_obj = $this->grid_search_apostas_login_id($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
     ...
     { 
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('apostas_login_id');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq']) < 1)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_apostas_login_id($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_apostas_login_id_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_apostas_login_id_cond_" . $ind . "' name='cond_grid_search_apostas_login_id_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       $lin_obj .= "       <span id=\"grid_apostas_login_id_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['psq_check_ret']['apostas_login_id'] = array();
       $apostas_login_id_look = substr($this->Db->qstr($apostas_login_id), 1, -1); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "--Selecione--?#??#?N?@?"; 
       $nm_comando = "SELECT participantes_bolao  FROM relacs_bolao_usuar WHERE relacs_bolao_usuar.bolao_id = " . $_SESSION['id_bolao'] . " ORDER BY participantes_bolao"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['psq_check_ret']['apostas_login_id'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_apostas_login_id_val_" . $ind . "\" name=\"val_grid_search_apostas_login_id_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       ...
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $apostas_login_id_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $apostas_login_id_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "exercicios/cons_apostas_geral";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'apostas_login_id')\r\n");
       $nm_saida->saida("                 {\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ]))) == 0)
                    {
                        $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campos_busca'][ $field ]));
                    }
                }
            }
        }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array(''))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('cons_apostas_geral', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"cons_apostas_geral\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"cons_apostas_geral_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "cons_apostas_geral/cons_apostas_geral_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"cons_apostas_geral_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['cons_apostas_geral_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@cons_apostas_geral@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           document.Fexport.action = \"cons_apostas_geral_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['cons_apostas_geral']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"cons_apostas_geral_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_apostas_geral']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('cons_apostas_geral')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('cons_apostas_geral', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }

 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_apostas_login_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['apostas_login_id'])) ? $this->New_label['apostas_login_id'] : "Apostador"; ?></TD>
     ...
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_apostas_login_id" <?php echo $str_hide_apostas_login_id?> valign="top">

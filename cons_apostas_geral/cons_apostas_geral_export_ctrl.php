<?php
@session_start() ;
$_SESSION['scriptcase']['cons_apostas_geral']['sc_process_barr'] = true;
require_once('../cons_apostas_geral/index.php');
unset($_SESSION['scriptcase']['cons_apostas_geral']['sc_process_barr']);
$ExportCtrl = new cons_apostas_geral_export_control;
$ExportCtrl->Export_barr();

class cons_apostas_geral_export_control
{

...
class cons_aposta_jogo_corrente_csv
{
   var $Db;
   var $Erro;
   var $Ini;
...
$_SESSION['scriptcase']['cons_aposta_jogo_corrente']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          require_once($this->Ini->path_aplicacao . "cons_aposta_jogo_corrente_res_csv.class.php");
          $this->Res = new cons_aposta_jogo_corrente_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['cons_aposta_jogo_corrente']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['cons_aposta_jogo_corrente']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cons_aposta_jogo_corrente']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['cons_aposta_jogo_corrente']['csv_res_file']);
          }
          unlink($Arq_input);

<?php
@session_start() ;
$_SESSION['scriptcase']['cons_aposta_jogo_corrente']['sc_process_barr'] = true;
require_once('../cons_aposta_jogo_corrente/index.php');
unset($_SESSION['scriptcase']['cons_aposta_jogo_corrente']['sc_process_barr']);
$ExportCtrl = new cons_aposta_jogo_corrente_export_control;
$ExportCtrl->Export_barr();

class cons_aposta_jogo_corrente_export_control
{

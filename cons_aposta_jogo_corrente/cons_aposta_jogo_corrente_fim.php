...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["exercicios_____cons_aposta_jogo_corrente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["exercicios_____cons_aposta_jogo_corrente"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_aposta_jogo_corrente'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_aposta_jogo_corrente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cons_aposta_jogo_corrente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cons_aposta_jogo_corrente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cons_aposta_jogo_corrente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cons_aposta_jogo_corrente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>cons_aposta_jogo_corrente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cons_aposta_jogo_corrente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cons_aposta_jogo_corrente']['embutida_filho'] as $ind => $sc_init)
          {

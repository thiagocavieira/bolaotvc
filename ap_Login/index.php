...
//
   if (!session_id())
   {
   include_once('ap_Login_session.php');
   ...
   $_SESSION['scriptcase']['ap_Login']['glo_nm_perfil']          = "bolaotvc";
   $_SESSION['scriptcase']['ap_Login']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['ap_Login']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['ap_Login']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['ap_Login']['glo_nm_path_cache']  = "";
   $_SESSION['scriptcase']['ap_Login']['glo_nm_path_doc']        = "";
   $NM_dir_atual = getcwd();
   ...
   //check prod
   if(empty($_SESSION['scriptcase']['ap_Login']['glo_nm_path_prod']))
   {
           /*check prod*/$_SESSION['scriptcase']['ap_Login']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
   }
   //check img
   if(empty($_SESSION['scriptcase']['ap_Login']['glo_nm_path_imagens']))
   {
           /*check img*/$_SESSION['scriptcase']['ap_Login']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
   }
   //check tmp
   if(empty($_SESSION['scriptcase']['ap_Login']['glo_nm_path_imag_temp']))
   {
           /*check tmp*/$_SESSION['scriptcase']['ap_Login']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   //check cache
   if(empty($_SESSION['scriptcase']['ap_Login']['glo_nm_path_cache']))
   {
           /*check cache*/$_SESSION['scriptcase']['ap_Login']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
   }
   //check doc
   if(empty($_SESSION['scriptcase']['ap_Login']['glo_nm_path_doc']))
   {
           /*check doc*/$_SESSION['scriptcase']['ap_Login']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
   }
...
// 
      ...
      $this->path_prod       = $_SESSION['scriptcase']['ap_Login']['glo_nm_path_prod'];
      $this->path_imagens    = $_SESSION['scriptcase']['ap_Login']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['ap_Login']['glo_nm_path_imag_temp'];
      $this->path_cache      = $_SESSION['scriptcase']['ap_Login']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['ap_Login']['glo_nm_path_doc'];
      ...
      if (isset($_SESSION['scriptcase']['ap_Login']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['ap_Login']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['ap_Login']['actual_lang']) || $_SESSION['scriptcase']['ap_Login']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['ap_Login']['actual_lang'] = $this->str_lang;
          setcookie('sc_actual_lang_exercicios',$this->str_lang,'0','/');
      }
      global $inicial_ap_Login;
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_flag) && $inicial_ap_Login->contr_ap_Login->NM_ajax_flag)
                  {
                      $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['action']  = $nm_apl_dest;
                      $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['target']  = $parms['T'];
                      $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['metodo']  = "post";
                      $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
                      ap_Login_pack_ajax_response();
                      exit;
                  }
?>
                  <html>
...
<?php
      ...
      if (isset($_SESSION['scriptcase']['ap_Login']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['ap_Login']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['ap_Login']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['ap_Login']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['ap_Login']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['ap_Login']['session_timeout']);
      ...
      {
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['action']  = "./";
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['target']  = "_self";
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['metodo']  = "post";
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
          ap_Login_pack_ajax_response();
          exit;
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['ap_Login']['session_timeout']['redir']))
      {
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['ap_Login']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan']) || $_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan'] != 'ap_Login')) 
          { 
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $this->link_ap_Login_inline = $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('ap_Login') . "/ap_Login_inline.php";
      if ($_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['ap_Login']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["ap_Login"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["ap_Login"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
...
// 
      ...
      if(function_exists('set_php_timezone'))  set_php_timezone('ap_Login'); 
      ...
      global $inicial_ap_Login, $NM_run_iframe;
      if ((isset($inicial_ap_Login->contr_ap_Login->NM_ajax_flag) && $inicial_ap_Login->contr_ap_Login->NM_ajax_flag) || (isset($_SESSION['sc_session'][$this->sc_page]['ap_Login']['embutida_call']) && $_SESSION['sc_session'][$this->sc_page]['ap_Login']['embutida_call']) || $NM_run_iframe == 1)
      {
           $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['ap_Login']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['ap_Login']['initialize'])  
      { 
          $this->conectDB();
      }
   }
   ...
   function init2()
   {
      if (isset($_SESSION['sc_session'][$this->sc_page]['ap_Login']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['ap_Login']['initialize'])  
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['initialize'] = false;
          $this->Db->Close(); 
      } 
      $this->conectDB();
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['ap_Login']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao']) && $_SESSION['scriptcase']['ap_Login']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['ap_Login']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['ap_Login']['glo_nm_perfil']) && $_SESSION['scriptcase']['ap_Login']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['ap_Login']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['ap_Login']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['ap_Login']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['ap_Login']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['ap_Login']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['ap_Login']['glo_nm_perfil'];
      }
...
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['ap_Login']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['ap_Login']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['ap_Login']['sc_outra_jan'] != 'ap_Login')) 
          { 
              if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno'])) 
              { 
?>
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'exercicios', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['ap_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'exercicios', 1, $this->force_db_utf8);
    }
    else {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['ap_Login']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['ap_Login']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['ap_Login']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['ap_Login']['SC_sep_date1'];
           }
...
function fb_return()
{
$_SESSION['scriptcase']['ap_Login']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['ap_Login']['contr_erro'] = 'off';
}
...
class ap_Login_edit
{
    ...
    function inicializa()
    {
        ...
        require_once("ap_Login_apl.php");
        $this->contr_ap_Login = new ap_Login_apl();
    }
}
...
//
    ...
    if (!empty($_POST))
    {
        foreach ($_POST as $nmgp_var => $nmgp_val)
        {
             ...
             nm_limpa_str_ap_Login($nmgp_val);
    ...
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['where_filter'] = $SC_where_pdf;
    }

    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['ap_Login']['session_timeout']['redir']))
    {
        if ('ajax_ap_Login_validate_login' == $_POST['rs'])
        {
            $login = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_ap_Login_validate_pswd' == $_POST['rs'])
        {
            $pswd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_ap_Login_validate_remember_me' == $_POST['rs'])
        {
            $remember_me = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_ap_Login_validate_new_user' == $_POST['rs'])
        {
            $new_user = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_ap_Login_validate_retrieve_pswd' == $_POST['rs'])
        {
            $retrieve_pswd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_ap_Login_submit_form' == $_POST['rs'])
        {
            $login = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_ap_Login_navigate_form' == $_POST['rs'])
        {
    ...
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['lig_edit_lookup']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['lig_edit_lookup']     = false;
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['lig_edit_lookup_cb']  = '';
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['lig_edit_lookup_row'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_call']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_call'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_proc']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_proc'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_insert']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_insert'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_update']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_update'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_delete']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_delete'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_btn_nav']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_form_btn_nav'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_grid_edit']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_grid_edit'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_grid_edit_link']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_grid_edit_link'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_qtd_reg']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_qtd_reg'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_tp_pag']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_liga_tp_pag'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['run_modal']))
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_modal'] = isset($_GET['nmgp_url_saida']) && 'modal' == $_GET['nmgp_url_saida'];
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_proc'])
    {
        return;
    }
    if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_parms']))
    { 
        $tmp_nmgp_parms = '';
        ...
        $nmgp_parms = $tmp_nmgp_parms . $_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_parms'];
        unset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_parms']);
    } 
    ...
    { 
        ...
        while (!empty($todo[$ix]))
        {
           ...
           if (1 < sizeof($cadapar))
           {
               ...
               nm_limpa_str_ap_Login($cadapar[1]);
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['parms']))
    {
        if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
        {
            $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['ap_Login']['parms']);
            $todo  = explode("?@?", $todox);
            $ix = 0;
            while (!empty($todo[$ix]))
            {
    ...
    $salva_run = "N";
    $salva_iframe = false;
    if (isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['iframe_menu']))
    {
        $salva_iframe = $_SESSION['sc_session'][$script_case_init]['ap_Login']['iframe_menu'];
        unset($_SESSION['sc_session'][$script_case_init]['ap_Login']['iframe_menu']);
    }
    if (isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe']))
    {
        $salva_run = $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'];
        unset($_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe']);
    }
    if (isset($nm_run_menu) && $nm_run_menu == 1)
    {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "ap_Login";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'ap_Login' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['iframe_menu']  = true;
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['mostra_cab']   = "S";
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe']   = "N";
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['retorno_edit'] = "";
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe']  = $salva_run;
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['iframe_menu'] = $salva_iframe;
    }

    if (!isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['db_changed']))
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['db_changed'] = false;
    }
    ...
    if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'ap_Login')
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan'] = true;
    ...
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        ...
        {
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_modal'] = true;
            $nm_url_saida = "ap_Login_fim.php"; 
        }
        $nm_apl_dependente = 0;
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan'] = true;
    }
    ...
    if (!isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['initialize']))
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['initialize'] = true;
    }
    elseif (!isset($_SERVER['HTTP_REFERER']))
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['initialize'] = false;
    }
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['first_time']))
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['first_time'] = false;
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['first_time'] = true;
    }

    $_SESSION['sc_session'][$script_case_init]['ap_Login']['menu_desenv'] = false;   
    if (!defined("SC_ERROR_HANDLER"))
    {
        define("SC_ERROR_HANDLER", 1);
    }
    include_once(dirname(__FILE__) . "/ap_Login_erro.php");
    ...
    else
    {
        if (!empty($nmgp_opcao))  
        {
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['opcao'] = $nmgp_opcao ; 
        }
        if (isset($_POST["facebook_error_code"])) 
        {
            $_SESSION['facebook_error_code'] = $_POST["facebook_error_code"];
            nm_limpa_str_ap_Login($_SESSION['facebook_error_code']);
        }
        ...
        if (isset($_POST["facebook_error_msg"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['facebook_error_msg']);
        }
        ...
        if (isset($_POST["facebook_user"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['facebook_user']);
        }
        ...
        if (isset($_POST["facebook_email"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['facebook_email']);
        }
        ...
        if (isset($_POST["facebook_name"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['facebook_name']);
        }
        ...
        if (isset($_POST["google_error_code"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['google_error_code']);
        }
        ...
        if (isset($_POST["google_error_msg"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['google_error_msg']);
        }
        ...
        if (isset($_POST["google_user"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['google_user']);
        }
        ...
        if (isset($_POST["google_email"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['google_email']);
        }
        ...
        if (isset($_POST["google_name"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['google_name']);
        }
        ...
        if (isset($_POST["logged_date_login"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['logged_date_login']);
        }
        ...
        if (isset($_POST["usr_login"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['usr_login']);
        }
        ...
        if (isset($_POST["usr_email"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['usr_email']);
        }
        ...
        if (isset($_POST["sett_remember_me"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['sett_remember_me']);
        }
        ...
        if (isset($_POST["sett_new_users"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['sett_new_users']);
        }
        ...
        if (isset($_POST["sett_retrieve_password"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['sett_retrieve_password']);
        }
        ...
        if (isset($_POST["sett_brute_force"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['sett_brute_force']);
        }
        ...
        if (isset($_POST["usr_priv_admin"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['usr_priv_admin']);
        }
        ...
        if (isset($_POST["usr_name"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['usr_name']);
        }
        ...
        if (isset($_POST["remember_me"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['remember_me']);
        }
        ...
        if (isset($_POST["sett_enable_2fa"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['sett_enable_2fa']);
        }
        ...
        if (isset($_POST["sett_cookie_expiration_time"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['sett_cookie_expiration_time']);
        }
        ...
        if (isset($_POST["twitter_user"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['twitter_user']);
        }
        ...
        if (isset($_POST["twitter_email"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['twitter_email']);
        }
        ...
        if (isset($_POST["twitter_name"])) 
        {
            ...
            nm_limpa_str_ap_Login($_SESSION['twitter_name']);
        }
        ...
        if (!empty($_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_redirect_apl']))
        {
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_redirect_apl']; 
            $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_redirect_tp']; 
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_redirect_apl'] = "";
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_redirect_tp'] = "";
            $nm_url_saida = "ap_Login_fim.php"; 
        }
        elseif (isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan'] == 'true')
        {
               $nm_url_saida = "ap_Login_fim.php"; 
        }
        elseif ($_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "R")
        {
           $nm_url_saida = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : ""; 
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            $nm_saida_global = $nm_url_saida;
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['ap_Login']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['ap_Login']['retorno_edit'] = $nmgp_url_saida ; 
            } 
            if (!empty($_SESSION['sc_session'][$script_case_init]['ap_Login']['retorno_edit'])) 
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['ap_Login']['retorno_edit'] . "?script_case_init=" . $script_case_init;  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
            ...
            if ($_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "R" && (!isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_call']) || !$_SESSION['sc_session'][$script_case_init]['ap_Login']['embutida_call']))
            { 
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "R")
        {
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_php'] = $nm_url_saida;
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_apl'] = $nm_saida_global;
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_ss']  = (isset($_SESSION['scriptcase']['sc_url_saida'][$script_case_init])) ? $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] : "";
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_dep'] = $nm_apl_dependente;
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_tp']  = (isset($_SESSION['scriptcase']['sc_tp_saida'])) ? $_SESSION['scriptcase']['sc_tp_saida'] : "";
        }
        $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_php'];
        $nm_saida_global = $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_php'];
        $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_dep'];
        if ($_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "R" && !empty($_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_ss'])) 
        { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_ss'];
            $_SESSION['scriptcase']['sc_tp_saida']  = $_SESSION['sc_session'][$script_case_init]['ap_Login']['volta_tp'];
        } 
        if ($_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] == "F" || $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] == "R") 
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['ap_Login']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['ap_Login']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init; 
            } 
        } 
        if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['ap_Login']['run_iframe'] != "R") 
        { 
            $_SESSION['sc_session'][$script_case_init]['ap_Login']['menu_desenv'] = true;   
        } 
    }
    if (isset($nmgp_redir)) 
    { 
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['redir'] = $nmgp_redir;   
    } 
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        $_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan'] = true;
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['ap_Login']['sc_outra_jan'])
    {
        $nm_apl_dependente = 0;
    }
    $GLOBALS["NM_ERRO_IBASE"] = 0;  
    $inicial_ap_Login = new ap_Login_edit();
    $inicial_ap_Login->inicializa();

    $inicial_ap_Login->contr_ap_Login->NM_ajax_info['select_html'] = array();
    $inicial_ap_Login->contr_ap_Login->NM_ajax_info['select_html']['remember_me'] = " onClick=\"\" ";

    if (!defined('SC_SAJAX_LOADED'))
    {
        include_once(dirname(__FILE__) . '/ap_Login_sajax.php');
        define('SC_SAJAX_LOADED', 'YES');
    }
    if (!class_exists('Services_JSON'))
    {
        include_once(dirname(__FILE__) . '/ap_Login_json.php');
    }
    $sajax_request_type = "POST";
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_ap_Login_validate_login");
    sajax_export("ajax_ap_Login_validate_pswd");
    sajax_export("ajax_ap_Login_validate_remember_me");
    sajax_export("ajax_ap_Login_validate_new_user");
    sajax_export("ajax_ap_Login_validate_retrieve_pswd");
    sajax_export("ajax_ap_Login_submit_form");
    sajax_export("ajax_ap_Login_navigate_form");
    sajax_handle_client_request();

    if (isset($_POST['wizard_action']) && 'change_step' == $_POST['wizard_action']) {
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['buffer_output'] = true;
        ob_start();
    }

    $inicial_ap_Login->contr_ap_Login->controle();
//
    function nm_limpa_str_ap_Login(&$str)
    {
    ...
    function ajax_ap_Login_validate_login($login, $script_case_init)
    {
        global $inicial_ap_Login;
        //register_shutdown_function("ap_Login_pack_ajax_response");
        $inicial_ap_Login->contr_ap_Login->NM_ajax_flag          = true;
        $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao         = 'validate_login';
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param'] = array(
                  'login' => NM_utf8_urldecode($login),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['buffer_output'])
        {
            ob_start();
        }
        $inicial_ap_Login->contr_ap_Login->controle();
    ...
    function ajax_ap_Login_validate_pswd($pswd, $script_case_init)
    {
        global $inicial_ap_Login;
        //register_shutdown_function("ap_Login_pack_ajax_response");
        $inicial_ap_Login->contr_ap_Login->NM_ajax_flag          = true;
        $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao         = 'validate_pswd';
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_ap_Login_validate_remember_me($remember_me, $script_case_init)
    {
        global $inicial_ap_Login;
        //register_shutdown_function("ap_Login_pack_ajax_response");
        $inicial_ap_Login->contr_ap_Login->NM_ajax_flag          = true;
        $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao         = 'validate_remember_me';
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_ap_Login_validate_new_user($new_user, $script_case_init)
    {
        global $inicial_ap_Login;
        //register_shutdown_function("ap_Login_pack_ajax_response");
        $inicial_ap_Login->contr_ap_Login->NM_ajax_flag          = true;
        $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao         = 'validate_new_user';
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_ap_Login_validate_retrieve_pswd($retrieve_pswd, $script_case_init)
    {
        global $inicial_ap_Login;
        //register_shutdown_function("ap_Login_pack_ajax_response");
        $inicial_ap_Login->contr_ap_Login->NM_ajax_flag          = true;
        $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao         = 'validate_retrieve_pswd';
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_ap_Login_submit_form($login, $pswd, $remember_me, $new_user, $retrieve_pswd, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_ap_Login;
        //register_shutdown_function("ap_Login_pack_ajax_response");
        $inicial_ap_Login->contr_ap_Login->NM_ajax_flag          = true;
        $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao         = 'submit_form';
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param'] = array(
                  'login' => NM_utf8_urldecode($login),
                  'pswd' => NM_utf8_urldecode($pswd),
                  'remember_me' => NM_utf8_urldecode($remember_me),
    ...
    function ajax_ap_Login_navigate_form($nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_ap_Login;
        //register_shutdown_function("ap_Login_pack_ajax_response");
        $inicial_ap_Login->contr_ap_Login->NM_ajax_flag          = true;
        $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao         = 'navigate_form';
        $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param'] = array(
                  'nm_form_submit' => NM_utf8_urldecode($nm_form_submit),
                  'nmgp_opcao' => NM_utf8_urldecode($nmgp_opcao),
   ...
   function ap_Login_pack_ajax_response()
   {
      global $inicial_ap_Login;
      $aResp = array();

      if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['wizard']))
      {
          $aResp['wizard'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['wizard'];
      }
      if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['empty_filter']))
      {
          $aResp['empty_filter'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['empty_filter'];
      }
      if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['dyn_search']['NM_Dynamic_Search']))
      {
          $aResp['dyn_search']['NM_Dynamic_Search'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['dyn_search']['NM_Dynamic_Search'];
      }
      if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str']))
      {
          $aResp['dyn_search']['id_dyn_search_cmd_str'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str'];
      }
      if ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['calendarReload'])
      {
         $aResp['result'] = 'CALENDARRELOAD';
      }
      elseif ('' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['autoComp'])
      {
         $aResp['result'] = 'AUTOCOMP';
      }
//mestre_detalhe
      elseif (!empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['newline']))
      {
         $aResp['result'] = 'NEWLINE';
         ob_end_clean();
      }
      elseif (!empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['tableRefresh']))
      {
         $aResp['result'] = 'TABLEREFRESH';
      }
//-----
      elseif (!empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['errList']))
      {
         $aResp['result'] = 'ERROR';
      }
      elseif (!empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fldList']))
      {
         $aResp['result'] = 'SET';
      }
      else
      ...
      {
         $aResp = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['autoComp'];
      }
//mestre_detalhe
      elseif ('NEWLINE' == $aResp['result'])
      {
         $aResp = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['newline'];
      }
      else
//-----
      {
         $aResp['ajaxRequest'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_opcao;
         if ('CALENDARRELOAD' == $aResp['result'])
         {
            ap_Login_pack_calendar_reload($aResp);
         }
         elseif ('ERROR' == $aResp['result'])
         {
            ap_Login_pack_ajax_errors($aResp);
         }
         elseif ('SET' == $aResp['result'])
         {
            ap_Login_pack_ajax_set_fields($aResp);
         }
         elseif ('TABLEREFRESH' == $aResp['result'])
         {
            ap_Login_pack_ajax_set_fields($aResp);
            $aResp['tableRefresh'] = ap_Login_pack_protect_string($inicial_ap_Login->contr_ap_Login->NM_ajax_info['tableRefresh']);
         }
         if ('OK' == $aResp['result'] || 'SET' == $aResp['result'])
         {
            ap_Login_pack_ajax_ok($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['focus']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['focus'])
         {
            $aResp['setFocus'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['focus'];
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['closeLine']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['closeLine'])
         {
            $aResp['closeLine'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['closeLine'];
         }
         else
         {
            $aResp['closeLine'] = 'N';
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['clearUpload']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['clearUpload'])
         {
            $aResp['clearUpload'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['clearUpload'];
         }
         else
         {
            $aResp['clearUpload'] = 'N';
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnDisabled']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnDisabled'])
         {
            ap_Login_pack_btn_disabled($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnLabel']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnLabel'])
         {
            ap_Login_pack_btn_label($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['varList']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['varList']))
         {
            ap_Login_pack_var_list($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['masterValue']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['masterValue'])
         {
            ap_Login_pack_master_value($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert'])
         {
            ap_Login_pack_ajax_alert($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage'])
         {
            ap_Login_pack_ajax_message($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxJavascript']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxJavascript'])
         {
            ap_Login_pack_ajax_javascript($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir']))
         {
            ap_Login_pack_ajax_redir($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['redirExit']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['redirExit']))
         {
            ap_Login_pack_ajax_redir_exit($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['blockDisplay']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['blockDisplay']))
         {
            ap_Login_pack_ajax_block_display($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fieldDisplay']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fieldDisplay']))
         {
            ap_Login_pack_ajax_field_display($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['buttonDisplay']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['buttonDisplay']))
         {
            $inicial_ap_Login->contr_ap_Login->NM_ajax_info['buttonDisplay'] = $inicial_ap_Login->contr_ap_Login->nmgp_botoes;
            ap_Login_pack_ajax_button_display($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['buttonDisplayVert']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['buttonDisplayVert']))
         {
            ap_Login_pack_ajax_button_display_vert($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fieldLabel']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fieldLabel']))
         {
            ap_Login_pack_ajax_field_label($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['readOnly']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['readOnly']))
         {
            ap_Login_pack_ajax_readonly($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']))
         {
            ap_Login_pack_ajax_nav_status($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['navSummary']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['navSummary']))
         {
            ap_Login_pack_ajax_nav_Summary($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['navPage']))
         {
            ap_Login_pack_ajax_navPage($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnVars']) && !empty($inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnVars']))
         {
            ap_Login_pack_ajax_btn_vars($aResp);
         }
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['quickSearchRes']) && $inicial_ap_Login->contr_ap_Login->NM_ajax_info['quickSearchRes'])
         {
         ...
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['event_field']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['event_field'])
         {
            $aResp['eventField'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['event_field'];
         }
         else
         {
         ...
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['buffer_output']) && $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['buffer_output'])
         {
            ...
            {
               $aResp['htmOutput'] = ap_Login_pack_protect_string(NM_charset_to_utf8($aResp['htmOutput']));
               ob_end_clean();
            }
         }
      }
   ...
   function ap_Login_pack_calendar_reload(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['calendarReload'] = 'OK';
   } // ap_Login_pack_calendar_reload

   function ap_Login_pack_ajax_errors(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['errList'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['errList'] as $sField => $aMsg)
      {
         if ('geral_ap_Login' == $sField)
         {
             $aMsg = ap_Login_pack_ajax_remove_erros($aMsg);
         }
         foreach ($aMsg as $sMsg)
         {
            $iNumLinha = (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['nmgp_refresh_row']) && 'geral_ap_Login' != $sField)
                       ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['nmgp_refresh_row'] : "";
            $aResp['errList'][] = array('fldName'  => $sField,
                                        'msgText'  => ap_Login_pack_protect_string(NM_charset_to_utf8($sMsg)),
                                        'numLinha' => $iNumLinha);
         }
      }
   } // ap_Login_pack_ajax_errors

   function ap_Login_pack_ajax_remove_erros($aErrors)
   {
       $aNewErrors = array();
       if (!empty($aErrors))
       {
       ...
       return $aNewErrors;
   } // ap_Login_pack_ajax_remove_erros

   function ap_Login_pack_ajax_ok(&$aResp)
   {
      global $inicial_ap_Login;
      $iNumLinha = (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['nmgp_refresh_row']))
                 ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['nmgp_refresh_row'] : "";
      $aResp['msgDisplay'] = array('msgText'  => ap_Login_pack_protect_string($inicial_ap_Login->contr_ap_Login->NM_ajax_info['msgDisplay']),
                                   'numLinha' => $iNumLinha);
   } // ap_Login_pack_ajax_ok

   function ap_Login_pack_ajax_set_fields(&$aResp)
   {
      global $inicial_ap_Login;
      $iNumLinha = (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['nmgp_refresh_row']))
                 ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['param']['nmgp_refresh_row'] : "";
      if ('' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['rsSize'])
      {
         $aResp['rsSize'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['rsSize'];
      }
      $aResp['fldList'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fldList'] as $sField => $aData)
      {
         $aField = array();
         ...
         {
            $aField['imgFile'] = ap_Login_pack_protect_string($aData['imgFile']);
         }
         if (isset($aData['imgOrig']))
         {
            $aField['imgOrig'] = ap_Login_pack_protect_string($aData['imgOrig']);
         }
         if (isset($aData['imgLink']))
         {
            $aField['imgLink'] = ap_Login_pack_protect_string($aData['imgLink']);
         }
         ...
         {
            $aField['docLink'] = ap_Login_pack_protect_string($aData['docLink']);
         }
         if (isset($aData['docIcon']))
         {
            $aField['docIcon'] = ap_Login_pack_protect_string($aData['docIcon']);
         }
         if (isset($aData['docReadonly']))
         {
            $aField['docReadonly'] = ap_Login_pack_protect_string($aData['docReadonly']);
         }
         ...
         {
            $aField['imgHtml'] = ap_Login_pack_protect_string($aData['imgHtml']);
         }
         if (isset($aData['mulHtml']))
         {
            $aField['mulHtml'] = ap_Login_pack_protect_string($aData['mulHtml']);
         }
         ...
         foreach ($aData['valList'] as $iIndex => $sValue)
         {
            ...
            {
               $aValue['label'] = ap_Login_pack_protect_string($aData['labList'][$iIndex]);
            }
            $aValue['value']     = ('_autocomp' != substr($sField, -9)) ? ap_Login_pack_protect_string($sValue) : $sValue;
            ...
            if (is_array($aData['optList']))
            {
               ...
               foreach ($aData['optList'] as $aOptList)
               {
                  foreach ($aOptList as $sValue => $sLabel)
                  {
                     ...
                     $aField['optList'][] = array('value' => ap_Login_pack_protect_string($sOpt),
                                                  'label' => ap_Login_pack_protect_string($sLabel));
                  }
               }
            }
            else
   ...
   } // ap_Login_pack_ajax_set_fields

   function ap_Login_pack_ajax_redir(&$aResp)
   {
      global $inicial_ap_Login;
      ...
      {
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir'][$sTag]))
         {
            $aResp['redirInfo'][$sTag] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redir'][$sTag];
         }
      }
   } // ap_Login_pack_ajax_redir

   function ap_Login_pack_ajax_redir_exit(&$aResp)
   {
      global $inicial_ap_Login;
      ...
      foreach ($aInfo as $sTag)
      {
         if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['redirExit'][$sTag]))
         {
            $aResp['redirExitInfo'][$sTag] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['redirExit'][$sTag];
         }
      }
   } // ap_Login_pack_ajax_redir_exit

   function ap_Login_pack_var_list(&$aResp)
   {
      global $inicial_ap_Login;
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['varList'] as $varData)
      {
         $aResp['varList'][] = array('index' => key($varData),
                                      'value' => current($varData));
      }
   } // ap_Login_pack_var_list

   function ap_Login_pack_master_value(&$aResp)
   {
      global $inicial_ap_Login;
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['masterValue'] as $sIndex => $sValue)
      {
         $aResp['masterValue'][] = array('index' => $sIndex,
                                         'value' => $sValue);
      }
   } // ap_Login_pack_master_value

   function ap_Login_pack_btn_disabled(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['btnDisabled'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnDisabled'] as $btnName => $btnStatus) {
        $aResp['btnDisabled'][$btnName] = $btnStatus;
      }
   } // ap_Login_pack_ajax_alert

   function ap_Login_pack_btn_label(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['btnLabel'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnLabel'] as $btnName => $btnLabel) {
        $aResp['btnLabel'][$btnName] = $btnLabel;
      }
   } // ap_Login_pack_ajax_alert

   function ap_Login_pack_ajax_alert(&$aResp)
   {
      global $inicial_ap_Login;
// PHP 8.0
      if (!isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert']['message'])) {
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert']['message'] = '';
      }
      if (!isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert']['params'])) {
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert']['params'] = '';
      }
//---
      $aResp['ajaxAlert'] = array('message' => $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert']['message'], 'params' =>  $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxAlert']['params']);
   } // ap_Login_pack_ajax_alert

   function ap_Login_pack_ajax_message(&$aResp)
   {
      global $inicial_ap_Login;
// PHP 8.0
      if (!isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['message'])) {
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['message'] = '';
      }
      if (!isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['title'])) {
          $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['title'] = '';
      }
//---
      $aResp['ajaxMessage'] = array('message'      => ap_Login_pack_protect_string($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['message']),
                                    'title'        => ap_Login_pack_protect_string($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['title']),
                                    'modal'        => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['modal'])        ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['modal']        : 'N',
                                    'timeout'      => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['timeout'])      ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['timeout']      : '',
                                    'button'       => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['button'])       ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['button']       : '',
                                    'button_label' => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['button_label']) ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['button_label'] : 'Ok',
                                    'top'          => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['top'])          ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['top']          : '',
                                    'left'         => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['left'])         ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['left']         : '',
                                    'width'        => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['width'])        ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['width']        : '',
                                    'height'       => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['height'])       ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['height']       : '',
                                    'redir'        => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['redir'])        ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['redir']        : '',
                                    'show_close'   => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['show_close'])   ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['show_close']   : 'Y',
                                    'body_icon'    => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['body_icon'])    ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['body_icon']    : 'Y',
                                    'toast'        => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['toast'])        ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['toast']        : 'N',
                                    'toast_pos'    => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['toast_pos'])    ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['toast_pos']    : '',
                                    'type'         => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['type'])         ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['type']         : '',
                                    'redir_target' => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['redir_target']) ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['redir_target'] : '',
                                    'redir_par'    => isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['redir_par'])    ? $inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxMessage']['redir_par']    : '');
   } // ap_Login_pack_ajax_message

   function ap_Login_pack_ajax_javascript(&$aResp)
   {
      global $inicial_ap_Login;
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['ajaxJavascript'] as $aJsFunc)
      {
         $aResp['ajaxJavascript'][] = $aJsFunc;
      }
   } // ap_Login_pack_ajax_javascript

   function ap_Login_pack_ajax_block_display(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['blockDisplay'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['blockDisplay'] as $sBlockName => $sBlockStatus)
      {
        $aResp['blockDisplay'][] = array($sBlockName, $sBlockStatus);
      }
   } // ap_Login_pack_ajax_block_display

   function ap_Login_pack_ajax_field_display(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['fieldDisplay'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fieldDisplay'] as $sFieldName => $sFieldStatus)
      {
        $aResp['fieldDisplay'][] = array($sFieldName, $sFieldStatus);
      }
   } // ap_Login_pack_ajax_field_display

   function ap_Login_pack_ajax_button_display(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['buttonDisplay'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['buttonDisplay'] as $sButtonName => $sButtonStatus)
      {
        $aResp['buttonDisplay'][] = array($sButtonName, $sButtonStatus);
      }
   } // ap_Login_pack_ajax_button_display

   function ap_Login_pack_ajax_button_display_vert(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['buttonDisplayVert'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['buttonDisplayVert'] as $aButtonData)
      {
        $aResp['buttonDisplayVert'][] = $aButtonData;
      }
   } // ap_Login_pack_ajax_button_display

   function ap_Login_pack_ajax_field_label(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['fieldLabel'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['fieldLabel'] as $sFieldName => $sFieldLabel)
      {
        $aResp['fieldLabel'][] = array($sFieldName, ap_Login_pack_protect_string($sFieldLabel));
      }
   } // ap_Login_pack_ajax_field_label

   function ap_Login_pack_ajax_readonly(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['readOnly'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['readOnly'] as $sFieldName => $sFieldStatus)
      {
        $aResp['readOnly'][] = array($sFieldName, $sFieldStatus);
      }
   } // ap_Login_pack_ajax_readonly

   function ap_Login_pack_ajax_nav_status(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['navStatus'] = array();
      if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']['ret']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']['ret'])
      {
         $aResp['navStatus']['ret'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']['ret'];
      }
      if (isset($inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']['ava']) && '' != $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']['ava'])
      {
         $aResp['navStatus']['ava'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navStatus']['ava'];
      }
   } // ap_Login_pack_ajax_nav_status

   function ap_Login_pack_ajax_nav_Summary(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['navSummary'] = array();
      $aResp['navSummary']['reg_ini'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navSummary']['reg_ini'];
      $aResp['navSummary']['reg_qtd'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navSummary']['reg_qtd'];
      $aResp['navSummary']['reg_tot'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navSummary']['reg_tot'];
   } // ap_Login_pack_ajax_nav_Summary

   function ap_Login_pack_ajax_navPage(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['navPage'] = $inicial_ap_Login->contr_ap_Login->NM_ajax_info['navPage'];
   } // ap_Login_pack_ajax_navPage


   function ap_Login_pack_ajax_btn_vars(&$aResp)
   {
      global $inicial_ap_Login;
      $aResp['btnVars'] = array();
      foreach ($inicial_ap_Login->contr_ap_Login->NM_ajax_info['btnVars'] as $sBtnName => $sBtnValue)
      {
        $aResp['btnVars'][] = array($sBtnName, ap_Login_pack_protect_string($sBtnValue));
      }
   } // ap_Login_pack_ajax_btn_vars

   function ap_Login_pack_protect_string($sString)
   {

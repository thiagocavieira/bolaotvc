...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("ap_Login_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('ap_Login_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
...
<?php
$_SESSION['scriptcase']['error_span_title']['ap_Login'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ap_Login'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['where_filter']))
       {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['Lookup_remember_me'][] = '1'; ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['btn_label']['ok'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("ap_Login");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("ap_Login");
 parent.scAjaxDetailHeight("ap_Login", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['ap_Login']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
